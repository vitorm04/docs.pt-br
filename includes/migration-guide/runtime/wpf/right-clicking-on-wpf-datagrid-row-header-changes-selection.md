...
|   |   |
|---|---|
|Detalhes|Clicar com o botão direito do mouse em um cabeçalho de linha <xref:System.Windows.Controls.DataGrid?displayProperty=name> enquanto várias linhas estão selecionadas altera a seleção de <xref:System.Windows.Controls.DataGrid?displayProperty=name> para somente a linha em questão.|
