...
>  
> O [fuso horário local](xref:System.TimeZoneInfo.Local) do executador de código embutido [Try.NET](https://try.dot.net) e do playground é o Tempo Universal Coordenado ou UTC. Isso pode afetar o comportamento e a saída dos exemplos que ilustram os tipos <xref:System.DateTime>, <xref:System.DateTimeOffset> e <xref:System.TimeZoneInfo> e seus membros.
