...
---
### <a name="parameter-names-changed-in-reference-assemblies"></a><span data-ttu-id="789a2-101">Nomes de parâmetro alterados em assemblies de referência</span><span class="sxs-lookup"><span data-stu-id="789a2-101">Parameter names changed in reference assemblies</span></span>

<span data-ttu-id="789a2-102">Alguns nomes de parâmetro de assembly de referência foram alterados para corresponder nomes de parâmetro nos assemblies de implementação.</span><span class="sxs-lookup"><span data-stu-id="789a2-102">Some reference assembly parameter names have changed to match parameter names in the implementation assemblies.</span></span>

#### <a name="change-description"></a><span data-ttu-id="789a2-103">Descrição das alterações</span><span class="sxs-lookup"><span data-stu-id="789a2-103">Change description</span></span>

<span data-ttu-id="789a2-104">Nas versões anteriores do .NET, alguns nomes de parâmetro do [assembly de referência](../../../../docs/standard/assembly/reference-assemblies.md) são diferentes para seus parâmetros correspondentes no assembly de implementação.</span><span class="sxs-lookup"><span data-stu-id="789a2-104">In previous .NET versions, some [reference assembly](../../../../docs/standard/assembly/reference-assemblies.md) parameter names are different to their corresponding parameters in the implementation assembly.</span></span> <span data-ttu-id="789a2-105">Isso pode causar problemas ao usar argumentos nomeados e reflexão.</span><span class="sxs-lookup"><span data-stu-id="789a2-105">This can cause problems while using named arguments and reflection.</span></span>

<span data-ttu-id="789a2-106">No .NET 5,0, esses nomes de parâmetro incompatíveis foram atualizados nos assemblies de referência para corresponder exatamente aos nomes de parâmetro correspondentes nos assemblies de implementação.</span><span class="sxs-lookup"><span data-stu-id="789a2-106">In .NET 5.0, these mismatched parameter names were updated in the reference assemblies to exactly match the corresponding parameter names in the implementation assemblies.</span></span>

<span data-ttu-id="789a2-107">A tabela a seguir mostra as APIs e os nomes de parâmetro que foram alterados.</span><span class="sxs-lookup"><span data-stu-id="789a2-107">The following table shows the APIs and parameter names that changed.</span></span>

| <span data-ttu-id="789a2-108">API</span><span class="sxs-lookup"><span data-stu-id="789a2-108">API</span></span> | <span data-ttu-id="789a2-109">Nome do parâmetro antigo</span><span class="sxs-lookup"><span data-stu-id="789a2-109">Old parameter name</span></span> | <span data-ttu-id="789a2-110">Nome do novo parâmetro</span><span class="sxs-lookup"><span data-stu-id="789a2-110">New parameter name</span></span> |
| - | - | - |
...
#### <a name="reason-for-change"></a><span data-ttu-id="789a2-111">Motivo da alteração</span><span class="sxs-lookup"><span data-stu-id="789a2-111">Reason for change</span></span>

<span data-ttu-id="789a2-112">Os nomes de parâmetro foram alterados quanto à consistência e para evitar falhas ao usar argumentos nomeados e reflexão.</span><span class="sxs-lookup"><span data-stu-id="789a2-112">The parameter names were changed for consistency and to avoid failures when using named arguments and reflection.</span></span>

#### <a name="version-introduced"></a><span data-ttu-id="789a2-113">Versão introduzida</span><span class="sxs-lookup"><span data-stu-id="789a2-113">Version introduced</span></span>

<span data-ttu-id="789a2-114">5,0</span><span class="sxs-lookup"><span data-stu-id="789a2-114">5.0</span></span>

#### <a name="recommended-action"></a><span data-ttu-id="789a2-115">Ação recomendada</span><span class="sxs-lookup"><span data-stu-id="789a2-115">Recommended action</span></span>

<span data-ttu-id="789a2-116">Se você encontrar um erro de compilador devido a uma alteração de nome de parâmetro, atualize o nome do parâmetro de acordo.</span><span class="sxs-lookup"><span data-stu-id="789a2-116">If you encounter a compiler error due to a parameter name change, update the parameter name accordingly.</span></span>

#### <a name="category"></a><span data-ttu-id="789a2-117">Categoria</span><span class="sxs-lookup"><span data-stu-id="789a2-117">Category</span></span>

<span data-ttu-id="789a2-118">Bibliotecas principais do .NET</span><span class="sxs-lookup"><span data-stu-id="789a2-118">Core .NET libraries</span></span>

#### <a name="affected-apis"></a><span data-ttu-id="789a2-119">APIs afetadas</span><span class="sxs-lookup"><span data-stu-id="789a2-119">Affected APIs</span></span>
