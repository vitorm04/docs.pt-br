...
No .NET Core 2,2 e versões anteriores, o tempo de execução prefere carregar o OpenSSL 1.0. x acima de 1.1. x. Isso significa que os <xref:System.IntPtr> tipos <xref:System.Runtime.InteropServices.SafeHandle> e para interoperabilidade com OpenSSL são usados com libcrypto. portanto. 1.0.0/libcrypto. portanto. 1.0/libcrypto. portanto, 10 por preferência.
