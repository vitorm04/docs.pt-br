...
Se você estiver usando o construtor de modelos para treinar o modelo de aprendizado de máquina, consulte [carregar dados de treinamento no construtor de modelos](load-data-model-builder.md).
