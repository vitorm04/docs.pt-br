...
A versão 6.0 da especificação não foi aprovada como um padrão. Este site contém a especificação [*rascunho* de C# 6.0](../../../../_csharplang/spec/lexical-structure.md). Ela é criada de arquivos markdown contidos no [repositório do GitHub dotnet/csharplang](https://github.com/dotnet/csharplang/blob/master/spec/README.md).
