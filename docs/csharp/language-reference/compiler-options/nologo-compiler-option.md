---
title: "-nologo (Opções do compilador C#) | Microsoft Docs"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
- devlang-csharp
...
A opção **/nologo** inibe a exibição da faixa de conexão quando o compilador é iniciado e a exibição de mensagens informativas durante a compilação.  
