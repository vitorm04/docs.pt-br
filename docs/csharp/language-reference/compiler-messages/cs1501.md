...
manager: "wpickett"
---
# Erro do Compilador CS1501
[!INCLUDE[vs2017banner](../../../csharp/includes/vs2017banner.md)]

Sobrecarga para tomadas ““o método números” argumentos”  
  
 Foi feita uma chamada para um método da classe, mas nenhuma definição de método usa o número especificado de argumentos.  
  
## Exemplo  
 O exemplo a seguir produz CS1501.  
