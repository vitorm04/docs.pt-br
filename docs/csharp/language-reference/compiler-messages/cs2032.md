...
1. Na pasta *Meus documentos,* crie um arquivo de texto chamado *CS2032.rsp*e digite as seguintes opções de compilação nele:
...
6. A mensagem de erro CS2032 é exibida porque o arquivo de resposta, *CS2032.rsp,* contém um caractere pipe.
