...
O encaminhador do tipo “tipo” no assembly assembly causa um ciclo  
  
 Esse erro só pode acontecer com metadados importados de forma incorreta formados.  Não pode ocorrer apenas com origem C\#.  
  
## Exemplo  
 O exemplo a seguir produz CS0731.  O exemplo consiste em três arquivos:  
 ...
 Criar primeiro os arquivos de .IL como bibliotecas, e depois criar o código .cs que referencia os dois arquivos.  
