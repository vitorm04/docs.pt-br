...
O operador 'operator' não pode ser aplicado a operandos dos tipos 'type' e 'type'  
 ...
 Você pode sobrecarregar um operador para fazê-lo dar suporte a operandos de certos tipos. Para obter mais informações, consulte [Sobrecarga de operador](../../../csharp/language-reference/operators/operator-overloading.md).
