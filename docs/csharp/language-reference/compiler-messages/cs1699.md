...
- [-keyfile (opções do compilador C#)](../compiler-options/keyfile-compiler-option.md) em vez do <xref:System.Reflection.AssemblyKeyFileAttribute> atributo.  
  
- [-keycontainer (opções do compilador C#)](../compiler-options/keycontainer-compiler-option.md) em vez de <xref:System.Reflection.AssemblyKeyNameAttribute> .  
  
- [-DelaySign (opções do compilador C#)](../compiler-options/delaysign-compiler-option.md) em vez de <xref:System.Reflection.AssemblyDelaySignAttribute> .  
