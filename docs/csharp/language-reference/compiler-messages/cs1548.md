...
Falha na criptografia ao assinar o assembly 'assembly' — 'reason'  
 ...
 Para obter mais informações, consulte [como assinar um assembly com um nome forte](../../../standard/assembly/sign-strong-name.md), [-keyfile (opçõesC# do compilador)](../compiler-options/keyfile-compiler-option.md) e [-DelaySign (C# opções do compilador)](../compiler-options/delaysign-compiler-option.md).  
