...
Falha na criptografia ao assinar o assembly 'assembly' — 'reason'  
 ...
 Para obter mais informações, consulte [Como: Assinar um conjunto com um nome forte](../../../standard/assembly/sign-strong-name.md), [-keyfile (C# Opções de compilação)](../compiler-options/keyfile-compiler-option.md) e [-delaysign (C# Opções de compilação)](../compiler-options/delaysign-compiler-option.md).  
