...
O tipo TypeName1 existe no TypeName2 e no TypeName3  
 ...
 Para resolver esse erro, use o recurso de alias da opção do compilador [/reference (Opções do Compilador C#)](../compiler-options/reference-compiler-option.md) ou não referencie um dos assemblies.  
