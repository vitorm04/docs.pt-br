...
- Ocultar a propriedade da classe base, adicionando a palavra-chave [new](../../../csharp/language-reference/keywords/new-modifier.md) a uma propriedade em uma classe derivada.  
