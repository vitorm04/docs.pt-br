---
description: Erro do Compilador CS0015
title: Erro do Compilador CS0015
ms.date: 07/20/2015
f1_keywords:
- CS0015
helpviewer_keywords:
...
ms.locfileid: "89122401"
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="27667-103">Erro do Compilador CS0015</span><span class="sxs-lookup"><span data-stu-id="27667-103">Compiler Error CS0015</span></span>

<span data-ttu-id="27667-104">O nome do tipo 'type' é muito longo</span><span class="sxs-lookup"><span data-stu-id="27667-104">The name of type 'type' is too long</span></span>

 <span data-ttu-id="27667-105">O nome totalmente qualificado de um tipo definido pelo usuário deve ter menos de 1024 caracteres, incluindo os pontos finais.</span><span class="sxs-lookup"><span data-stu-id="27667-105">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>

 <span data-ttu-id="27667-106">O exemplo a seguir gera o erro CS0015:</span><span class="sxs-lookup"><span data-stu-id="27667-106">The following sample generates CS0015:</span></span>
