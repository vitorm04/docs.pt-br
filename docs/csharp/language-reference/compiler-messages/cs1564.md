...
- [-win32manifest (C# Opções de compilador)](../compiler-options/win32manifest-compiler-option.md)
- [-win32res (C# Opções de compilador)](../compiler-options/win32res-compiler-option.md)
