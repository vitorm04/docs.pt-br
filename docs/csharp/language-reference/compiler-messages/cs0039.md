...
Uma conversão com o operador [as](../../language-reference/operators/type-testing-and-cast.md#as-operator) será permitida por herança, conversões de referência e conversões boxing.
