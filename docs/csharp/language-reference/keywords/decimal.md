...
Neste exemplo, um `decimal` e um [int](../../../csharp/language-reference/builtin-types/integral-numeric-types.md) são misturados na mesma expressão. O resultado é avaliado como o tipo `decimal`.
