...
- Métodos anônimos. Para obter mais informações, consulte [Métodos anônimos](../../programming-guide/statements-expressions-operators/anonymous-methods.md).
