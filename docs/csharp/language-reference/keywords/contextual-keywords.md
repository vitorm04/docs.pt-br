...
|[value](../../../csharp/language-reference/keywords/value.md)|Usado para definir acessadores e para adicionar ou remover manipuladores de eventos.|  
|[var](../../../csharp/language-reference/keywords/var.md)|Permite que o tipo de uma variável declarada no escopo do método seja determinado pelo compilador.|  
|[when](when.md)|Especifica uma condição de filtro para um bloco `catch` ou o rótulo `case` de uma instrução `switch`.|
|[where](../../../csharp/language-reference/keywords/where-generic-type-constraint.md)|Adiciona restrições a uma declaração genérica. (Consulte também [where](../../../csharp/language-reference/keywords/where-clause.md)).|  
|[yield](../../../csharp/language-reference/keywords/yield.md)|Usada em um bloco iterador para retornar um valor para o objeto enumerador ou para sinalizar o final da iteração.|  
  
 Todas as palavras-chave de consulta introduzidas no C# 3.0 também são contextuais. Para obter mais informações, consulte [Palavras-chave de consulta (LINQ)](../../../csharp/language-reference/keywords/query-keywords.md).  
