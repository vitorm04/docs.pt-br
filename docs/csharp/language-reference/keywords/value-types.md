...
- [Tipos integrais](../builtin-types/integral-numeric-types.md): tipos numéricos inteiros e o tipo [char](../builtin-types/char.md)
...
Para saber mais sobre o operador `new`, confira [new](../operators/new-operator.md).
