...
Para obter mais informações sobre como descartar objetos `IDisposable`, confira [Usando objetos que implementam IDisposable](../../../standard/garbage-collection/using-objects.md).
