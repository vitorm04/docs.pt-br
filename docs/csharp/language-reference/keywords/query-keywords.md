...
|[where](../../../csharp/language-reference/keywords/where-clause.md)|Filtra elementos de origem baseados em uma ou mais expressões boolianas separadas por operadores AND e OR lógicos ( `&&` ou <code>&#124;&#124;</code> ).|  
