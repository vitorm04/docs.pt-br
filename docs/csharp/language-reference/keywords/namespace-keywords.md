...
ms.locfileid: "43399824"
---
# <a name="namespace-keywords-c-reference"></a>Palavras-chave de namespace (Referência de C#)
Esta seção descreve as palavras-chave e operadores associados ao uso de namespaces:  
