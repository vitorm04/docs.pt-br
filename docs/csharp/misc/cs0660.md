...
O compilador detectou o operador de igualdade ou desigualdade definido pelo usuário, mas não substitui o <xref:System.Object.Equals%2A?displayProperty=nameWithType> método. Um operador de igualdade ou desigualdade definido pelo usuário implica que você também deseja substituir o <xref:System.Object.Equals%2A> método. Para obter mais informações, consulte [como definir a igualdade de valor para um tipo](../programming-guide/statements-expressions-operators/how-to-define-value-equality-for-a-type.md).
