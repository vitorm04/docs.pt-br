...
Restrições para substituem e métodos de implementação de interface explícita são herdados do método base, para que elas não podem ser especificadas diretamente  
