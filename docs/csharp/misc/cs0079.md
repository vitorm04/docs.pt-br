...
O evento 'event' só pode aparecer à esquerda de + = ou =  
 ...
 Uma [evento](../../csharp/language-reference/keywords/event.md) foi chamado incorretamente. Para obter mais informações, consulte [eventos](../../csharp/programming-guide/events/index.md) e [delegados](../../csharp/programming-guide/delegates/index.md).  
