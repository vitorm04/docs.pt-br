...
'rotina de conversão': conversão definida pelo usuário para/de classe base  
  
 Conversões definidas pelo usuário para valores de uma classe base não são permitidas; Você não precisa desses operadores.  
