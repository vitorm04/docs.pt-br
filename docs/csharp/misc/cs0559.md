...
O tipo de parâmetro + + ou --operador deve ser do tipo recipiente  
 ...
 A declaração de método para uma sobrecarga de operador deve seguir determinadas diretrizes. Para o + + e --operadores, é necessário que o parâmetro ser do mesmo tipo que o tipo no qual o operador está sobrecarregado.  
