...
'function1' não implementa membro abstrato herdado 'function2'  
 ...
 Uma classe é necessária para implementar todos os [abstrata](../../csharp/language-reference/keywords/abstract.md) os membros da classe base, a menos que a classe é também resumem.  
