...
Não é possível converter o grupo de método 'Identificador' para o tipo 'tipo' de não-delegado.  Você pretendia invocar o método?  
  
 Esse erro ocorre ao converter um grupo de método sem um tipo de não-delegado ou tentar invocar um método sem usar parênteses.  
  
## <a name="example"></a>Exemplo  
 A seguinte amostra gera CS0428:  
