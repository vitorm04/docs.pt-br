...
ms.locfileid: "61657571"
---
# <a name="compiler-error-cs0428"></a><span data-ttu-id="03113-102">Erro do compilador CS0428</span><span class="sxs-lookup"><span data-stu-id="03113-102">Compiler Error CS0428</span></span>
<span data-ttu-id="03113-103">Não é possível converter o grupo de métodos 'Identifier' para 'type' do tipo não delegado.</span><span class="sxs-lookup"><span data-stu-id="03113-103">Cannot convert method group 'Identifier' to non-delegate type 'type'.</span></span>  <span data-ttu-id="03113-104">Você pretendia invocar o método?</span><span class="sxs-lookup"><span data-stu-id="03113-104">Did you  intend to invoke the method?</span></span>  
  
 <span data-ttu-id="03113-105">Esse erro ocorre ao converter um grupo de métodos em um tipo não delegado ou a tentativa de invocar um método sem o uso de parênteses.</span><span class="sxs-lookup"><span data-stu-id="03113-105">This error occurs when converting a method group to a non-delegate type, or attempting to invoke a method without using parentheses.</span></span>  
  
## <a name="example"></a><span data-ttu-id="03113-106">Exemplo</span><span class="sxs-lookup"><span data-stu-id="03113-106">Example</span></span>  
 <span data-ttu-id="03113-107">O exemplo a seguir gera CS0428:</span><span class="sxs-lookup"><span data-stu-id="03113-107">The following sample generates CS0428:</span></span>  
