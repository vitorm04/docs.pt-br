...
ms.locfileid: "79172919"
---
# <a name="compiler-error-cs0428"></a><span data-ttu-id="83eba-102">Erro do Compilador CS0428</span><span class="sxs-lookup"><span data-stu-id="83eba-102">Compiler Error CS0428</span></span>
<span data-ttu-id="83eba-103">Não é possível converter o grupo de método 'Identificador' para o tipo 'tipo' de não-delegado.</span><span class="sxs-lookup"><span data-stu-id="83eba-103">Cannot convert method group 'Identifier' to non-delegate type 'type'.</span></span>  <span data-ttu-id="83eba-104">Você pretendia invocar o método?</span><span class="sxs-lookup"><span data-stu-id="83eba-104">Did you  intend to invoke the method?</span></span>  
  
 <span data-ttu-id="83eba-105">Esse erro ocorre ao converter um grupo de método sem um tipo de não-delegado ou tentar invocar um método sem usar parênteses.</span><span class="sxs-lookup"><span data-stu-id="83eba-105">This error occurs when converting a method group to a non-delegate type, or attempting to invoke a method without using parentheses.</span></span>  
  
## <a name="example"></a><span data-ttu-id="83eba-106">Exemplo</span><span class="sxs-lookup"><span data-stu-id="83eba-106">Example</span></span>  
 <span data-ttu-id="83eba-107">A seguinte amostra gera CS0428:</span><span class="sxs-lookup"><span data-stu-id="83eba-107">The following sample generates CS0428:</span></span>  
