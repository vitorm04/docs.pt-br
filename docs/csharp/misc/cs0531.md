...
'member': membros de interface não podem ter uma definição  
 ...
 Métodos que são declarados em uma [interface](../../csharp/language-reference/keywords/interface.md) deve ser implementada em uma classe que herda dela e não na própria interface.  
