...
'member': membros de interface não podem ter uma definição  
 ...
 Métodos que são declarados em um [interface](../../csharp/language-reference/keywords/interface.md) devem ser implementados em uma classe que herda dela e não na própria interface.  
