...
Comentário XML sobre 'param' tem atributo cref 'atributo' que se refere a um parâmetro de tipo  
  
 Este erro é gerado por um comentário XML que se refere a um parâmetro de tipo.  
