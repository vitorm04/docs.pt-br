...
Só é possível obter o endereço de uma expressão unfixed dentro de um inicializador de instrução fixed  
 ...
 O exemplo a seguir mostra como obter o endereço de uma expressão unfixed. O exemplo a seguir gera CS0212.  
...
```  
 ...
 Além disso, o exemplo a seguir gera CS0212 e mostra como resolver o erro:  
