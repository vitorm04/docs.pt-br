...
Um acessador add ou remove esperado  
 ...
 Se sua [evento](../../csharp/language-reference/keywords/event.md) não está declarado como um campo, ele deve definir ambos **adicione** e **remover** funções do acessador.  
