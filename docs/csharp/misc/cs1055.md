...
ms.locfileid: "33307268"
---
# <a name="compiler-error-cs1055"></a>CS1055 de erro do compilador
Um acessador add ou remove esperado  
  
 Se seu [evento](../../csharp/language-reference/keywords/event.md) não está declarado como um campo, ele deve definir ambos **adicionar** e **remover** funções do acessador.  
