...
Não é possível definir métodos sobrecarregados que diferem somente em ref e out.  
 ...
 Métodos que diferem apenas em seu uso de [ref](../../csharp/language-reference/keywords/ref.md) e [out](../../csharp/language-reference/keywords/out.md) em um parâmetro não são permitidas.  
