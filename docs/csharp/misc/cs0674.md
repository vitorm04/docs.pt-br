...
Não use 'ParamArrayAttribute'. Use a palavra-chave 'params'.  
 ...
 O C# compilador não permite o uso de <xref:System.ParamArrayAttribute?displayProperty=nameWithType>; usar [params](../../csharp/language-reference/keywords/params.md) em vez disso.  
