...
Não use ' System. ParamArrayattribute '. Em vez disso, use a palavra-chave ' params '.  
 ...
 O C# compilador não permite o uso de <xref:System.ParamArrayAttribute?displayProperty=nameWithType>. em vez disso, use [params](../language-reference/keywords/params.md) .  
