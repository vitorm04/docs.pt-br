...
Operador definido pelo usuário 'operator' deve ser declarado estático e público  
 ...
 Os dois o **estáticos** e **pública** acesso [modificadores](../../csharp/language-reference/keywords/modifiers.md) deve ser especificado em operadores definidos pelo usuário.  
