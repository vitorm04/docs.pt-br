...
A chamada é ambígua entre os seguintes métodos ou propriedades: 'method1' e 'method2'  
 ...
 Devido à conversão implícita, o compilador não foi capaz de chamar uma forma de um método sobrecarregado. Você pode resolver este erro das seguintes maneiras:  
