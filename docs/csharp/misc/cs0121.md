...
Devido à conversão implícita, o compilador não pôde chamar uma forma de um método sobrecarregado. Você pode resolver esse erro das seguintes maneiras:
...
Os exemplos a seguir geram o erro do compilador CS0121:
