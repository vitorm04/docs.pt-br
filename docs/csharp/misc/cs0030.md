...
Não é possível converter o tipo 'type' para 'type'  
 ...
 Você deve fornecer as rotinas de conversão para dar suporte a determinadas sobrecargas do operador. Para obter mais informações, consulte [Operadores de conversão](../../csharp/programming-guide/statements-expressions-operators/conversion-operators.md).  
