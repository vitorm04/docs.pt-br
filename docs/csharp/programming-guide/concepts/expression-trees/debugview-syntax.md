...
| <xref:System.Int64?displayProperty=nameWithType> | [Longas](../../../language-reference/builtin-types/integral-numeric-types.md) | L |
| <xref:System.UInt64?displayProperty=nameWithType> | [Ulong](../../../language-reference/builtin-types/integral-numeric-types.md) | UL |
| <xref:System.Double?displayProperty=nameWithType> | [Duplo](../../../language-reference/builtin-types/floating-point-numeric-types.md) | D |
| <xref:System.Single?displayProperty=nameWithType> | [Flutuar](../../../language-reference/builtin-types/floating-point-numeric-types.md) | F |
