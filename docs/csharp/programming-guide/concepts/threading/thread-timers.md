...
```  
 ...
 Temporizadores de thread são particularmente úteis quando o objeto <xref:System.Windows.Forms.Timer?displayProperty=fullName> não está disponível, assim como quando você está desenvolvendo aplicativos de console.  
