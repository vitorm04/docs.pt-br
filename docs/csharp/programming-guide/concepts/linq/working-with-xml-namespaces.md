...
|[Como escrever consultas no XML nos namespaces (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-write-queries-on-xml-in-namespaces.md)|Demonstra como especificar namespaces de XML em consultas LINQ to XML do C#.|  
