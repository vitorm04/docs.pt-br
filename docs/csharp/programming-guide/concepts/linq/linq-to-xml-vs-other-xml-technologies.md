---
title: LINQ para XML vs. Outras Tecnologias XML3
ms.date: 07/20/2015
...
Este tópico compara o [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] às seguintes tecnologias XML: <xref:System.Xml.XmlReader>, XSLT, MSXML e XmlLite. Estas informações podem ajudá-lo a decidir qual tecnologia usar.  
 ...
 Para uma [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] comparação com o Modelo de Objeto de Documento (DOM), consulte [LINQ para XML vs. DOM (C#)](./linq-to-xml-vs-dom.md).  
  
## <a name="linq-to-xml-vs-xmlreader"></a>LINQ para XML vs. XmlReader  
...
## <a name="linq-to-xml-vs-xslt"></a>LINQ para XML vs. XSLT  
...
## <a name="linq-to-xml-vs-msxml"></a>LINQ para XML vs. MSXML  
...
## <a name="linq-to-xml-vs-xmllite"></a>LINQ para XML vs. XmlLite  
 ...
 O XmlLite não é integrado com a LinQ (Language-Integrated Query). Não produz melhorias de produtividade do programador que são a força motivadora por trás do LINQ.  
