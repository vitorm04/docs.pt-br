...
---
# <a name="in-memory-xml-tree-modification-vs-functional-construction-linq-to-xml-c"></a>Modificação da árvore XML na memória vs. Construção Funcional (LINQ a XML) (C#)
