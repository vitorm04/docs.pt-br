...
|Tópico|Descrição|  
|-----------|-----------------|  
|[Anotações LINQ to XML](../../../../csharp/programming-guide/concepts/linq/linq-to-xml-annotations.md)|Descreve como adicionar anotações a nós e atributos [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)].|  
...
|[Como: Ler e gravar um documento codificado (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-read-and-write-an-encoded-document.md)|Descreve como ler e gravar documentos XML codificados.|  
