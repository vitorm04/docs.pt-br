...
```
 ...
 <span data-ttu-id="85ad0-120">Esse exemplo gera a saída a seguir:</span><span class="sxs-lookup"><span data-stu-id="85ad0-120">This example produces the following output:</span></span>
