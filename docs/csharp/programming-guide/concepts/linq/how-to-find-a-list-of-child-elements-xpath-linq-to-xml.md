---
title: Como localizar uma lista dos elementos filho (XPath-LINQ to XML) (C#) | Microsoft Docs
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
Este tópico compara o eixo de elementos filho do XPath com o eixo <xref:System.Xml.Linq.XContainer.Elements%2A> do [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)].  
