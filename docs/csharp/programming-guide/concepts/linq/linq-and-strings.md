...
- [Como contar ocorrências de uma palavra em uma string (LINQ) (C#)](how-to-count-occurrences-of-a-word-in-a-string-linq.md)  
...
- [Como consultar caracteres em uma seqüência (LINQ) (C#)](how-to-query-for-characters-in-a-string-linq.md)
...
- [Como dividir um arquivo em muitos arquivos usando grupos (LINQ) (C#)](how-to-split-a-file-into-many-files-by-using-groups-linq.md)
  
  Mostra como criar novos arquivos usando um único arquivo como uma fonte de dados.

- [Como calcular valores de coluna em um arquivo de texto CSV (LINQ) (C#)](how-to-compute-column-values-in-a-csv-text-file-linq.md)
