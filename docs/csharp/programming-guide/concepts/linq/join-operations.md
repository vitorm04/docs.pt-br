...
---
# <a name="no-locjoin-operations-c"></a><span data-ttu-id="b75de-104">JoinOperações (C#)</span><span class="sxs-lookup"><span data-stu-id="b75de-104">Join Operations (C#)</span></span>
...
|-----------------|-----------------|---------------------------------|----------------------|  
|Join|<span data-ttu-id="b75de-122">Joins duas sequências baseadas em funções de seletor de chave e extraem pares de valores.</span><span class="sxs-lookup"><span data-stu-id="b75de-122">Joins two sequences based on key selector functions and extracts pairs of values.</span></span>|`join … in … on … equals …`|<xref:System.Linq.Enumerable.Join%2A?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.Join%2A?displayProperty=nameWithType>|  
|GroupJoin|<span data-ttu-id="b75de-123">Joins duas sequências baseadas em funções de seletor de chave e agrupa as correspondências resultantes para cada elemento.</span><span class="sxs-lookup"><span data-stu-id="b75de-123">Joins two sequences based on key selector functions and groups the resulting matches for each element.</span></span>|`join … in … on … equals … into …`|<xref:System.Linq.Enumerable.GroupJoin%2A?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.GroupJoin%2A?displayProperty=nameWithType>|  
...
- [<span data-ttu-id="b75de-130">Formular Join consultas de s e produtos cruzados</span><span class="sxs-lookup"><span data-stu-id="b75de-130">Formulate Joins and Cross-Product Queries</span></span>](../../../../framework/data/adonet/sql/linq/formulate-joins-and-cross-product-queries.md)
...
- [<span data-ttu-id="b75de-132">Joinusando chaves compostas</span><span class="sxs-lookup"><span data-stu-id="b75de-132">Join by using composite keys</span></span>](../../../linq/join-by-using-composite-keys.md)
