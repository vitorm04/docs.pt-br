...
## <a name="object-relational-designer"></a>Object Relational Designer  
 O Object Relational Designer é uma ferramenta de design visual que você pode usar em aplicativos [LINQ to SQL](../../../../framework/data/adonet/sql/linq/index.md) para gerar classes no C# que representam os dados relacionais em um banco de dados subjacente. Para obter mais informações, consulte [Ferramentas LINQ to SQL no Visual Studio](/visualstudio/data-tools/linq-to-sql-tools-in-visual-studio2).  
