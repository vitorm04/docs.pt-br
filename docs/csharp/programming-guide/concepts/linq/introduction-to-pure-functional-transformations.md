...
|[Programação Funcional vs. Programação Imperativa (C#)](./functional-programming-vs-imperative-programming.md)|Compara e contrasta programação funcional à programação (procedural) imperativa mais tradicional.|  
