---
title: "Introdução às transformações funcionais puras (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
ms.openlocfilehash: 248aff45ca2acd9022f23b2541f274801f6f3546
...
|Tópico|Descrição|  
|-----------|-----------------|  
|[Conceitos e terminologia (transformação funcional) (C#)](../../../../csharp/programming-guide/concepts/linq/concepts-and-terminology-functional-transformation.md)|Apresenta os conceitos e a terminologia de transformações e puras.|  
|[Programação funcional versus Programação obrigatória (C#)](../../../../csharp/programming-guide/concepts/linq/functional-programming-vs-imperative-programming.md)|Compara e contrasta programação funcional à programação (procedural) imperativa mais tradicional.|  
|[Refatoração em funções puras (C#)](../../../../csharp/programming-guide/concepts/linq/refactoring-into-pure-functions.md)|Apresenta funções puras, e mostra exemplos de funções e puras e impuros.|  
