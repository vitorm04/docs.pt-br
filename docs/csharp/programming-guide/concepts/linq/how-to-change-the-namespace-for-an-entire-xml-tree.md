---
title: "Como alterar o namespace de uma árvore XML inteira (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
Às vezes você tem que alterar programaticamente ao namespace para um elemento ou atributo. LINQ to XML faz isso fácil. A propriedade <xref:System.Xml.Linq.XElement.Name%2A?displayProperty=fullName> pode ser definida. A propriedade <xref:System.Xml.Linq.XAttribute.Name%2A?displayProperty=fullName> não pode ser definida, mas você pode facilmente copiar os atributos para uma <xref:System.Collections.Generic.List%601?displayProperty=fullName>, remover os atributos existentes e, em seguida, adicionar novos atributos que estão no novo namespace desejado.  
