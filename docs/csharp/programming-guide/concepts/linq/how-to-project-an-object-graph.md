---
title: "Como projetar um objeto gráfico (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="how-to-project-an-object-graph-c"></a>Como projetar um gráfico de objeto (C#)
Este tópico ilustra como projeto, ou preencher, um objeto gráfico XML.  
  
## <a name="example"></a>Exemplo  
 O código a seguir preenche um objeto gráfico com as classes `Address`, `PurchaseOrder` e `PurchaseOrderItem` do documento XML de [Arquivo XML de exemplo: pedido de compra típico (LINQ to XML)](../../../../csharp/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-linq-to-xml-1.md).  
...
```  
 ...
 Neste exemplo, o resultado da consulta [!INCLUDE[vbteclinq](../../../../csharp/includes/vbteclinq_md.md)] é retornado como um <xref:System.Collections.Generic.IEnumerable%601> de `PurchaseOrderItem`. Os itens da classe `PurchaseOrder` são do tipo <xref:System.Collections.Generic.IEnumerable%601> de `PurchaseOrderItem`. O código usa o método de extensão <xref:System.Linq.Enumerable.ToList%2A> para criar uma coleção <xref:System.Collections.Generic.List%601> dos resultados da consulta.  
