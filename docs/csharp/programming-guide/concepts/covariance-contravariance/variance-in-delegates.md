...
- [<span data-ttu-id="ddef8-148">Genéricos</span><span class="sxs-lookup"><span data-stu-id="ddef8-148">Generics</span></span>](~/docs/standard/generics/index.md)
