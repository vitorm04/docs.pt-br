...
9. Pressione CTRL+F5 para compilar e executar o projeto. Verifique se uma pasta de trabalho do Excel foi criada na localização especificada no código de exemplo: C:\SampleFolder\SampleWorkbook.xls.  
...
5.  Verifique se uma pasta de trabalho do Excel foi criada na localização especificada no código de exemplo: C:\SampleFolder\SampleWorkbook.xls.  
