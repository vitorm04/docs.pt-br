...
- [Aviso de segurança - CA2121: Construtores estáticos devem ser particulares](https://docs.microsoft.com/en-us/visualstudio/code-quality/ca2121-static-constructors-should-be-private)
