...
-   [Usar delegados](../../../csharp/programming-guide/delegates/using-delegates.md)  
...
-   [Usar variação em delegados](../../../csharp/programming-guide/concepts/covariance-contravariance/using-variance-in-delegates.md)  
