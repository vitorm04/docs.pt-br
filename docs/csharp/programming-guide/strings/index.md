...
|\U|Sequência de escape Unicode (UTF-32)|`\U00HHHHHH` (Range: 000000-10FFFF; exemplo: `\U0001F47D` = "&#x1F47D;")|  
...
|[Guia de Programação em C#](../index.md)|Fornece links para tópicos que explicam as construções de programação em C#.|  
