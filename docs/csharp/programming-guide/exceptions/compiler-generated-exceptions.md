...
|<xref:System.NullReferenceException>|Jogado quando uma tentativa é feita para referenciar um objeto cujo valor é [nulo](../../language-reference/keywords/null.md).|  
