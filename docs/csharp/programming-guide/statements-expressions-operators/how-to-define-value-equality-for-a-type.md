...
description: Saiba como definir a igualdade de valor para um tipo. Confira exemplos de código e exiba recursos adicionais disponíveis.
ms.date: 07/20/2015
helpviewer_keywords:
...
## <a name="struct-example"></a>Exemplo de struct
