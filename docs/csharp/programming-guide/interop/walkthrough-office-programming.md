...
- [Passo a passo: inserindo tipos de assemblies gerenciados](../concepts/assemblies-gac/walkthrough-embedding-types-from-managed-assemblies-in-visual-studio.md)
