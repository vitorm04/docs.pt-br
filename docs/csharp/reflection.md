---
title: "Reflexão e geração de código"
description: "Reflexão e geração de código"
...
# <a name="-reflection--code-generation"></a>🔧 Reflexão e geração de código

> **Observação**
> 
> Este tópico ainda não foi criado! 
>
> Agradecemos a sua contribuição para ajudar a moldar o escopo e a abordagem. Você pode acompanhar o status e fornecer comentários sobre esse [problema](https://github.com/dotnet/docs/issues/493) no GitHub.
> 
