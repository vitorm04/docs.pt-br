---
title: Usando C# Interativo com o Powershell | Guia o C#
description: Explorar o shell do C# Interativo da linha de comando do Windows
...
# <a name="-using-c-interactive-with-powershell"></a>🔧 Usando C# Interativo com o Powershell

> **Observação**
> 
> Este tópico ainda não foi criado! 
>
> Agradecemos a sua contribuição para ajudar a moldar o escopo e a abordagem. Você pode acompanhar o status e fornecer comentários sobre esse [problema](https://github.com/dotnet/docs/issues/970) no GitHub.
> 
