...
- [Tipos de valor][ValueTypes]
  ...
  - [Tipos de valor anulável][NullableTypes]
...
O `bool` `true` tipo do C# é usado para representar valores Boolianos — valores que são `false`ou.
