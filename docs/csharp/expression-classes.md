...
description: "Tipos de Framework com suporte a árvores de expressão"
...
Você pode ver a lista completa [aqui](https://docs.microsoft.com/dotnet/core/api/System.Linq.Expressions).
