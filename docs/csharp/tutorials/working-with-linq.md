...
Existem muitas razões para isso. Você pode abordar uma das principais causas dessa queda de desempenho: uso ineficiente da [*avaliação lenta*](../../standard/linq/deferred-execution-lazy-evaluation.md).
