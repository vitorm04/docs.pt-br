...
O tutorial .NET [Hello World em 10 minutos](https://dotnet.microsoft.com/learn/dotnet/hello-world-tutorial/intro) tem instruções para configurar seu ambiente de desenvolvimento local no Windows, Linux ou macOS.
...
Você criará aplicativos usando [`dotnet new`](../../../core/tools/dotnet-new.md) o comando. Este comando gera os arquivos e ativos necessários para o seu aplicativo. Todos os tutoriais de introdução ao C# usam o tipo de aplicativo `console`. Depois de conhecer as noções básicas, você poderá expandir para outros tipos de aplicativo.

Os outros comandos que [`dotnet build`](../../../core/tools/dotnet-build.md) você usará são para [`dotnet run`](../../../core/tools/dotnet-run.md) construir o executável, e para executar o executável.
...
## <a name="branches-and-loops"></a>[Ramificações e loops](branches-and-loops-local.md)
