...
Bem-vindo aos tutoriais de introdução ao C#. Eles começam com lições interativas que podem ser executadas em seu navegador. Você pode aprender o básico de C# da série de [vídeoC# 101](https://aka.ms/dotnet3-csharp) antes de iniciar essas lições interativas.
...
No tutorial [Olá, Mundo](hello-world.yml), você criará o programa C# mais básico. Você explorará o tipo `string` e como trabalhar com texto.
...
## <a name="branches-and-loops"></a>[Ramificações e loops](branches-and-loops.yml)
