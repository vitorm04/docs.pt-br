---
title: "O modelo de evento padrão do .NET"
description: "O modelo de evento padrão do .NET"
...
# <a name="the-standard-net-event-pattern"></a>O modelo de evento padrão do .NET
