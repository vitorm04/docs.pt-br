...
Você também pode usar a mesma sintaxe para testar se um [tipo de valor anulado](../language-reference/builtin-types/nullable-value-types.md) tiver um valor, conforme mostrado no seguinte código de amostra:
