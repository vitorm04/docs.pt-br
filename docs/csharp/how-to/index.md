...
- [Use a sobrecarga de operador](../programming-guide/statements-expressions-operators/how-to-use-operator-overloading-to-create-a-complex-number-class.md).
...
- [Acesse todos os elementos em uma coleção usando `foreach`](../programming-guide/classes-and-structs/how-to-access-a-collection-class-with-foreach.md).
...
- [Converta uma cadeia de caracteres para um <xref:System.DateTime>](../programming-guide/strings/how-to-convert-a-string-to-a-datetime.md).
