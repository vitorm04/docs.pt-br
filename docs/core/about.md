...
- Tipos de dados, como <xref:System.Data.DataSet?displayProperty=nameWithType> e [DbSet][dbset].
- Tipos de alto desempenho, como <xref:System.Numerics.Vector?displayProperty=nameWithType> e [Pipelines][pipelines].
