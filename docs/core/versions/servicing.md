---
title: "Manutenção do .NET Core | Microsoft Docs"
description: "Manutenção do .NET Core"
...
# <a name="-net-core-servicing"></a>🔧 Manutenção do .NET Core

> **Observação**
> 
> Este tópico ainda não foi criado! 
>
> Agradecemos a sua contribuição para ajudar a moldar o escopo e a abordagem. Você pode acompanhar o status e fornecer comentários sobre esse [problema](https://github.com/dotnet/docs/issues/469) no GitHub.
> 
