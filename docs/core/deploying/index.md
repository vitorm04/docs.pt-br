...
- A menos que substituídas, as FDDs usarão o runtime mais recente instalado no sistema de destino. Isso permite que seu aplicativo use a versão corrigida mais atual do runtime do .NET Core. 
...
- É possível que o runtime e as bibliotecas do .NET Core sejam alteradas em versões futuras, sem seu conhecimento. Em casos raros, isso pode alterar o comportamento do seu aplicativo.
