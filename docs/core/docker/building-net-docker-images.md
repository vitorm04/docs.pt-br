...
> [!IMPORTANT]
> Estamos em processo de atualização deste artigo para o .NET Core 2.0. As instruções a seguir estão desatualizadas. Pedimos sinceras desculpas pelo inconveniente!
