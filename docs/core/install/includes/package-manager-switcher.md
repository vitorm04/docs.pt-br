...
_As instalações do Gerenciador de pacotes têm suporte apenas na arquitetura **x64** _. Outras arquiteturas, como o **ARM**, devem [instalar manualmente o SDK do .NET Core](../sdk.md?pivots=os-linux#download-and-manually-install) ou [instalar manualmente o tempo de execução do .NET Core](../runtime.md?pivots=os-linux#download-and-manually-install). Para obter mais informações, consulte [dependências e requisitos do .NET Core](../dependencies.md).
