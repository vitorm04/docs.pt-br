...
- [Analisador de portabilidade .net](../../standard/analyzers/portability-analyzer.md) – um ferramentas que pode gerar um relatório de como o seu código é portável entre .NET Framework e .NET Core: como uma [ferramenta de linha de comando](https://github.com/Microsoft/dotnet-apiport/releases) como uma extensão do [Visual Studio](https://visualstudiogallery.msdn.microsoft.com/1177943e-cfb7-4822-a8a6-e56c7905292b)
