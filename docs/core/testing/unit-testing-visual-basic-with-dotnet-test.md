...
Dentro deste novo diretório, corra [`dotnet new sln`](../tools/dotnet-new.md) para criar uma nova solução. Essa prática facilita gerenciar a biblioteca de classes e o projeto de teste de unidade.
...
Faça *do PrimeService* o [`dotnet new classlib -lang VB`](../tools/dotnet-new.md) diretório atual e execute para criar o projeto de origem. Renomeie *Class1.VB* para *PrimeService.VB*. Crie uma implementação com falha da classe `PrimeService`:
...
Altere o diretório de volta para o diretório *unit-testing-vb-using-dotnet-test*. Execute [`dotnet sln add .\PrimeService\PrimeService.vbproj`](../tools/dotnet-sln.md) para adicionar o projeto da biblioteca de classe à solução.
...
Faça do *diretório PrimeService.Tests* o diretório atual e [`dotnet new xunit -lang VB`](../tools/dotnet-new.md)crie um novo projeto usando . Esse comando cria um projeto de teste que usa o xUnit como a biblioteca de teste. O modelo gerado configura o executor de teste no *PrimeServiceTests.vbproj*:
...
O projeto de teste requer outros pacotes para criar e executar testes de unidade. `dotnet new` na etapa anterior adicionou xUnit e o executor de xUnit. Agora, adicione a biblioteca de classes `PrimeService` como outra dependência ao projeto. Use [`dotnet add reference`](../tools/dotnet-add-reference.md) o comando:

```dotnetcli
dotnet add reference ../PrimeService/PrimeService.vbproj
```

Você pode ver o arquivo inteiro no [repositório de exemplos](https://github.com/dotnet/samples/blob/master/core/getting-started/unit-testing-vb-dotnet-test/PrimeService.Tests/PrimeService.Tests.vbproj) no GitHub.
...
Execute [`dotnet sln add .\PrimeService.Tests\PrimeService.Tests.vbproj`](../tools/dotnet-sln.md) no diretório *de teste de unidade-vb-usando-dotnet-test.*
