...
> Você pode seguir o guia do MSBuild integraton [aqui](https://github.com/coverlet-coverage/coverlet/blob/master/Documentation/MSBuildIntegration.md)
