...
Por [Nate McMaster](http://github.com/natemcmaster)
...
> [!NOTE]
> Muitos dos padrões glob padrão são adicionados automaticamente pelo SDK do .NET Core.
...
[Referência de project.json](project-json.md)
