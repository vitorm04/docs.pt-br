...
Na pasta *nome do botsay-\<>* , navegue até um nível para a pasta do *repositório* :
...
Invoque a ferramenta executando o comando `dotnet tool run` da pasta do *repositório* :
