...
- **Selar um tipo que foi previamente desselado**
...
- **✔️ Reduzir a visibilidade de um tipo**
...
- **✔ Adicionar um construtor a uma classe, junto com um construtor padrão (sem parâmetros) se a classe anteriormente não tinha construtores**
   ...
   No entanto, adicionar um construtor a uma classe que anteriormente não tinha construtores *sem* adicionar o construtor padrão não é permitido.
...
- **Renomear um parâmetro (incluindo alterar seu caso)**
...
- **️ Alterar de um `ref readonly` para um valor de retorno `ref` em um método ou interface virtual**
...
- **Transformar um membro virtual em um membro abstrato**
...
- **Adicionar uma sobrecarga que inviabiliza uma sobrecarga existente e define um comportamento diferente**
...
- **Adicionar um construtor a uma classe que anteriormente não tinha construtor sem adicionar o construtor padrão**

- **️ Adicionar [readonly](../../csharp/language-reference/keywords/readonly.md) a um campo**

- **✔️ Reduzir a visibilidade de um membro**
...
- **Aumentar o intervalo de valores aceitos para uma propriedade ou parâmetro se o membro não for [virtual](../../csharp/language-reference/keywords/virtual.md)**
...
- **Reduzir o intervalo de valores aceitos para uma propriedade ou parâmetro**

- **Aumentar o intervalo de valores retornados para uma propriedade, campo, valor de retorno ou parâmetro [out](../../csharp/language-reference/keywords/out-parameter-modifier.md)**

- **Alterar os valores retornados para uma propriedade, campo, valor de retorno ou parâmetro [out](../../csharp/language-reference/keywords/out-parameter-modifier.md)**
...
- **Não dar suporte ou agora a exigir um pacote de serviço específico para uma operação que anteriormente tinha suporte em uma plataforma**
...
- **Remover a geração de um evento em determinada ação**
