...
---
# <a name="breaking-changes-for-migration-from-version-30-preview-7-to-30"></a>Alterações recentes para migração da versão 3,0 Preview 7 para 3,0
...
Se você estiver migrando do 3,0 Preview 7 para 3,0 do .NET Core, ASP.NET Core ou EF Core, examine os tópicos a seguir para obter alterações significativas que possam afetar seu aplicativo:
