...
## <a name="build-and-install"></a><span data-ttu-id="8e154-152">Compilar e instalar</span><span class="sxs-lookup"><span data-stu-id="8e154-152">Build and install</span></span>
