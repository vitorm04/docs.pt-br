...
1. Pressione <kbd>Shift</kbd> + <kbd>F5</kbd> para compilar e executar o programa sem depuração.
...
> [Testar uma biblioteca de .NET Standard com o .NET Core usando o Visual Studio](testing-library-with-visual-studio.md)
