...
---
# <a name="build-a-net-standard-library-with-c-and-the-net-core-sdk-in-visual-studio-2017"></a>Criar uma biblioteca .NET Standard com C# e o SDK do .NET Core no Visual Studio 2017
