---
title: "Gravando aplicativos de console do .NET Core usando as ferramentas CLI: um guia passo a passo avançado | Microsoft Docs"
...
# 🔧 Gravando aplicativos de console do .NET Core usando as ferramentas de CLI: um guia passo a passo avançado
