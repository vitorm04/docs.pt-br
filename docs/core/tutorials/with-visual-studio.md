...
Para obter mais informações, consulte o artigo [dependências e requisitos do .NET Core](../install/sdk.md?tabs=netcore30&pivots=os-windows#install-with-visual-studio).
