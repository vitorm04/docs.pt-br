...
O ASP.NET Core 3.0 apresenta um novo modelo para a criação de uma interface do usuário sofisticada, interativa e combinável chamado Blazor. O lado do servidor mais incrivelmente permite que os desenvolvedores criem interface do usuário com o Razor no servidor e que esse código seja entregue ao navegador e executado no lado do cliente usando o [Webassembly](https://webassembly.org/). O lado do servidor mais recente está disponível agora com o ASP.NET Core 3,0 ou posterior. O lado do cliente de mais alto que deve estar disponível em 2020.
...
| ---------------------------------------------------- | ----------------------- | --------------------------- | --------------- |
| É necessária a familiaridade da equipe com JavaScript/TypeScript | **Mínimo**             | **Necessário**                | **Mínimo**     |
