...
![Azure Cosmos DB é um banco de dados de baixa latência garantido globalmente distribuído que pode ser acessado com quatro protocolos de API. ](./media/image19.1.png)
