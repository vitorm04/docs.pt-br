...
**Imagem multi-arco**: Para multiarquitetura, é um recurso que simplifica a seleção da imagem apropriada, de acordo com a plataforma onde o Docker está sendo executado. Por exemplo, quando um arquivo Docker solicita uma imagem base **de mcr.microsoft.com/dotnet/core/sdk:3.1** do registro, ele realmente obtém **3.1-sdk-nanoserver-1909**, **3.1-sdk-nanoserver-1809** ou **3.1-sdk-buster-slim**, dependendo do sistema operacional e da versão onde o Docker está sendo executado.
