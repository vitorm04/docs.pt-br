...
---
# <a name="migrate-from-aspnet-web-forms-to-blazor"></a>Migrar do ASP.NET Web Forms paraBlazor
...
### <a name="model-validation-in-blazor"></a>Validação de modelo emBlazor
