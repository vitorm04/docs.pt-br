...
- O Docker está se tornando o verdadeiro padrão no setor de contêineres e é compatível com os fornecedores mais significativos nos ecossistemas do Windows e do Linux, incluindo a Microsoft. No futuro, o Docker provavelmente será onipresente em qualquer datacenter na nuvem ou local.
...
- Um ambiente de DevOps de ponta a ponta que oferece suporte à Integração Contínua/Implantação Contínua e que se conecta aos ambientes de produção do Docker pode fornecer agilidade e, dessa forma, melhorar o tempo de entrega de seus aplicativos.
