...
![Um diagrama mostrando a taxonomia básica em Docker.](./media/docker-containers-images-and-registries/taxonomy-docker-terms-concepts.png)
...
>[anterior](road-to-modern-applications-based-on-containers.md)
