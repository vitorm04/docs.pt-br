...
- Se um chamador não tiver confiança total, mas ainda tentar chamar essa biblioteca, o tempo de execução lançará uma <xref:System.Security.SecurityException> e o chamador não terá permissão para vincular à biblioteca.  
