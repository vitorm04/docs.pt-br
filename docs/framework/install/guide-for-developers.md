...
> [!NOTE]
> Para saber mais sobre o .NET Framework 3.5, veja [Instalação do .NET Framework 3.5 no Windows 8 e versões posteriores](~/docs/framework/install/net-framework-3-5-on-windows-8-plus.md).
