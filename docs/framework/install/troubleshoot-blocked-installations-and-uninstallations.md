...
description: Soluciona problemas que você encontra que impedem a instalação do Quadro .NET. Consulte mensagens de status para obter informações para resolver problemas.
ms.date: 04/18/2019
...
|O .NET Framework 4.5.x já faz parte deste sistema operacional, mas está atualmente desligado (apenas o Windows Server 2012).| Use **os recursos do Windows ligados ou desligados** no painel de **controle** para ativar o .NET Framework 4.5.x. |  
