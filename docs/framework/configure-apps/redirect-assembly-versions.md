...
### <a name="relying-on-automatic-binding-redirection"></a>Depender de redirecionamento de associação automática  
 ...
 Você pode habilitar o redirecionamento de associação automático se seu aplicativo for destinado a versões mais antigas do .NET Framework em [!INCLUDE[vs_dev12](../../../includes/vs-dev12-md.md)]. Você pode substituir esse comportamento padrão, fornecendo informações de redirecionamento de associação no arquivo App. config para qualquer assembly ou desativar o recurso de redirecionamento de associação. Para obter informações sobre como ativar ou desativar a esse recurso, consulte [como: habilitar e desabilitar o redirecionamento automático de associações](../../../docs/framework/configure-apps/how-to-enable-and-disable-automatic-binding-redirection.md).  
