...
---
# <a name="sqlworkflowinstancestore"></a>\<sqlWorkflowExemplodearmazenamento>
Um comportamento de serviço que permite configurar o recurso <xref:System.Activities.DurableInstancing.SqlWorkflowInstanceStore>, que dá suporte a informações de estado persistentes para instâncias de serviço de fluxo de trabalho em um banco de dados do SQL Server 2005 ou do SQL Server 2008. Para obter mais informações sobre esse recurso, consulte [SQL Workflow Instance Store](../../../windows-workflow-foundation/sql-workflow-instance-store.md).  
...
|connectionStringName|Uma cadeia de caracteres que contém uma cadeia de conexão nomeada para o servidor de banco de dados. Um exemplo de uma seqüência de conexão nomeada é "DefaultConnectionString".|  
