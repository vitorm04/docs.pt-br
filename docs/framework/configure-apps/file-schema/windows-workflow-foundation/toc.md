# [Esquema de configuração do Windows Workflow Foundation](index.md)
...
######## [<states>](states.md)
######### [<state>](state.md)
###### [Usando a anotação em consultas](using-annotation-in-queries.md)
## [Referência gerenciada adicional](additional-managed-reference.md)
...
#### [Microsoft.VisualStudio.Activities.Asr.ClientActivityBuilder... construtor](microsoft-visualstudio-activities-asr-clientactivitybuilder-ctor.md)
