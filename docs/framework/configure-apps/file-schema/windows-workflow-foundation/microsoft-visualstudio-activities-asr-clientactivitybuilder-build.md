...
## <a name="syntax"></a><span data-ttu-id="3036f-104">Sintaxe</span><span class="sxs-lookup"><span data-stu-id="3036f-104">Syntax</span></span>  
  
```csharp  
public ActivityBuilder Build();   
```  
  
## <a name="return-value"></a><span data-ttu-id="3036f-105">Valor de retorno</span><span class="sxs-lookup"><span data-stu-id="3036f-105">Return Value</span></span>  
 <span data-ttu-id="3036f-106">Retorna um objeto <xref:System.Activities.ActivityBuilder>.</span><span class="sxs-lookup"><span data-stu-id="3036f-106">Returns a <xref:System.Activities.ActivityBuilder> object.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="3036f-107">Consulte também</span><span class="sxs-lookup"><span data-stu-id="3036f-107">See Also</span></span>  
 [<span data-ttu-id="3036f-108">Microsoft.VisualStudio.Activities.Asr.ClientActivityBuilder</span><span class="sxs-lookup"><span data-stu-id="3036f-108">Microsoft.VisualStudio.Activities.Asr.ClientActivityBuilder</span></span>](../../../../../docs/framework/configure-apps/file-schema/windows-workflow-foundation/microsoft-visualstudio-activities-asr-clientactivitybuilder.md)
