...
Você pode configurar um aplicativo ASP.NET para usar as configurações de compatibilidade adicionando um [\<Add>](../appsettings/add-element-for-appsettings.md) elemento à [\<appSettings>](../appsettings/index.md) seção do arquivo Web. config.
