...
Quando você executar o exemplo no .NET Framework 3.5 ou em uma versão anterior, ele exibe a saída a seguir:
...
No entanto, se você adicionar o seguinte arquivo de configuração para o diretório de exemplo e, em seguida, executar o exemplo no .NET Framework 4 ou versão posterior, a saída é idêntica à produzida pelo exemplo quando ele é executado no .NET Framework 3.5.
