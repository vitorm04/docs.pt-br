...
```  
 ...
 No entanto, se você adicionar o arquivo de configuração a seguir ao exemplo do diretório e, em seguida, executar o exemplo na [!INCLUDE[net_v40_long](../../../../../includes/net-v40-long-md.md)] ou versão posterior, a saída é idêntica à produzida pelo exemplo quando ele é executado em [!INCLUDE[net_v35_short](../../../../../includes/net-v35-short-md.md)].  
