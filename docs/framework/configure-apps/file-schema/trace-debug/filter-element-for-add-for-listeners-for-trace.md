...
---
# <a name="filter-element-for-add-for-listeners-for-trace"></a>\<filtrar> \<Element \<para adicionar \<> para ouvintes> para rastrear>
Adiciona um filtro a um `Listeners` ouvinte na coleção para um rastreamento.  
