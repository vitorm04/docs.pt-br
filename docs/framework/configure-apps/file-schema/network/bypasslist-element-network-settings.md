...
## <a name="remarks"></a>Comentários  
 A lista de bypass contém expressões regulares que descrevem URIs <xref:System.Net.WebRequest> que as instâncias acessam diretamente em vez de por meio do servidor proxy.  
