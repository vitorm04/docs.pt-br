...
|[\<par >](../../../../../docs/framework/configure-apps/file-schema/wcf/peer-of-servicecredentials.md)|Especifica as credenciais atuais para um nó par. Esse elemento é do tipo <xref:System.ServiceModel.Configuration.PeerCredentialElement>.|  
