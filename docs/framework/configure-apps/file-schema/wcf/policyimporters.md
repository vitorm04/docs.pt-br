...
## <a name="see-also"></a><span data-ttu-id="ed662-105">Consulte também</span><span class="sxs-lookup"><span data-stu-id="ed662-105">See Also</span></span>  
 <xref:System.ServiceModel.Configuration.MetadataElement>  
 <xref:System.ServiceModel.Configuration.PolicyImporterElementCollection>  
 <xref:System.ServiceModel.Description.MetadataImporter>  
 [<span data-ttu-id="ed662-106">\<policyImporter ></span><span class="sxs-lookup"><span data-stu-id="ed662-106">\<policyImporter></span></span>](../../../../../docs/framework/configure-apps/file-schema/wcf/policyimporter.md)  
 [<span data-ttu-id="ed662-107">Configuração de cliente do WCF</span><span class="sxs-lookup"><span data-stu-id="ed662-107">WCF Client Configuration</span></span>](../../../../../docs/framework/wcf/feature-details/client-configuration.md)  
 [<span data-ttu-id="ed662-108">Clientes</span><span class="sxs-lookup"><span data-stu-id="ed662-108">Clients</span></span>](../../../../../docs/framework/wcf/feature-details/clients.md)
