...
|Elemento|Descrição|
|-------------|-----------------|
|[> \<segurança](security-of-wsfederationhttpbinding.md)|Define as configurações de segurança para a mensagem. Este elemento é do tipo <xref:System.ServiceModel.Configuration.WSFederationHttpSecurityElement>.|
