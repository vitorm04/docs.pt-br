...
|[> \<segurança](security-of-netpeerbinding.md)|Define as configurações de segurança para a mensagem. Este elemento é do tipo <xref:System.ServiceModel.Configuration.PeerSecurityElement>.|  
