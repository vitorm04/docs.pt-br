...
|Elemento|Descrição|  
|-------------|-----------------|  
|[> \<segurança](security-of-netnamedpipebinding.md)|Define as configurações de segurança para a associação. Este elemento é do tipo <xref:System.ServiceModel.Configuration.NetNamedPipeBindingElement>.|  
