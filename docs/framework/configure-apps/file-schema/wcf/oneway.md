...
|Elemento|Descrição|  
|-------------|-----------------|  
|[\<channelPoolSettings >](channelpoolsettings.md)|Um objeto <xref:System.ServiceModel.Configuration.ChannelPoolSettingsElement> que contém as propriedades do pool de canais para o canal atual.|  
