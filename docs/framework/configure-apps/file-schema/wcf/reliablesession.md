...
|Atributo|Descrição|  
|---------------|-----------------|  
|acknowledgementInterval|Um <xref:System.TimeSpan> que contém o intervalo de tempo máximo que o canal vai aguardar para enviar uma confirmação para as mensagens recebidas até esse ponto. O padrão é 00:00:0.2.|  
