...
|Atributo|Descrição|  
|---------------|-----------------|  
|`mode`|-Opcional. Especifica o tipo de segurança que é aplicada. O padrão é `Message`.<br /><br /> Esse atributo é do tipo <xref:System.ServiceModel.SecurityMode>.|  
