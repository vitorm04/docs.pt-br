...
Esta seção de configuração contém todas as [!INCLUDE[indigo1](../../../../../includes/indigo1-md.md)] elementos de configuração do ServiceModel.  
...
|[\<roteamento >](../../../../../docs/framework/configure-apps/file-schema/wcf/routing.md)|Esta seção define um conjunto de filtros de roteamento, que determinam o tipo de [!INCLUDE[indigo1](../../../../../includes/indigo1-md.md)] <xref:System.ServiceModel.Dispatcher.MessageFilter> a ser usada ao avaliar mensagens recebidas, bem como o roteamento de tabelas que definem os pontos de extremidade de destino para enviar mensagens para quando houver correspondência de filtro.|  
