...
---
# <a name="tracking-of-wcf"></a>\<acompanhamento de > do WCF
...
|Elemento|Descrição|  
|-------------|-----------------|  
|[\<participants>](../windows-workflow-foundation/participants.md)|Uma coleção de elementos de configuração que define os participantes que assinam os registros de rastreamento. Os participantes de rastreamento contém a lógica para processar a carga de registros de rastreamento (por exemplo, eles poderiam optar por gravar em um arquivo).|  
