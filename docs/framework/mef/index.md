...
- Adicione uma referência ao assembly System.ComponentModel.Composition, no qual reside o MEF.

- Abra o Module1.vb ou o Program.cs e adicione as instruções `Imports` ou `using` System.ComponentModel.Composition e System.ComponentModel.Composition.Hosting. Esses dois namespaces contêm tipos MEF que você precisará para desenvolver um aplicativo extensível.
...
Se você estiver usando o Visual Basic, Module1, adicione uma classe pública denominada `Program`.

Adicione a seguinte linha para à classe `Program` no Module1 ou Program.cs:
