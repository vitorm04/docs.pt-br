...
## <a name="see-also"></a>Consulte também  
 ...
 [Por dentro do .NET Native (vídeo do Channel 9)](http://channel9.msdn.com/Shows/Going+Deep/Inside-NET-Native)   
