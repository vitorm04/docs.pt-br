...
1. Crie o serviço. Para obter um tutorial desse procedimento básico, consulte [introdução tutorial](getting-started-tutorial.md).  
...
2. Depois de criar o cliente WCF, defina a propriedade <xref:System.ServiceModel.Security.WindowsClientCredential.AllowedImpersonationLevel%2A> da classe <xref:System.ServiceModel.Security.WindowsClientCredential> como um dos valores de enumeração <xref:System.Security.Principal.TokenImpersonationLevel>.  
...
- [Representar o cliente](./samples/impersonating-the-client.md)
