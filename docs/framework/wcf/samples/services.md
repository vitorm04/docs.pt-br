...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Demonstra a hospedagem de serviços WCF.  
 ...
 Demonstra comportamentos de serviço do WCF.  
 ...
 Demonstra como implementar e configurar um cliente usando o WCF e serviço típico.  
 ...
 Demonstra a proteção estendida, uma iniciativa de segurança para proteger contra ataques de (MITM) man-in-the-middle.  
  
 [Fábrica de canais de configuração](../../../../docs/framework/wcf/samples/configuration-channel-factory.md)  
 Demonstra o uso da <xref:System.ServiceModel.Configuration.ConfigurationChannelFactory%601>.  
 ...
 Demonstra como definir um <<!--zz xref:System.ServiceModel.WsHttpBinding --> `xref:System.ServiceModel.WsHttpBinding`> para um serviço usando código, em vez de definir o `wsHttpBinding` na configuração de associação.  
