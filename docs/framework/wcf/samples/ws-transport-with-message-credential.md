...
```  
 ...
 O endereço especificado usa o esquema https://. A configuração de associação define o modo de `TransportWithMessageCredential`segurança como. O mesmo modo de segurança deve ser especificado no arquivo Web. config do serviço.  
