...
```  
 ...
 O <xref:System.ServiceModel.Description.WebScriptEndpoint> define o formato de dados padrão para o serviço em JSON em vez de XML. Para invocar o serviço, navegue até http://localhost/ServiceModelSamples/service.svc/Add?n1=100&n2=200 depois de concluir o conjunto de backup e criar etapas mostradas neste tópico. Essa funcionalidade de teste é habilitada pelo uso de uma solicitação HTTP GET.  
