...
## <a name="in-this-section"></a>Nesta seção  
 [Contrato de dados básicos](../../../../docs/framework/wcf/samples/basic-data-contract.md)  
 ...
 Demonstra a <xref:System.Runtime.Serialization.DataContractSerializer>, que realiza geral serialização e desserialização de serviços para os dados de classes de contrato.  
