...
ms.locfileid: "61972374"
---
# <a name="net-msmq-binding"></a>Associação de MSMQ de rede
Esta seção contém exemplos que demonstram como usar atributos de associação de MSMQ de um elemento de ponto de extremidade.  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Demonstra como realizar a comunicação em fila volátil por meio do transporte de enfileiramento de mensagens (MSMQ).  
  
 [Filas de mensagens mortas](../../../../docs/framework/wcf/samples/dead-letter-queues.md)  
 Demonstra como manipular e processar as mensagens com falha na entrega.  
  
 [Tratamento de mensagens suspeitas no MSMQ 4.0](../../../../docs/framework/wcf/samples/poison-message-handling-in-msmq-4-0.md)  
 Demonstra como executar manipulação em um serviço usando o MSMQ 4.0 de mensagens suspeitas.  
 ...
 Demonstra como executar transacionada comunicação em fila usando o serviço de enfileiramento de mensagens (MSMQ) em HTTP.  
 ...
 Demonstra como implementar um aplicativo que usa WS-Security com autenticação de certificado X.509v3 para o cliente e requer autenticação de servidor usando o certificado X.509v3 do servidor em relação ao MSMQ.
