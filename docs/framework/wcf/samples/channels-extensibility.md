...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Demonstra como compor WCF e perfil seguro confiável (RSP).  
 ...
 Demonstra como limitar a quantidade de memória usada para armazenar em buffer grandes mensagens enviadas usando o WCF.  
