...
1. Execute Setup.bat na pasta de instalação de exemplo dentro de um prompt de comando do Visual Studio 2012. Isso instala todos os certificados necessários para executar o exemplo.
...
2. Copie os arquivos de programa de serviço no diretório de serviço no computador de serviço. Copie também os arquivos de Setup.bat e Cleanup.bat para o computador de serviço.  
...
1. Execute Cleanup.bat na pasta Samples depois de concluir a execução do exemplo. Isso remove o certificado do servidor do repositório de certificados.
