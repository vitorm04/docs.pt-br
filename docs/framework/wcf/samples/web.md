...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Demonstra como estender o [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] modelo de programação HTTP Web para dar suporte a novos formatos de resposta de saída.  
 ...
 Demonstra como implementar um serviço baseado em HTTP usando o [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] modelo de programação HTTP Web que expõe uma coleção de clientes que dá suporte a recuperar, adicionar, excluir e substituir operações.  
 ...
 Demonstra como implementar um serviço baseado no RPC e expô-lo no formato SOAP e o formato "Plain Old XML" (POX) usando o [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] modelo de programação HTTP Web.  
  
 [Integração de cache ASP.NET](../../../../docs/framework/wcf/samples/aspnet-caching-integration.md)  
 Demonstra como utilizar o cache de saída do ASP.NET com o [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] modelo de programação HTTP Web.  
