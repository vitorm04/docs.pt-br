...
3.  Se [!INCLUDE[vs_current_long](../../../../includes/vs-current-long-md.md)] não estiver instalado, e seu sistema operacional não é Windows Server 2008 SP2 ou posterior, instale [251798 Hotfix](https://go.microsoft.com/fwlink/?LinkId=184693).  
