...
Esta seção contém exemplos que demonstram os transportes personalizados no [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)].  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Demonstra como estender o exemplo de transporte UDP para oferecer suporte ao fluxo de transação personalizado e mostra o uso do <xref:System.ServiceModel.Channels.TransactionMessageProperty> propriedade.  
  
 [Transporte: WSE 3.0 TCP interoperabilidade](../../../../docs/framework/wcf/samples/transport-wse-3-0-tcp-interoperability.md)  
 Este exemplo demonstra como implementar uma sessão duplex TCP como um personalizado [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] transporte.
