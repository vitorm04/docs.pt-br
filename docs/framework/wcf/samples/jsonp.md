...
```  
 ...
 O exemplo consiste em dois aplicativos de web do ASP.NET: um contém apenas um serviço WCF, e outra contém a página da Web. aspx, que chama o serviço. Ao executar a solução, [!INCLUDE[vs_current_long](../../../../includes/vs-current-long-md.md)] hospedará os dois sites em portas diferentes, que cria um ambiente em que o serviço e o cliente residem em domínios diferentes.  
