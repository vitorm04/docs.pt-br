...
Esta seção contém exemplos que demonstram [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] gerenciamento.  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Rastreamento analítico do WCF](../../../../docs/framework/wcf/samples/wcf-analytic-tracing.md)  
 ...
 [Provedor WMI](../../../../docs/framework/wcf/samples/wmi-provider.md)  
