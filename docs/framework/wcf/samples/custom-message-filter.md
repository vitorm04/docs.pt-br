...
Este exemplo demonstra como substituir a mensagem de filtros que [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] usa para enviar mensagens a pontos de extremidade.  
