...
> O procedimento de instalação e as instruções de Build para este exemplo estão localizados no final deste tópico.  
 ...
 A propriedade do `Endpoint` cliente permite acesso a informações sobre o ponto de extremidade de serviço com o qual o cliente está se comunicando, incluindo informações de endereço, associação e contrato. A propriedade do `InnerChannel` cliente é uma instância do <xref:System.ServiceModel.IClientChannel> que permite o acesso a informações sobre o canal subjacente, como seu estado e identificador de sessão.  
