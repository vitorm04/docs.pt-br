...
A seção [ \<System. ServiceModel >](../../../docs/framework/configure-apps/file-schema/wcf/system-servicemodel.md) descreve os elementos que são usados para configurar [!INCLUDE[indigo1](../../../includes/indigo1-md.md)] clientes e serviços.
