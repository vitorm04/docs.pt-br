...
A seção [ \<System. ServiceModel >](../../../docs/framework/configure-apps/file-schema/wcf/system-servicemodel.md) descreve os elementos que são usados para configurar os clientes do Windows Communication Foundation (WCF) e serviços.
