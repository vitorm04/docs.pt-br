...
O WCF agora tem suporte para desenvolvimento do primeiro contrato. A ferramenta de svcutil.exe tem uma opção /serviceContract que permite que você gere contratos de serviço e dados de um documento WSDL.
