...
O WCF agora tem suporte para desenvolvimento do primeiro contrato. A ferramenta svcutil. exe tem um comutador/serviceContract que permite gerar contratos de serviço e de dados de um documento WSDL.
