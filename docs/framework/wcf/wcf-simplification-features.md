...
> [!IMPORTANT]
>  Consulte "Usando XML com segurança" em [considerações de segurança para dados](../../../docs/framework/wcf/feature-details/security-considerations-for-data.md) para obter mais informações sobre como proteger seus dados.  
