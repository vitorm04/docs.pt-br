...
|/collectionType:\<type>|Especifica o tipo de coleção da lista para um cliente do WCF.<br/><br /> Padrão: o tipo de coleção é System. Array. <br /><br /> Forma abreviada: `/ct`|  
