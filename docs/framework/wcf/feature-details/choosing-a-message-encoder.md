...
Este tópico discute os critérios para escolher entre os codificadores de mensagem que estão incluídos no [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)]: binário, o texto e o mecanismo de otimização de transmissão mensagem (MTOM).  
...
|Interoperabilidade|Esse fator refere-se à capacidade de um [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] codificador para interoperar com não[!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] serviços.|Texto<br /><br /> MTOM (parcial)|  
