...
> [!WARNING]
> Ao usar o transporte de pipe nomeado com uma reserva de URL de caractere curinga fraco em vários sites hospedados no IIS, o seguinte erro pode ocorrer: Ocorreu um erro no serviço de ativação ' NetPipeActivator ' do protocolo ' net. pipe ' ao tentar escutar o site ' 2 ', portanto, o protocolo está desabilitado para o site temporariamente. Consulte a mensagem de exceção para obter mais detalhes. URL: WeakWildcard: net. pipe:/\<nome da máquina >/status: Exceção ConflictingRegistration:  Nome do processo: ID do processo SMSvcHost: 1076\  
