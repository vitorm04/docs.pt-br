...
> [!WARNING]
>  Instalar a extensão WebDAV para IIS pode fazer com que os serviços da Web HTTP retornar um erro HTTP 405 como o WebDAV tentativas de extensão para manipular todas as solicitações PUT. Para contornar esse problema, você pode desinstalar a extensão WebDAV ou desabilitar a extensão WebDAV para seu site. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][IIS e WebDav](http://learn.iis.net/page.aspx/357/webdav-for-iis-70/)  
...
|<xref:System.DateTime>|DD/MM/AAAA<br /><br /> DD/MM/AAAA HH [AM &#124; PM]<br /><br /> Mês dia/ano<br /><br /> Dia do mês ano hh [AM &#124; PM]|  
|<xref:System.TimeSpan>|DD. HH<br /><br /> Onde DD = dias, HH = horas, MM = minutos, SS = segundos|  
