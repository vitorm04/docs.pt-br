...
### <a name="configuration"></a>Configuração  
 A configuração a seguir configura o mesmo ponto de extremidade usando a configuração. Observe duas ligações: uma protege o serviço hospedado no subsistema confiável e o outro se comunica entre o subsistema confiável e o serviço de back-end.  
