...
---
# <a name="how-to-secure-messages-within-reliable-sessions"></a>Como: Mensagens seguras em sessões confiáveis
...
Esse procedimento é descrito em [como: Trocar mensagens dentro de uma sessão confiável](../../../../docs/framework/wcf/feature-details/how-to-exchange-messages-within-a-reliable-session.md).
