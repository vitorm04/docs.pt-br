...
## <a name="in-this-section"></a>Nesta seção  
 [Cenários de canal par](../../../../docs/framework/wcf/feature-details/peer-channel-scenarios.md):  Descreve os cenários de desenvolvimento compatíveis com as APIs de canal par, por exemplo, publicação/assinatura de mensagens, colaboração, distribuído de processamento e jogos.  
  
 [Conceitos de canal par](../../../../docs/framework/wcf/feature-details/peer-channel-concepts.md):  Descreve as malhas ponto a ponto, nós pares, segurança de canal par e resolvedores de pares.  
