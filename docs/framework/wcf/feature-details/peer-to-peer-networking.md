...
## <a name="in-this-section"></a>Nesta seção  
 [Cenários de canal de mesmo nível](../../../../docs/framework/wcf/feature-details/peer-channel-scenarios.md): Descreve cenários de desenvolvimento com suporte das APIs de canal par, por exemplo, mensagens, colaboração, publicação/assinatura distribuídas de processamento e jogos.  
  
 [Conceitos de canal de mesmo nível](../../../../docs/framework/wcf/feature-details/peer-channel-concepts.md): descreve malhas de ponto a ponto, nós pares, segurança de canal par e resolvedor Peer.  
...
## <a name="peer-channel-code-examples"></a>Exemplos de código de canal par  
 [Resolvedor de pares personalizado de canal par](http://msdn.microsoft.com/library/5b75a2bb-7ff1-4a14-abe7-3debf0537d23)  
  
## <a name="peer-channel-team-blog"></a>Blog da equipe do canal par  
 [Blog da equipe do canal par](http://go.microsoft.com/fwlink/?LinkID=114530) (http://go.microsoft.com/fwlink/?LinkID=114530)
