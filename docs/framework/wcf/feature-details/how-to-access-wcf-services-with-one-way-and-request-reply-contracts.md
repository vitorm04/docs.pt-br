...
Os procedimentos a seguir descrevem como acessar um [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] serviço que define um contrato unidirecional e um contrato de solicitação-resposta e que não usa o padrão de comunicação duplex.  
