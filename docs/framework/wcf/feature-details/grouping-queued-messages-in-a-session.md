...
2.  Criar o cliente WCF usando o [Ferramenta Utilitária de metadados ServiceModel (Svcutil.exe)](../../../../docs/framework/wcf/servicemodel-metadata-utility-tool-svcutil-exe.md) ferramenta.  
...
### <a name="description"></a>Descrição  
 O exemplo a seguir fornece o código para o `IProcessOrder` de serviço e para um cliente que usa este serviço. Ele mostra como o WCF usa as sessões na fila para fornecer o comportamento do agrupamento.  
