...
3.  Adicione o GeneratedClient.cs localizado na parte inferior deste tópico para o projeto.  
...
4.  Abra o arquivo Program.cs e adicione o seguinte método. Esse método usa um endereço de ponto de extremidade e usa para inicializar o cliente do serviço (proxy).  
...
5.  Adicione o seguinte código ao método de `Main` .  
 ...
 Você concluiu a implementação do aplicativo cliente. Continue no [como: testar o Proxy de descoberta](../../../../docs/framework/wcf/feature-details/how-to-test-the-discovery-proxy.md).  
  
## <a name="example"></a>Exemplo  
 É o código completo listando deste tópico.  
