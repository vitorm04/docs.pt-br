...
---
# <a name="how-to-improve-the-startup-time-of-wcf-client-applications-using-the-xmlserializer"></a>Como: Melhorar o tempo de inicialização do WCF cliente aplicativos usando o XmlSerializer
