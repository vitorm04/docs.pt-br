...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Um serviço básico do Windows Communication Foundation (WCF) desenvolvido para fornecer informações em uma rede privada segura para um aplicativo WCF.  
 ...
 Mostra um cliente e o serviço protegidos pela segurança de mensagem WCF.  
