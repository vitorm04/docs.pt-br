...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Fornece uma visão geral do suporte de sindicalização fornecido pelo WCF.  
 ...
 Descreve os métodos de adição de elementos personalizados e atributos para um feed de sindicalização.  
