...
Os tópicos nesta seção descrevem as funcionalidades transacionais do Windows Communication Foundation (WCF) fornece.  
  
## <a name="in-this-section"></a>Nesta seção  
 [Atributos de transação de ServiceModel](../../../../docs/framework/wcf/feature-details/servicemodel-transaction-attributes.md)  
 Descreve o padrão de dois <xref:System.ServiceModel> atributos que permitem que você configure o comportamento das transações de um serviço WCF.  
 ...
 Descreve como usar o recurso de diagnóstico e gerenciamento do WCF para solucionar o seu aplicativo transacional.  
 ...
 Descreve como integrar seus serviços WCF com o código que usa o serviço de empresa.
