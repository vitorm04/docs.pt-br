...
|SOAP 1.2 Core|[Parte 1 do SOAP versão 1.2: Estrutura de mensagens (segunda edição)](https://go.microsoft.com/fwlink/?LinkId=94664)|  
...
|Endereçamento 1.0 metadados do W3C Web Services|[Metadados de 1.0 - endereçamento de serviços da Web](https://www.w3.org/TR/ws-addr-metadata/)|  
...
|WSS: X509 Profile 1.1 de token|[Web Services Security certificado perfil de Token X.509 1.1](https://go.microsoft.com/fwlink/?LinkId=95332)|  
...
|WS-ReliableMessaging 1.1|[Protocolo de mensagem confiável versão 1.1](../../../../docs/framework/wcf/feature-details/reliable-messaging-protocol-version-1-1.md)|  
...
|WS-AtomicTransaction|[Transação atômica de serviços da Web](https://go.microsoft.com/fwlink/?LinkId=95323)|  
 ...
 O <xref:System.ServiceModel.Description.MetadataExporter>, <xref:System.ServiceModel.Description.MetadataImporter>, <xref:System.ServiceModel.Description.WsdlExporter>, <xref:System.ServiceModel.Description.WsdlImporter>, e <xref:System.ServiceModel.Description.MetadataResolver> classes oferecem suporte para as seguintes especificações de metadados:  
  
-   [Esquema XML parte 1: Segunda edição das estruturas](https://go.microsoft.com/fwlink/?LinkId=3536)  
  
-   [XML Schema Part 2: Tipos de dados Second Edition](https://go.microsoft.com/fwlink/?LinkId=40138)  
...
-   [1.2 mecanismo WS-PolicyAttachment](https://go.microsoft.com/fwlink/?LinkId=96707)  
...
- [Protocolo de mensagem confiável versão 1.1](../../../../docs/framework/wcf/feature-details/reliable-messaging-protocol-version-1-1.md)
