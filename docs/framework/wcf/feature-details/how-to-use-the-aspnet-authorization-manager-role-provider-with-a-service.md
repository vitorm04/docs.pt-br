...
---
# <a name="how-to-use-the-aspnet-authorization-manager-role-provider-with-a-service"></a>Como: Usar o provedor de função do Gerenciador de autorização do ASP.NET com um serviço
