...
5. Opcional. Para habilitar a confirmação de assinatura durante a inicialização, adicione uma [ \<secureConversationBootstrap >](../../../../docs/framework/configure-apps/file-schema/wcf/secureconversationbootstrap.md) elemento filho e defina o `requireSignatureConfirmation` atributo `true`.
