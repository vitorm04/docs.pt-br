...
---
# <a name="how-to-use-svcutilexe-to-export-metadata-from-compiled-service-code"></a>Como: Use Svcutil.exe para exportar metadados de código de serviço compilado
