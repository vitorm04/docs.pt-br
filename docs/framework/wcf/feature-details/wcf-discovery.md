...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Fornece uma visão geral de uma implementação de protótipo de alguns novos recursos de descoberta. Ele também fornece uma visão geral sobre como selecionar a versão de descoberta para usar.  
