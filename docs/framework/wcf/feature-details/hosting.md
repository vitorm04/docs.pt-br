...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Descreve como um serviço do Windows Communication Foundation (WCF) é hospedado no Internet Information Services ou [do Windows Server AppFabric](http://go.microsoft.com/fwlink/?LinkId=196496).  
 ...
 Descreve como um serviço WCF é hospedado em IIS ou do WAS sem usar um arquivo. svc.  
