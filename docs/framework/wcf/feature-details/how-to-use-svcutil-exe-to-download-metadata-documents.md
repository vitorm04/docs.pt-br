...
> - Defina um dos namespaces de operações para um namespace diferente usando a propriedade <xref:System.ServiceModel.ServiceContractAttribute.Namespace%2A>.
...
2. No prompt de comando, inicie a ferramenta usando o formato a seguir.  
    ...
    ```  
     ...
     Você deve especificar a opção `/t:metadata` para baixar metadados. Caso contrário, o código do cliente e a configuração serão gerados.  
