...
Este tópico resume as diferenças no recurso de filas do Windows Communication Foundation (WCF) entre o Windows Vista, o Windows Server 2003 e o [!INCLUDE[wxp](../../../../includes/wxp-md.md)].  
...
## <a name="application-specific-dead-letter-queue"></a>Fila de mensagens mortas específica do aplicativo  
 ...
 O Windows Vista fornece filas de mensagens mortas específicas do aplicativo. As filas de mensagens mortas específicas do aplicativo não estão disponíveis no Windows Server 2003 e [!INCLUDE[wxp](../../../../includes/wxp-md.md)], e os aplicativos devem usar a fila de mensagens mortas de todo o sistema.  
