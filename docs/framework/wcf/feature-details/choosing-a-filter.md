...
### <a name="matchall"></a>MatchAll  
 O filtro filtro matchall corresponde a qualquer mensagem recebida. Isso é útil se você sempre deve rotear todas as mensagens recebidas para um ponto de extremidade específico, como um serviço de registro em log que armazena uma cópia de todas as mensagens recebidas. O exemplo a seguir define `FilterElement` um que usa o filtro filtro matchall.  
...
```  
 ...
 Para obter mais informações sobre como criar consultas XPath, consulte [Sintaxe XPath](https://go.microsoft.com/fwlink/?LinkId=164592).  
