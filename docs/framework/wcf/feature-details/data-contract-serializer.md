...
O [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] infraestrutura usa a <xref:System.Runtime.Serialization.DataContractSerializer> classe como o serializador padrão. Os tópicos nesta seção fornecem mais detalhes para usá-lo como um serializador autônomo.  
  
## <a name="in-this-section"></a>Nesta seção  
 [Serialização e desserialização](../../../../docs/framework/wcf/feature-details/serialization-and-deserialization.md)  
 Fornece detalhes sobre como usar o <xref:System.Runtime.Serialization.DataContractSerializer> documentos de classe para gráficos de objeto de serializar e desserializar o XML em objetos.  
  
 [Exportação e importação de esquema](../../../../docs/framework/wcf/feature-details/schema-import-and-export.md)  
 Explica como gerar um esquema de linguagem XSD de definição de esquema XML de um [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] como gerar código a partir de um documento de esquema XSD ou classe.  
