...
## <a name="authorization-manager"></a>Gerenciador de autorização  
 ...
 Para obter mais informações sobre o AzMan e o [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] provedor de função, consulte [How To: Use Gerenciador de autorização (AzMan) com o ASP.NET 2.0](https://go.microsoft.com/fwlink/?LinkId=88951). Para obter mais informações sobre como usar o provedor de função e AzMan para os serviços WCF, consulte [como: usar o provedor de função do Gerenciador de autorização do ASP.NET com um serviço](../../../../docs/framework/wcf/feature-details/how-to-use-the-aspnet-authorization-manager-role-provider-with-a-service.md).  
