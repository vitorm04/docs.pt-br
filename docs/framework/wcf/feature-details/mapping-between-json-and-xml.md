...
|[valor normalizado] de `JSON Type Attribute`do todos|Permitido [filhos] o EII correspondente|Mapeando para JSON|  
|---------------------------------------------------------|---------------------------------------------------|---------------------|  
