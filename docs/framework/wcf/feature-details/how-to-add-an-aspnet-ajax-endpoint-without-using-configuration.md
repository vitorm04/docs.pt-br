...
---
# <a name="how-to-add-an-aspnet-ajax-endpoint-without-using-configuration"></a>Como: Adicionar um ponto de extremidade do ASP.NET AJAX sem utilizar a configuração
