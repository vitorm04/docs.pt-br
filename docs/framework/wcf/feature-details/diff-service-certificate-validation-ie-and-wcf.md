...
## <a name="see-also"></a>Consulte também  
 [Diferenças de validação de certificado entre HTTPS, SSL através de TCP e segurança SOAP](../../../../docs/framework/wcf/feature-details/cert-val-diff-https-ssl-over-tcp-and-soap.md)  
