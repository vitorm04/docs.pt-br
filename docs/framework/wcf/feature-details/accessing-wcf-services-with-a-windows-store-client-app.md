...
Os modos de segurança a seguir têm suporte em aplicativos da Windows Store:
...
Os seguintes tipos de credencial do cliente têm suporte em aplicativos da Windows Store:
