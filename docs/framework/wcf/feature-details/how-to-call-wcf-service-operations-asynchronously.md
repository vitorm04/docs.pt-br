...
## <a name="see-also"></a>Consulte também  
 [How to: Implement an Asynchronous Service Operation](../../../../docs/framework/wcf/how-to-implement-an-asynchronous-service-operation.md) (Como implementar uma operação de serviço assíncrona)
