...
Os artigos nesta seção apresentam orientações e itens a serem considerados ao criar aplicativos de Windows Communication Foundation de segurança (WCF). Para obter mais informações sobre o Windows Server AppFabric e a segurança, consulte [modelo de segurança para o Windows Server app Fabric](https://docs.microsoft.com/previous-versions/appfabric/ee677202(v=azure.10))  
