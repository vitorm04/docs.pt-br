...
|esquema XML|[XML Schema Part 2: Datatypes Second Edition](https://go.microsoft.com/fwlink/?LinkId=94861) e [esquema XML parte 1: estruturas Second Edition](https://go.microsoft.com/fwlink/?LinkId=94862)<br /><br /> O WCF usa o esquema XML para descrever tipos de dados usados em mensagens.|  
