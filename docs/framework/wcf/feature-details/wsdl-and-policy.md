...
|msf:Streamed|Ponto de extremidade|Ponto de extremidade usa quadros mensagem transmitida. Essa declaração é usada com o protocolo Message Framing fornecido para os transportes, como TCP e pipes nomeados.|  
