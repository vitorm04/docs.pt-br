...
Os tópicos nesta seção descrevem [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] recursos de segurança e como usá-los para ajudar a proteger mensagens.  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]Windows Server AppFabric e segurança, consulte [modelo de segurança para o Windows Server AppFabric](http://go.microsoft.com/fwlink/?LinkID=201279&clcid=0x409)  
