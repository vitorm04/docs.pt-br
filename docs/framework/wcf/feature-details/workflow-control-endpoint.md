...
ms.locfileid: "69988552"
---
# <a name="workflow-control-endpoint"></a>Ponto de extremidade de controle de fluxo de trabalho
O ponto de extremidade de controle de fluxo de trabalho permite aos desenvolvedores chamar operações de controle <xref:System.ServiceModel.Activities.WorkflowServiceHost>para controlar remotamente as instâncias de fluxo de trabalho hospedadas Esse recurso pode ser usado para realizar programaticamente operações de controle como suspender, retomar e encerrar.  
  
> [!WARNING]
> Se você estiver usando o ponto de extremidade de controle do fluxo de trabalho dentro de <xref:System.Activities.Statements.Persist> uma transação e o fluxo de trabalho que está sendo controlado contiver uma atividade, a instância do fluxo de trabalho será bloqueada até que  
  
## <a name="workflow-instance-management"></a>Gerenciamento de instância de fluxo de trabalho  
 [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)]define um novo contrato chamado <xref:System.ServiceModel.Activities.IWorkflowInstanceManagement>. Este contrato define uma série de operações de controle que permitem controlar remotamente as instâncias de fluxo <xref:System.ServiceModel.Activities.WorkflowServiceHost>de trabalho hospedadas pelo. <xref:System.ServiceModel.Activities.WorkflowControlEndpoint>é um ponto de extremidade padrão que fornece uma implementação <xref:System.ServiceModel.Activities.IWorkflowInstanceManagement> do contrato. <xref:System.ServiceModel.Activities.WorkflowControlClient>é uma classe que é usada para enviar as operações de controle para <xref:System.ServiceModel.Activities.WorkflowControlEndpoint>o.  
