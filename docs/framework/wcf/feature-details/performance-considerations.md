...
Considerações sobre desempenho sempre é importantes ao criar aplicativos. Esta seção contém as entradas relacionadas à segurança e desempenho.  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Descreve o mecanismo mais rápido para encontrando declarações em uma coleção de declarações.  
  
 [Criptografia de assinaturas digitais](../../../../docs/framework/wcf/feature-details/encryption-of-digital-signatures.md)  
 Descreve como criptografar a assinatura digital pode adicionar uma penalidade de desempenho e como desativá-la.  
