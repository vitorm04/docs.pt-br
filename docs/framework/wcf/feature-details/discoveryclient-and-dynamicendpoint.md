...
```  
 ...
 Para obter mais informações sobre como tornar assíncrona localizar chamadas, consulte [localizar assíncrona](../../../../docs/framework/wcf/samples/asynchronous-find-sample.md).  
