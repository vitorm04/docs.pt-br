...
## <a name="performance-counters"></a>Contadores de desempenho  
 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] Fornece um conjunto padrão de contadores de desempenho para medir o desempenho do seu aplicativo transacional. Para obter mais informações, consulte [Contadores de desempenho](../../../../docs/framework/wcf/diagnostics/performance-counters/index.md).  
...
-   Padrão [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] rastreamento  
     ...
     Esse tipo de rastreamento é o mesmo que rastreamento qualquer [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] aplicativo. Para obter mais informações, consulte [Configurando rastreamento](../../../../docs/framework/wcf/diagnostics/tracing/configuring-tracing.md).  
