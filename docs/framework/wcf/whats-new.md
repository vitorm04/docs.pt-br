...
### <a name="simplified-generated-configuration-files"></a>Arquivos de configuração gerados simplificados  
 ...
 Para obter mais informações, consulte [recursos de simplificação do WCF](../../../docs/framework/wcf/wcf-simplification-features.md)  
...
|receiveTimeout|SMSvcHost.exe|30 segundos|[Configurando o serviço de compartilhamento de porta NET.TCP](http://msdn.microsoft.com/library/b6dd81fa-68b7-4e1b-868e-88e5901b7ea0)|  
