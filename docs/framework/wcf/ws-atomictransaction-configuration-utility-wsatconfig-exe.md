...
## <a name="remarks"></a>Comentários  
 ...
 Se você estiver executando o Windows XP ou o Windows Server 2003, deverá baixar uma atualização antes de executar o WsatConfig. exe. Para obter mais informações sobre essa atualização, consulte [Update for Windows Communication Foundation (KB912817)](https://www.microsoft.com/download/details.aspx?id=21520).  
...
|-Servidor virtual:\<servidor virtual >|Especifica o nome do cluster de recursos do DTC.|  
