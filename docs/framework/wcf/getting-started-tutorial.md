...
## <a name="in-this-section"></a>Nesta seção
 ...
 Descreve como implementar um contrato de serviço. Quando um contrato é definido, ele deve ser implementado com uma classe de serviço.
