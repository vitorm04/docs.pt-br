...
-   Os clientes e serviços de envio e recebem de falhas de SOAP como exceções.  
 ...
 Além disso, os serviços e clientes do WCF podem usar falhas de soap não declarado para fins de depuração e podem estender o comportamento de erro padrão. As seções a seguir discutem esses conceitos e tarefas.  
