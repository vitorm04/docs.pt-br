...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Visão geral das quais associações WCF fazer, quais associações que o sistema fornece e como você pode definir ou modificá-los.  
  
 [Associações fornecidas pelo sistema](../../../docs/framework/wcf/system-provided-bindings.md)  
 Uma lista de associações incluídas com o WCF. Essas associações abrangem a maioria dos requisitos de segurança e mensagem padrão.  
