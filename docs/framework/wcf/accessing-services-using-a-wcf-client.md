...
```
 ...
 A ferramenta de utilitário de metadados ServiceModel e o **Adicionar referência de serviço** no Visual Studio geram a seguinte classe de cliente WCF. A classe herda da classe <xref:System.ServiceModel.ClientBase%601> genérica e implementa a interface `ICalculator`. A ferramenta também gera a interface `ICalculator` (não mostrada aqui).
...
- [Como acessar um WSE 3.0 Service](./feature-details/how-to-access-a-wse-3-0-service-with-a-wcf-client.md)
- [Entendendo o código do cliente gerado](./feature-details/understanding-generated-client-code.md)
- [Como melhorar o tempo de inicialização de aplicativos clientes WCF usando o XmlSerializer](./feature-details/startup-time-of-wcf-client-applications-using-the-xmlserializer.md)
