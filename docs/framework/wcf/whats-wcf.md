...
## <a name="features-of-wcf"></a>Recursos do WCF  
 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] inclui o seguinte conjunto de recursos. [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [Detalhes do recurso WCF](../../../docs/framework/wcf/feature-details/index.md).  
...
-   **Interoperabilidade**  
     ...
     [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] implementa modernos padrões para interoperabilidade de serviço da Web. [!INCLUDE[crabout](../../../includes/crabout-md.md)] os padrões com suporte, consulte [interoperabilidade e integração](../../../docs/framework/wcf/feature-details/interoperability-and-integration.md).  
