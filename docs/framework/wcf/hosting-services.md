...
|IIS 5.1, [!INCLUDE[iis601](../../../includes/iis601-md.md)]|-Executando um serviço WCF lado a lado com o conteúdo ASP.NET na Internet usando o protocolo HTTP.|-Reciclagem de processo.<br />-Desligamento ocioso.<br />-Monitoramento de integridade de processo.<br />-Ativação baseada em mensagem.<br />-Apenas para HTTP.|  
