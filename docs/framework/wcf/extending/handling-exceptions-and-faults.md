...
## <a name="communicating-faults"></a>Falhas de comunicação  
 ...
 ![Tratamento de exceções e falhas](../../../../docs/framework/wcf/extending/media/wcfc-soap1-1andsoap1-2faultcomparisonc.gif "wcfc_SOAP1-1AndSOAP1-2FaultComparisonc")  
...
- Além dos componentes principais, você pode usar a [ferramenta Visualizador de rastreamento de serviço (SvcTraceViewer. exe)](../../../../docs/framework/wcf/service-trace-viewer-tool-svctraceviewer-exe.md) para exibir e Pesquisar rastreamentos do WCF. A ferramenta foi projetada especificamente para arquivos de rastreamento gerados pelo WCF e escrito usando <xref:System.Diagnostics.XmlWriterTraceListener>o. A figura a seguir mostra os vários componentes envolvidos no rastreamento.  
  
 ![Tratamento de exceções e falhas](../../../../docs/framework/wcf/extending/media/wcfc-tracinginchannelsc.gif "wcfc_TracingInChannelsc")  
