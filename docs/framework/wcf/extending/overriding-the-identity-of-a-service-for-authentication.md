...
Normalmente, você não precisa definir a identidade em um serviço porque a seleção de um tipo de credencial de cliente determina o tipo de identidade exposto nos metadados do serviço. Por exemplo, o código de configuração a seguir usa o `clientCredentialType` [ \<elemento WSHttpBinding >](../../configure-apps/file-schema/wcf/wshttpbinding.md) e define o atributo como Windows.  
