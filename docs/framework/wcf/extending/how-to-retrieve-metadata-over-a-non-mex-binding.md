...
5.  Neste ponto, você tem uma coleção de pontos de extremidade de serviço. [!INCLUDE[crabout](../../../../includes/crabout-md.md)]importação de metadados, consulte [como: importar metadados para pontos de extremidade de serviço](../../../../docs/framework/wcf/feature-details/how-to-import-metadata-into-service-endpoints.md).  
