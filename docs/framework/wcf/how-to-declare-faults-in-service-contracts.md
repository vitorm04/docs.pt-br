...
1. Crie um contrato de serviço que contenha pelo menos uma operação. Para obter um exemplo, consulte [ Defina um contrato](how-to-define-a-wcf-service-contract.md)de serviço.
