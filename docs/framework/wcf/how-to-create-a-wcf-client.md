...
3. Adicione uma referência de serviço para o serviço da Calculadora.
   ...
   3. Insira a seguinte URL na caixa de endereço de **adicionar referência de serviço** caixa de diálogo: [http://localhost:8000/GettingStarted/CalculatorService](http://localhost:8000/GettingStarted/CalculatorService)
