...
|Dá suporte a serviços de compilação com padrões WS-* como Mensagens Confiáveis, Transações, Segurança da Mensagem.|Usa o protocolo básico e formatos como HTTP, WebSockets, SSL, JQuery, JSON e XML. Não há suporte para protocolos de nível mais alto como Mensagens Confiáveis ou Transações.|  
