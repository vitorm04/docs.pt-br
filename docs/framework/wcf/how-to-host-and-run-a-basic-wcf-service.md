...
Este é o terceiro de seis tarefas necessárias para criar um aplicativo do Windows Communication Foundation (WCF). Para obter uma visão geral de todos os seis das tarefas, consulte o [Tutorial de Introdução](../../../docs/framework/wcf/getting-started-tutorial.md) tópico.  
  
 Este tópico descreve como hospedar um serviço do Windows Communication Foundation (WCF) em um aplicativo de console. Este procedimento consiste nas seguintes etapas:  
