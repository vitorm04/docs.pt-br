# [Usando o Windows Management Instrumentation para diagnóstico](index.md)
## [Referência de classe WMI](wmi-class-reference.md)
...
### [Classe de comportamento](behavior-class.md)
...
### [Ponto de extremidade](endpoint.md)
...
### [Classe MessageEncodingBindingElement](messageencodingbindingelement.md)
...
### [Classe de operação](operation-class.md)
### [OperationBehaviorAttribute](operationbehaviorattribute.md)
### [Classe PeerCustomResolverBindingElement](peercustomresolverbindingelement.md)
### [Classe PeerResolverBindingElement](peerresolverbindingelement.md)
