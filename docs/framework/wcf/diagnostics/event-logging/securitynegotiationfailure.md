...
## <a name="description"></a>Descrição  
 Esse evento indica que houve falha na negociação de segurança. O evento lista o serviço de ação, identidade do cliente, ID da atividade e negociação.  
