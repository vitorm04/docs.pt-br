...
## <a name="description"></a>Descrição  
 Esse evento indica que a solicitação de PutInstance WMI não foi processada. A listas de eventos do objeto WMI, a exceção, o nome do processo e o processo de identificação.  
