...
## <a name="description"></a>Descrição  
 Esse evento indica que a solicitação PutInstance WMI não foi processada. As listas de eventos do objeto WMI, a exceção, o nome do processo e o processo de identificação.  
