...
## <a name="description"></a>Descrição  
 Esse evento indica que a solicitação ExecMethod do WMI não foi processada. O evento de lista de exceção, o nome do processo e o ID de processo.  
