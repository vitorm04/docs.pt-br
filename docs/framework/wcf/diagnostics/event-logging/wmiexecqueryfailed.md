...
## <a name="description"></a>Descrição  
 Esse evento indica que a solicitação de WMI ExecQuery não foi processada. O evento de lista de exceção, o nome do processo e a ID de processo.  
