...
## <a name="description"></a>Descrição  
 Esse evento indica que uma solicitação para iniciar o serviço falhou. O evento lista o código de erro, o nome do processo e a ID de processo.  
