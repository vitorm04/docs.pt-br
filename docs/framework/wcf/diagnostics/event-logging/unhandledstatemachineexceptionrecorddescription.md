...
## <a name="description"></a>Descrição  
 Esse evento indica que uma exceção sem tratamento foi gerada enquanto uma máquina de estado estava processando um evento. Listas de evento a ID da transação, nome da máquina de estado, estado atual, histórico, ID de inscrição, exceção, o nome do processo e processo de identificação.  
