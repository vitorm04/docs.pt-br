...
## <a name="description"></a>Descrição  
 Esse evento indica que uma exceção sem tratamento gerada enquanto uma máquina de estado estava processando um evento. A ID da transação de listas de eventos, nome da máquina de estado, estado atual, histórico, identificação da inscrição, exceção, nome do processo e processo de identificação.  
