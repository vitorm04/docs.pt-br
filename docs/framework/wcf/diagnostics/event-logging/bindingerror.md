...
## <a name="description"></a>Descrição  
 Esse evento indica que ocorreu um erro ao analisar a associação específica do site específico, portanto, o protocolo é desabilitado para o site temporariamente. O evento de lista de associação, o código-fonte, exceção, nome do processo e ID de processo.  
