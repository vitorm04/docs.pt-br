...
Este tópico lista todas as exceções geradas por canais de transporte de Pipe nomeado.  
...
|PipeShutdownReadError|Falha na operação de leitura do indicador pipe 'desligamento'.|  
|PipeShutdownWriteError|A operação de gravação do indicador pipe 'desligamento' falhou.|  
