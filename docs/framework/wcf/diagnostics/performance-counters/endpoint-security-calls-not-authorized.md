---
title: 'Ponto de extremidade: Chamadas de segurança não autorizadas'
ms.date: 03/30/2017
...
ms.locfileid: "61916273"
---
# <a name="endpoint-security-calls-not-authorized"></a>Ponto de extremidade: Chamadas de segurança não autorizadas
