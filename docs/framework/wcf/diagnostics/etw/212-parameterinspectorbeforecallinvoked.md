...
## <a name="description"></a>Descrição  
 Esse evento é emitido depois que o modelo de serviço tem chamado a `BeforeCall` método em um `ParameterInspector`.  
  
## <a name="message"></a>Mensagem  
 O Dispatcher invocado BeforeCall em um ParameterInspector do tipo '%1'.  
