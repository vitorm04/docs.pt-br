...
## <a name="description"></a>Descrição  
 Esse evento é emitido quando o manipulador de mensagens Http iniciou o processamento da solicitação de entrada.  
  
## <a name="message"></a>Mensagem  
 Manipulador de mensagens HTTP iniciou o processamento da solicitação de entrada.  
