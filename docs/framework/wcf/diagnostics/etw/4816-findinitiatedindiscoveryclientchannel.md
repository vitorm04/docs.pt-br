...
## <a name="description"></a>Descrição  
 Esse evento é emitido quando uma operação find foi iniciada no DiscoveryClientChannel para descobrir a extremidade.  
  
## <a name="message"></a>Mensagem  
 Uma operação Find foi iniciada no DiscoveryClientChannel para descobrir a extremidade.  
