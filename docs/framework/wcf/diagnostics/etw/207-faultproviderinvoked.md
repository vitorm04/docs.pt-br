...
## <a name="description"></a>Descrição  
 Esse evento é emitido após um `FaultProvider` foi invocado.  
  
## <a name="message"></a>Mensagem  
 O Dispatcher invocado um FaultProvider do tipo '%1' com uma exceção do tipo '%2'.  
...
|ExceptionTypeName|`xs:string`|O FullName de CLR da exceção que o `FaultProvider` tem operado.|  
