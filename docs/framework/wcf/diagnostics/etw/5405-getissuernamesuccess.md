...
## <a name="description"></a>Descrição  
 Esse evento é emitido quando a recuperação do nome do emissor foi bem-sucedida.  
  
## <a name="message"></a>Mensagem  
 Recuperação de emissor nome: % 1 de tokenid: % 2 foi bem-sucedida.  
