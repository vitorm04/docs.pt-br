...
## <a name="description"></a>Descrição  
 Esse evento é emitido após o modelo de serviço foi invocado o `AfterCall` método em um `ParameterInspector`.  
...
|--------------------|--------------------|-----------------|  
|Nome do tipo|`xs:string`|O FullName do CLR do tipo de chamada `ParameterInspector`.|  
