...
## <a name="description"></a>Descrição  
 Esse evento é emitido depois que o modelo de serviço tem chamado a `AfterCall` método em um `ParameterInspector`.  
  
## <a name="message"></a>Mensagem  
 O Dispatcher invocado AfterCall em um ParameterInspector do tipo '%1'.  
