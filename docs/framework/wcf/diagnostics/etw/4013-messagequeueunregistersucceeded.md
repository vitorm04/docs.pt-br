...
## <a name="description"></a>Descrição  
 Esse evento é emitido quando a fila de mensagens cancelar o registro foi concluída com êxito.  
  
## <a name="message"></a>Mensagem  
 Fila de mensagens cancelar o registro com êxito para o uri: '%1'.  
