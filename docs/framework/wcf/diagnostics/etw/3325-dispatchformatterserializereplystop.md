...
## <a name="description"></a>Descrição  
 Esse evento é emitido quando o dispatcher concluída serialização da mensagem de resposta.  
  
## <a name="message"></a>Mensagem  
 Serialização de Dispatcher concluída da mensagem de resposta.  
