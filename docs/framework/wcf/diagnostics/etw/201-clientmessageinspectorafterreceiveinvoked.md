...
## <a name="description"></a>Descrição  
 Esse evento é emitido depois que o modelo de serviço tenha chamado o `AfterReceiveReply` método em um Inspetor de mensagens do cliente.  
  
## <a name="message"></a>Mensagem  
 O Dispatcher invocado AfterReceiveReply em um ClientMessageInspector do tipo '%1'.  
