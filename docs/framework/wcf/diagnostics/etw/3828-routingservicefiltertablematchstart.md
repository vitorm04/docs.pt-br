...
## <a name="description"></a>Descrição  
 Esse evento é emitido quando a correspondência de MessageFilterTable do serviço de roteamento foi iniciada.  
  
## <a name="message"></a>Mensagem  
 Início de correspondência de MessageFilterTable do serviço de roteamento.  
