...
## <a name="description"></a>Descrição  
 Esse evento é emitido quando uma fábrica de canais ficou antiga no cache porque o cache atingiu seu limite.  
  
## <a name="message"></a>Mensagem  
 Uma fábrica de canais ficou antiga no cache porque o cache atingiu seu limite de '%1'.  
