...
## <a name="description"></a>Descrição  
 Esse evento é emitido quando o registro de fila de mensagens falhou.  
  
## <a name="message"></a>Mensagem  
 Registro de fila para o uri da mensagem: '%1' falhou com o status: '%2'.  
