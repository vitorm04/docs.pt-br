...
ms.locfileid: "33474741"
---
# <a name="end-to-end-tracing-scenarios"></a>Cenários de rastreamento ponta a ponta
Esta seção contém tópicos que descrevem os diferentes cenários para usar o rastreamento.  
  
 Rastreamento de atividades é implementado para resposta, OneWay e Duplex cenários usando o seguinte  
...
-   Propagação de id de atividade de usuário  
