...
## <a name="description"></a>Descrição  
 ...
 Essa é uma operação bidirecional; No entanto, não haverá nenhuma resposta para enviar ao cliente. Você pode usar este rastreamento para depuração durante o desenvolvimento.  
