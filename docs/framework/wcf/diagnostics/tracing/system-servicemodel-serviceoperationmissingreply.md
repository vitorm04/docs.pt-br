...
## <a name="description"></a>Descrição  
 A operação de solicitação/resposta não tem nenhuma mensagem de resposta.  
  
 Essa é uma operação bidirecional; No entanto, não há nenhuma resposta para enviar ao cliente. Você pode usar este rastreamento para depuração durante o desenvolvimento.  
