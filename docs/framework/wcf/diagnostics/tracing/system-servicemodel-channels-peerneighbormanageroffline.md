...
PeerNode está off-line, indicando que há não atualmente conectado vizinhos.  
  
## <a name="description"></a>Descrição  
 Este rastreamento ocorre após a remoção de um vizinho de lista de vizinho do nó local.  
