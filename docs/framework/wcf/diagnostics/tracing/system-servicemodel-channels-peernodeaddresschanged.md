...
ms.locfileid: "59188943"
---
# <a name="systemservicemodelchannelspeernodeaddresschanged"></a>System.ServiceModel.Channels.PeerNodeAddressChanged
Um ou mais dos endereços do PeerNode foi alterado.  
  
## <a name="description"></a>Descrição  
 Este rastreamento ocorre na conclusão do retorno de chamada de notificação de alteração de endereço.  
