...
A transação especificada fluiu para a operação especificada.  
  
## <a name="description"></a>Descrição  
 Rastreadas se foi recebida no fluxo de transação disponibilizada ao código do usuário de uma fonte externa.  
