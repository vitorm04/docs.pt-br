...
## <a name="description"></a>Descrição  
 Rastreamento de nível de aviso indica que uma resposta de canal HTTP foi anulada. Informações adicionais neste rastreamento revelará a razão ou a mensagem passada para o método de anulação.  
