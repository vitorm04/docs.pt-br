...
## <a name="description"></a>Descrição  
 Este rastreamento de nível de aviso indica que uma resposta de canal HTTP anulada. Informações adicionais neste rastreamento revelará a razão ou a mensagem transmitida para o método de anulação.  
