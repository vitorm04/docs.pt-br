...
## <a name="description"></a>Descrição  
 Resolução do timer do sistema operacional foi detectada como *n* tiques, que é aproximadamente *m* milissegundos. Em que *n* e *m* são valores numéricos.  
