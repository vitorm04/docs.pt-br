...
ms.locfileid: "59193675"
---
# <a name="systemservicemodelunhandledaction"></a>System.ServiceModel.UnhandledAction
System.ServiceModel.UnhandledAction  
  
## <a name="description"></a>Descrição  
 Nenhum serviço disponível para tratar essa ação.  
  
 Todos os rastreamentos de contador de desempenho podem ser usados para depurar o contador de desempenho relacionados a problemas.  
