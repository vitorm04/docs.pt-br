...
## <a name="description"></a>Descrição  
 Um objeto de comunicação falha ao anular porque ocorreu uma exceção durante a execução de seu método de anulação. Outra mais próxima de rastreamento pode conter detalhes sobre a exceção.  
