...
Uma mensagem foi recebida pelo PeerNode, mas não é propagada para vizinhos.  
  
## <a name="description"></a>Descrição  
 Este rastreamento ocorre durante o processamento de uma mensagem de inundação de entrada.  
  
## <a name="troubleshooting"></a>Solução de problemas  
 Verifique se um filtro de propagação de mensagem existe.  
