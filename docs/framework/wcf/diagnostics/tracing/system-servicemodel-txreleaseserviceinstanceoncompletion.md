...
## <a name="description"></a>Descrição  
 Rastreada quando a instância atual do serviço é liberada ou descartada devido a conclusão da transação ativa atual e ReleaseServiceInstanceOnTransactionComplete estiver definido como `true`.  
