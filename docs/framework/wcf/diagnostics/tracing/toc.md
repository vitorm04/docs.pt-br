...
## [Usando o rastreamento para solucionar problemas do seu aplicativo](using-tracing-to-troubleshoot-your-application.md)
...
### [Emitindo rastreamentos de código do usuário](emitting-user-code-traces.md)
## [Configurações recomendadas para rastreamento e registro de mensagem](recommended-settings-for-tracing-and-message-logging.md)
