...
### [Atividade](activity.md)
### [Transferência](transfer.md)
### [Propagação](propagation.md)
### [Resumo de tipo de rastreamento](trace-type-summary.md)
## [Usando o rastreamento para solucionar problemas de seu aplicativo](using-tracing-to-troubleshoot-your-application.md)
### [Usando o Visualizador de Rastreamento de Serviço para exibir rastreamentos correlacionados e solucionar problemas](using-service-trace-viewer-for-viewing-correlated-traces-and-troubleshooting.md)
...
#### [Rastreamento de atividades em segurança de mensagem](activity-tracing-in-message-security.md)
#### [MSMQ](msmq.md)
#### [COM+](com.md)
### [Rastreamentos significativos](significant-traces.md)
### [Depuração do cliente](debugging-on-the-client.md)
### [Emitindo traços de código do usuário](emitting-user-code-traces.md)
## [Configurações recomendadas para rastreamento e o registro de mensagem](recommended-settings-for-tracing-and-message-logging.md)
## [Questões de segurança e dicas úteis para rastreamento](security-concerns-and-useful-tips-for-tracing.md)
