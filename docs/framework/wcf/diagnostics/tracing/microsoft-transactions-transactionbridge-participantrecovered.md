...
Uma inscrição de participante foi recuperada do log de Gerenciador de transações.  
  
## <a name="description"></a>Descrição  
 Rastreada quando o Gerenciador de transações local tiver realizado com sucesso recuperação para uma inscrição de participante subordinada determinada.  
