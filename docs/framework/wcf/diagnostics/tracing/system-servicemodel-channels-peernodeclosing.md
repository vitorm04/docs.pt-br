...
manager: wpickett
ms.openlocfilehash: 5196c437159a98b2950bdffe3c2b15feb51a2c8a
...
PeerNode foi iniciado fechar.  
  
## <a name="description"></a>Descrição  
 Este rastreamento ocorre no início da execução de fechamento em PeerNode.  
