...
## <a name="description"></a>Descrição  
 Rastreado se o TransactionManager local não é capaz de registrar com seu TransactionManager superior devido a dificuldades para enviar uma mensagem.  
  
## <a name="troubleshooting"></a>Solução de problemas  
 Inspecione a mensagem de rastreamento para a exceção, causando a falha de envio de mensagem  
