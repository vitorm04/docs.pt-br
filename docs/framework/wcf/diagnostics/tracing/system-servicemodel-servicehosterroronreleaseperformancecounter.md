...
## <a name="description"></a>Descrição  
 Ocorreram erros no ServiceHost ao chamar ReleasePerformanceCounters. Este rastreamento pode ser usado para determinar os erros ao lançar contadores de desempenho.  
