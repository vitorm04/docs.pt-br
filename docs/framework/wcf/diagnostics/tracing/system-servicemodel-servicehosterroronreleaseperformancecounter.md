...
## <a name="description"></a>Descrição  
 Erros em ServiceHost ao chamar ReleasePerformanceCounters. Esse rastreamento pode ser usado para determinar os erros ao lançar os contadores de desempenho.  
