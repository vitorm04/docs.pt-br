...
## <a name="description"></a>Descrição  
 Dados de configuração para o NetPipeSection foram lidos com os dados especificados: com os dados especificados: maxConnectionsPendingDispatch, maxPendingAccepts e receiveTimeout.  
