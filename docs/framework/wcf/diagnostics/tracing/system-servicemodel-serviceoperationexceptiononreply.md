...
## <a name="description"></a>Descrição  
 Respondendo a uma operação de solicitação/resposta gera uma exceção. Esse rastreamento é útil para depuração durante o desenvolvimento.  
