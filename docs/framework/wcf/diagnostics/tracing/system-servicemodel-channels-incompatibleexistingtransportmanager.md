...
## <a name="description"></a>Descrição  
 Este rastreamento informativo indica que um registro correspondente foi encontrado para o ouvinte que está sendo aberto, no entanto, o Gerenciador de transporte existente é incompatível. O ouvinte tentará usar outro gerenciador de transporte e gerará uma exceção se não for bem-sucedido.  
