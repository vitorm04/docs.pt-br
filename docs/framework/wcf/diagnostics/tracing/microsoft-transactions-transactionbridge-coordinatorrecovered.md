...
## <a name="description"></a>Descrição  
 Rastreada quando o Gerenciador de transações local foi executada com êxito recuperação para uma inscrição de coordenador superior determinado.  
