...
## <a name="description"></a>Descrição  
 Este rastreamento é gerado quando o MSDTC está não é possível criar uma transação. Isso pode ser devido a poucos recursos, espaço insuficiente de log ou outros erros.  
