...
O handshake de segurança não teve êxito dentro do tempo limite especificado.  
  
## <a name="description"></a>Descrição  
 Este rastreamento ocorre ao tentar estabelecer uma conexão segura vizinho.  
