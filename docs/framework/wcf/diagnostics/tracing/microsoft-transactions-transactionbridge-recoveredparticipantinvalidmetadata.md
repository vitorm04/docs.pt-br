...
A referência de ponto de extremidade encontrada em uma entrada de log de recuperação de participante continha metadados inválidos ou incompatíveis.  
  
## <a name="description"></a>Descrição  
 O sistema não é possível criar um proxy para uma inscrição de participante recuperado.  
