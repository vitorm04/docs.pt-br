...
## <a name="description"></a>Descrição  
 Este rastreamento é emitido quando estiver criando um host de serviço, no nível de informações. Ele fornece uma descrição do contrato de serviço e associação.  
