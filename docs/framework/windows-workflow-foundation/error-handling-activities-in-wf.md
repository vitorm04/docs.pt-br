...
[!INCLUDE[netfx_current_long](../../../includes/netfx-current-long-md.md)] fornece vários sistema forneceu atividades implementando o tratamento de erro e recuperação. Para obter mais informações, consulte [exceções](../../../docs/framework/windows-workflow-foundation/exceptions.md).  
