...
###  <a name="BKMK_CreatePersistenceDatabase"></a><span data-ttu-id="42069-122">Para criar o banco de dados de persistência</span><span class="sxs-lookup"><span data-stu-id="42069-122">To create the persistence database</span></span>  
...
###  <a name="BKMK_AddReference"></a><span data-ttu-id="42069-138">Para adicionar a referência aos assemblies DurableInstancing</span><span class="sxs-lookup"><span data-stu-id="42069-138">To add the reference to the DurableInstancing assemblies</span></span>  
...
###  <a name="BKMK_CreateForm"></a><span data-ttu-id="42069-143">Para criar o formulário de host de fluxo de trabalho</span><span class="sxs-lookup"><span data-stu-id="42069-143">To create the workflow host form</span></span>  
...
###  <a name="BKMK_AddHelperMethods"></a><span data-ttu-id="42069-236">Para adicionar as propriedades e métodos auxiliares do formulário</span><span class="sxs-lookup"><span data-stu-id="42069-236">To add the properties and helper methods of the form</span></span>  
...
###  <a name="BKMK_ConfigureWorkflowApplication"></a><span data-ttu-id="42069-258">Para configurar o armazenamento de instância, manipuladores de ciclo de vida do fluxo de trabalho e extensões</span><span class="sxs-lookup"><span data-stu-id="42069-258">To configure the instance store, workflow lifecycle handlers, and extensions</span></span>  
...
###  <a name="BKMK_WorkflowVersionMap"></a><span data-ttu-id="42069-277">Para habilitar o início e retomar vários tipos de fluxo de trabalho</span><span class="sxs-lookup"><span data-stu-id="42069-277">To enable starting and resuming multiple workflow types</span></span>  
...
###  <a name="BKMK_StartWorkflow"></a><span data-ttu-id="42069-288">Para iniciar um novo fluxo de trabalho</span><span class="sxs-lookup"><span data-stu-id="42069-288">To start a new workflow</span></span>  
...
###  <a name="BKMK_ResumeWorkflow"></a><span data-ttu-id="42069-303">Para retomar um fluxo de trabalho</span><span class="sxs-lookup"><span data-stu-id="42069-303">To resume a workflow</span></span>  
...
###  <a name="BKMK_TerminateWorkflow"></a><span data-ttu-id="42069-318">Para encerrar um fluxo de trabalho</span><span class="sxs-lookup"><span data-stu-id="42069-318">To terminate a workflow</span></span>  
...
###  <a name="BKMK_BuildAndRun"></a><span data-ttu-id="42069-327">Para compilar e executar o aplicativo</span><span class="sxs-lookup"><span data-stu-id="42069-327">To build and run the application</span></span>  
