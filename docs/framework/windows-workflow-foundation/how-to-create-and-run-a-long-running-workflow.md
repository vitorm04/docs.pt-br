...
-   [Para criar o banco de dados de persistência](../../../docs/framework/windows-workflow-foundation/how-to-create-and-run-a-long-running-workflow.md#BKMK_CreatePersistenceDatabase)  
  
-   [Para adicionar a referência aos assemblies DurableInstancing](../../../docs/framework/windows-workflow-foundation/how-to-create-and-run-a-long-running-workflow.md#BKMK_AddReference)  
  
-   [Para criar o formulário de host de fluxo de trabalho](../../../docs/framework/windows-workflow-foundation/how-to-create-and-run-a-long-running-workflow.md#BKMK_CreateForm)  
  
-   [Para adicionar as propriedades e métodos auxiliares do formulário](../../../docs/framework/windows-workflow-foundation/how-to-create-and-run-a-long-running-workflow.md#BKMK_AddHelperMethods)  
  
-   [Para configurar o armazenamento de instância, manipuladores de ciclo de vida do fluxo de trabalho e extensões](../../../docs/framework/windows-workflow-foundation/how-to-create-and-run-a-long-running-workflow.md#BKMK_ConfigureWorkflowApplication)  
  
-   [Para habilitar o início e retomar vários tipos de fluxo de trabalho](../../../docs/framework/windows-workflow-foundation/how-to-create-and-run-a-long-running-workflow.md#BKMK_WorkflowVersionMap)  
  
-   [Para iniciar um novo fluxo de trabalho](../../../docs/framework/windows-workflow-foundation/how-to-create-and-run-a-long-running-workflow.md#BKMK_StartWorkflow)  
  
-   [Para retomar um fluxo de trabalho](../../../docs/framework/windows-workflow-foundation/how-to-create-and-run-a-long-running-workflow.md#BKMK_ResumeWorkflow)  
  
-   [Para encerrar um fluxo de trabalho](../../../docs/framework/windows-workflow-foundation/how-to-create-and-run-a-long-running-workflow.md#BKMK_TerminateWorkflow)  
...
3.  Escolha **SqlWorkflowInstanceStoreSchema.sql** do **janela** menu. Certifique-se de que **WF45GettingStartedTutorial** está selecionado no **bancos de dados disponíveis** suspensa e escolha **Execute** do **consulta**menu.  
  
4.  Escolha **SqlWorkflowInstanceStoreLogic.sql** do **janela** menu. Certifique-se de que **WF45GettingStartedTutorial** está selecionado no **bancos de dados disponíveis** suspensa e escolha **Execute** do **consulta**menu.  
...
2.  Selecione **Assemblies** do **adicionar referência** lista e digite `DurableInstancing` para o **Assemblies de pesquisa** caixa. Isso filtra os assemblies e facilita a seleção das referências desejadas.  
...
1.  Clique com botão direito **NumberGuessWorkflowHost** na **Solution Explorer** e escolha **adicionar**, **Novo Item**.  
  
2.  No **instalado** modelos, escolha **Windows Form**, tipo `WorkflowHostForm` no **nome** caixa e clique em **adicionar**.  
...
4.  Adicione os seguintes controles ao formulário na ordem especificada e configure as propriedades como direcionadas.  
    ...
    |**Rótulo**|Local: 94, 18<br /><br /> Texto: Adivinhar um número entre 1 e|  
    ...
    |**Rótulo**|Nome: WorkflowVersion<br /><br /> Local: 13, 362<br /><br /> Texto: Versão de fluxo de trabalho|  
    |**GroupBox**|Local: 13, 67<br /><br /> Tamanho: 358, 287<br /><br /> Texto: jogo|  
  
    > [!NOTE]
    >  Ao adicionar os seguintes controles, coloque-o na caixa de grupo.  
  
    |Controle|Propriedade: valor|  
    |-------------|---------------------|  
    |**Rótulo**|Local: 7, 20<br /><br /> Texto: Id de instância de fluxo de trabalho|  
    |**ComboBox**|Nome: InstanceId<br /><br /> DropDownStyle: DropDownList<br /><br /> Local: 121, 17<br /><br /> Tamanho: 227, 21|  
    |**Rótulo**|Local: 7, 47<br /><br /> Texto: adivinhar|  
    |**TextBox**|Nome: adivinhar<br /><br /> Local: 50, 44<br /><br /> Tamanho: 65, 20|  
    |**Button**|Nome: EnterGuess<br /><br /> Local: 121, 42<br /><br /> Tamanho: 75, 23<br /><br /> Texto: Tentativa de inserir|  
    |**Button**|Nome: QuitGame<br /><br /> Local: 274, 42<br /><br /> Tamanho: 75, 23<br /><br /> Texto: sair|  
    |**TextBox**|Nome: WorkflowStatus<br /><br /> Local: 10, 73<br /><br /> Várias linhas: True<br /><br /> Somente leitura: True<br /><br /> Barras de rolagem: Vertical<br /><br /> Tamanho: 338, 208|  
  
5.  Definir o **AcceptButton** propriedade a fim de **EnterGuess**.  
...
4.  Adicione uma propriedade `WorkflowInstanceId` à classe `WorkflowFormHost`.  
    ...
    ```  
     ...
     O `InstanceId` caixa de combinação exibe uma lista de ids de instância de fluxo de trabalho persistentes e o `WorkflowInstanceId` propriedade retorna o fluxo de trabalho selecionado no momento.  
  
5.  Adicione um manipulador para o evento `Load` do formulário. Para adicionar o manipulador, alterne para o **modo Design** para o formulário, clique no **eventos** no canto superior do **propriedades** janela e clique duas vezes em **carga**.  
...
7.  Adicione um manipulador `SelectedIndexChanged` para `InstanceId`. Para adicionar o manipulador, alterne para o **modo Design** para o formulário, selecione o `InstanceId` caixa de combinação, clique no **eventos** no canto superior do **propriedades** janela, e Clique duas vezes em **SelectedIndexChanged**.  
...
11. Adicione o seguinte método `GameOver` e o delegado correspondente à classe de formulário. Quando um fluxo de trabalho for concluído, este método atualizará o formulário da interface do usuário, removendo a id da instância do fluxo de trabalho concluído do **InstanceId** caixa de combinação.  
...
###  <a name="BKMK_WorkflowVersionMap"></a> Para habilitar o início e retomar vários tipos de fluxo de trabalho  
 Para retomar uma instância de fluxo de trabalho, o host precisa fornecer a definição de fluxo de trabalho. Neste tutorial, há três tipos de fluxo de trabalho e as etapas tutoriais subsequentes trazem várias versões desses tipos. `WorkflowIdentity` fornece uma maneira de um aplicativo de host associar informações de identificação a uma instância do fluxo de trabalho persistida. As etapas nesta seção demonstram como criar uma classe de utilitário para ajudar com o mapeamento da identidade de fluxo de trabalho de uma instância do fluxo de trabalho persistida para a definição do fluxo de trabalho correspondente. Para obter mais informações sobre `WorkflowIdentity` e controle de versão, consulte [usando WorkflowIdentity e controle de versão](../../../docs/framework/windows-workflow-foundation/using-workflowidentity-and-versioning.md).  
...
3.  Remova ou comente o fluxo de trabalho existente que hospeda o código de [como: executar um fluxo de trabalho](../../../docs/framework/windows-workflow-foundation/how-to-run-a-workflow.md)e substituí-lo com o código a seguir.  
...
4.  Clique com botão direito **NumberGuessWorkflowHost** na **Solution Explorer** e escolha **propriedades**. No **aplicativo** especifique **aplicativo do Windows** para o **tipo de saída**. Essa etapa é opcional, mas se não for seguida, a janela do console será exibida além do formulário.  
  
5.  Pressione Ctrl+Shift+B para criar o aplicativo.  
  
6.  Certifique-se de que **NumberGuessWorkflowHost** é definido como o aplicativo de inicialização e, em seguida, pressione Ctrl + F5 para iniciar o aplicativo.  
  
7.  Selecione um intervalo para o jogo de adivinhação Pro e o tipo de fluxo de trabalho para iniciar e, em seguida, clique em **novo jogo**. Insira uma estimativa no **estimativa** caixa e clique em **vá** para enviar sua estimativa. Observe que a saída das atividades de `WriteLine` são exibidas no formulário.  
  
8.  Iniciar vários fluxos de trabalho usando intervalos de número e os tipos de fluxo de trabalho diferente, digite algumas suposições e alternar entre os fluxos de trabalho, selecionando a partir de **Id de instância de fluxo de trabalho** lista.  
