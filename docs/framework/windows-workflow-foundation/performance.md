...
## <a name="terminology"></a>Terminologia  
 ...
 Windows Server AppFabric é um conjunto de tecnologias integrados que tornam mais fácil criar, redimensionar e gerenciar Web e aplicativos compostos que executam no IIS. Fornece ferramentas para monitorar e gerenciar serviços e fluxos de trabalho. [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [O Windows Server AppFabric](http://msdn.microsoft.com/windowsserver/ee695849.aspx)  
