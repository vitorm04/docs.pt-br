...
##  <a name="UsingWorkflowIdentity"></a><span data-ttu-id="af5a0-113">Usando WorkflowIdentity</span><span class="sxs-lookup"><span data-stu-id="af5a0-113">Using WorkflowIdentity</span></span>  
...
###  <a name="SxS"></a><span data-ttu-id="af5a0-129">Execução lado a lado usando WorkflowIdentity</span><span class="sxs-lookup"><span data-stu-id="af5a0-129">Side-by-side Execution using WorkflowIdentity</span></span>  
...
##  <a name="UpdatingWF4PersistenceDatabases"></a><span data-ttu-id="af5a0-147">Atualizando bancos de dados do .NET Framework 4 persistência para dar suporte a controle de versão de fluxo de trabalho</span><span class="sxs-lookup"><span data-stu-id="af5a0-147">Upgrading .NET Framework 4 Persistence Databases to Support Workflow Versioning</span></span>  
...
###  <a name="ToUpgrade"></a><span data-ttu-id="af5a0-153">Para atualizar o esquema de banco de dados</span><span class="sxs-lookup"><span data-stu-id="af5a0-153">To upgrade the database schema</span></span>  
