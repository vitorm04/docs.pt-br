...
##  <a name="BKMK_ToRunTheApplication"></a><span data-ttu-id="44b0e-159">Para compilar e executar o aplicativo</span><span class="sxs-lookup"><span data-stu-id="44b0e-159">To build and run the application</span></span>  
