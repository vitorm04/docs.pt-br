...
## <a name="using-activityfunc"></a>Usando ActivityFunc  
 ...
 Para usar a atividade de `TextGenerator` com a atividade de `WriteRandomText` , especifique-o como <xref:System.Activities.ActivityDelegate.Handler%2A>.  
  
 [!code-csharp[CFX_ActivityExample#5](../../../samples/snippets/csharp/VS_Snippets_CFX/CFX_ActivityExample/cs/Program.cs#5)]  
  
## <a name="see-also"></a>Consulte também  
 [Expõe e chamar ActivityActions](../../../docs/framework/windows-workflow-foundation/samples/exposing-and-invoking-activityactions.md)
