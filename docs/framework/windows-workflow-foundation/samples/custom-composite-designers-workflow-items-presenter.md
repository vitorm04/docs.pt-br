...
-   Criando um designer de atividade com um modo de exibição "recolhido" e "expandido".  
  
-   Substituindo um designer padrão em um aplicativo rehosted.  
  
### <a name="to-set-up-build-and-run-the-sample"></a>Para configurar, compilar, e executar o exemplo  
  
1.  Abra o **UsingWorkflowItemsPresenter.sln** solução de exemplo para c# ou VB no [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)].  
