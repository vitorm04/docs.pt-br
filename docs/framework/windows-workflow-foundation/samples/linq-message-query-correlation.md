...
2. Uma vez que o URL ACLs é adicionado, use as seguintes etapas.  
    ...
    2. Defina vários projetos de inicialização clicando com o botão direito do mouse na solução e selecionando **Projetos de Inicialização definidas**. Adicione **serviço** e **cliente** (nessa ordem) como vários projetos de inicialinicial.  
