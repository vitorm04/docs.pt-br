...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Demonstra o uso de uma condição de regra com uma atividade de <xref:System.Workflow.Activities.IfElseActivity> .  
 ...
 Demonstra alguns dos principais recursos introduzidos no [!INCLUDE[netfx35_long](../../../../includes/netfx35-long-md.md)] do Windows Workflow Foundation (WF).
