...
2.  Configurar o base de dados SQL Server.  
    ...
    1.  De um [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)] prompt de comando, execute "Setup. cmd" do diretório de SuspendedInstanceManagement, que faz o seguinte:  
...
3.  Configurar a fila de serviço.  
    ...
    1.  Na [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)], clique com botão direito do **SampleWorkflowApp** do projeto e clique em **definir como projeto de inicialização**.  
