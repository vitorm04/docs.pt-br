...
## <a name="demonstrates"></a>Demonstra
 <xref:System.ServiceModel.WorkflowServiceHost>com <xref:System.ServiceModel.Activities.Description.WorkflowUnhandledExceptionBehavior> <xref:System.ServiceModel.Activities.WorkflowControlEndpoint> e no Windows Workflow Foundation (WF).
...
2. Configurar o base de dados SQL Server.
    ...
    1. A partir de um prompt de comando do Visual Studio 2010, execute "setup.cmd" do diretório de amostra SuspendedInstanceManagement, que faz o seguinte:
...
2. Expandir **serviços e aplicativos,** **fila de mensagens,** **filas privadas.**
