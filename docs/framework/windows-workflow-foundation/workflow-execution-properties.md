...
> [!NOTE]
>  O seguinte exemplo de código neste tópico se baseia o [propriedades de execução](../../../docs/framework/windows-workflow-foundation/samples/execution-properties.md) exemplo.  
