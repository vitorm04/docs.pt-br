...
## <a name="in-this-section"></a>Nesta seção  
 [Variáveis e argumentos](../../../docs/framework/windows-workflow-foundation/variables-and-arguments.md).  
 Descreve os conceitos de variáveis e os argumentos e como eles são usados.  
  
 [Expressões](../../../docs/framework/windows-workflow-foundation/expressions.md)  
 Descreve expressões e como elas são usadas no desenvolvimento de fluxo de trabalho.  
  
 [Expressões C#](../../../docs/framework/windows-workflow-foundation/csharp-expressions.md)  
 Descreve expressões C# em fluxos de trabalho, introduzidas com o [!INCLUDE[net_v45](../../../includes/net-v45-md.md)].  
  
 [Propriedades versus argumentos](../../../docs/framework/windows-workflow-foundation/properties-vs-arguments.md)  
 Descreve como selecionar quais tipos usar para a entrada de atividade.  
  
 [Expondo dados com CacheMetadata](../../../docs/framework/windows-workflow-foundation/exposing-data-with-cachemetadata.md)  
