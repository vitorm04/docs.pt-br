...
**Corrija a definição do fluxo de trabalho ou forneça valores de entrada para corrigir esses erros:**
 **'Adicionar': Valor para um argumento de atividade obrigatório 'Operand2' não foi fornecido.** 
 **'Add': O valor para um argumento de atividade obrigatório 'Operand1' não foi fornecido.**  Após os argumentos corretos são passados, o fluxo de trabalho concluída com sucesso, conforme mostrado no exemplo o seguir.  
