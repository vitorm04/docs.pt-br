...
8.  Um único assembly que usa [nível 2 transparência](http://aka.ms/Level2Transparency) não pode ser usado em [!INCLUDE[netfx40_short](../../../includes/netfx40-short-md.md)], [!INCLUDE[netfx_current_short](../../../includes/netfx-current-short-md.md)] em confiança total, e [!INCLUDE[netfx_current_short](../../../includes/netfx-current-short-md.md)] em confiança parcial.  
  
##  <a name="BKMK_NewDesignerCapabilites"></a> Novos recursos de Designer  
  
###  <a name="BKMK_DesignerSearch"></a> Pesquisa de Designer  
 Para tornar os fluxos de trabalho maiores mais gerenciáveis, os fluxos de trabalho podem agora ser pesquisados por palavra-chave. Este recurso só está disponível no Visual Studio; Este recurso não está disponível em um designer de rehosted. Há dois tipos de pesquisas disponível:  
  
-   Localização rápida, iniciada com um **Ctrl + F** ou **editar**, **localizar e substituir**, **localização rápida**.  
  
-   Localizar nos arquivos, iniciado com um **Ctrl + Shift + F** ou **editar**, **localizar e substituir**, **localizar nos arquivos**.  
...
###  <a name="BKMK_VariableDeleteContextMenu"></a> Excluir item de menu de contexto no designer de argumento variável  
...
###  <a name="BKMK_AutoSurround"></a> Auto-surround com sequência  
...
###  <a name="BKMK_CSharpExpressions"></a> Expressões c#  
 ...
 Para obter mais informações sobre expressões c#, consulte [c# expressões](../../../docs/framework/windows-workflow-foundation/csharp-expressions.md).  
  
###  <a name="BKMK_Visibility"></a> Mais controle de visibilidade da barra de shell e cabeçalho de itens  
...
###  <a name="BKMK_AutoConnect"></a> Conecte-se automaticamente e inserir automaticamente em fluxos de trabalho de fluxograma e de máquina de estado  
...
###  <a name="BKMK_Annotations"></a> Anotações de designers  
...
###  <a name="BKMK_DesignTimeValidation"></a> Validação de tempo de design em segundo plano  
...
###  <a name="BKMK_ViewState"></a> Estado de exibição localizado em um local separado nos arquivos XAML  
...
###  <a name="BKMK_BackwardCompatRehostedDesigner"></a> Participar de recursos de fluxo de trabalho 4.5 no designer de rehosted  
