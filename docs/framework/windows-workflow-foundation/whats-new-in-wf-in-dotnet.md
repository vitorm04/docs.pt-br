...
---
# <a name="what39s-new-in-windows-workflow-foundation-in-net-45"></a>O que &#39; s no Windows Workflow Foundation no .NET 4.5
...
###  <a name="BKMK_DesignerSearch"></a>Pesquisa de Designer  
 Para tornar os fluxos de trabalho maiores mais gerenciáveis, os fluxos de trabalho podem agora ser pesquisados por palavra-chave. Esse recurso está disponível somente no [!INCLUDE[vs_current_short](../../../includes/vs-current-short-md.md)]; este recurso não está disponível em um designer hospedado novamente. Há dois tipos de pesquisas disponível:  
...
###  <a name="BKMK_CSharpExpressions"></a>Expressões c#  
 ...
 [!INCLUDE[crabout](../../../includes/crabout-md.md)]Expressões c#, consulte [c# expressões](../../../docs/framework/windows-workflow-foundation/csharp-expressions.md).  
