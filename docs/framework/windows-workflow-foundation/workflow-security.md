...
Para obter mais informações e baixar a CTP de segurança de WF, consulte: [Pacote de segurança WF CTP](https://wf.codeplex.com/releases/view/48114)