...
## <a name="in-this-section"></a>Nesta seção  
 [Como criar um fluxo de trabalho sequencial](../../../docs/framework/windows-workflow-foundation/how-to-create-a-sequential-workflow.md)  
 Descreve como criar um fluxo de trabalho sequencial usando a atividade de <xref:System.Activities.Statements.Sequence> .  
  
 [Como criar um fluxo de trabalho de fluxograma](../../../docs/framework/windows-workflow-foundation/how-to-create-a-flowchart-workflow.md)  
