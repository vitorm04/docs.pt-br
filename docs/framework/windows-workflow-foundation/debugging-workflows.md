...
## <a name="remote-debugging"></a>Depuração remota  
 Depuração remota do Windows Workflow Foundation (WF) funciona da mesma maneira depuração remota para outros componentes do Visual Studio. Para obter informações sobre como usar a depuração remota, consulte [como: Habilitar a depuração remota](https://go.microsoft.com/fwlink/?LinkId=196257).  
