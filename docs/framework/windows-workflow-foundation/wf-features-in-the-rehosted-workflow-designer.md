...
> [!NOTE]
> Para obter uma lista de todos os novos recursos do Windows Workflow Foundation (WF) introduzidos no .NET Framework 4,5, incluindo aqueles que não estão relacionados à hospedagem do designer, consulte [o que há de novo no Windows Workflow Foundation no .net 4,5](whats-new-in-wf-in-dotnet.md).
