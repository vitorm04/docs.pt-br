...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-462"></a>Alterações de redirecionamento para a migração do .NET Framework 4.5 para 4.6.2
