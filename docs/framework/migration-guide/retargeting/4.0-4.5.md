...
description: Encontre informações sobre problemas de compatibilidade de aplicativos que podem afetar seu aplicativo ao migrar do .NET Framework 4,0 para 4,5.
ms.date: 07/10/2019
...
ms.locfileid: "91609610"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="e7cbe-103">Alterações de redirecionamento para a migração do .NET Framework 4.0 para 4.5</span><span class="sxs-lookup"><span data-stu-id="e7cbe-103">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="e7cbe-104">Se você estiver migrando do .NET Framework 4.0 para 4.5, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="e7cbe-104">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="e7cbe-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e7cbe-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="e7cbe-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="e7cbe-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="e7cbe-107">Núcleo</span><span class="sxs-lookup"><span data-stu-id="e7cbe-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e7cbe-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e7cbe-108">Entity Framework</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="e7cbe-109">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="e7cbe-109">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e7cbe-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e7cbe-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="e7cbe-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="e7cbe-111">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="e7cbe-112">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="e7cbe-112">XML, XSLT</span></span>
