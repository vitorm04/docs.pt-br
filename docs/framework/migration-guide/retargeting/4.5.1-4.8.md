...
---
# <a name="retargeting-changes-for-migration-from-net-framework-451-to-48"></a>Alterações de redirecionamento para a migração do .NET Framework 4.5.1 para 4.8
