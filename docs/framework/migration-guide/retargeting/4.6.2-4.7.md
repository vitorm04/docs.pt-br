...
---
# <a name="retargeting-changes-for-migration-from-net-framework-462-to-47"></a>Alterações de redirecionamento para a migração do .NET Framework 4.6.2 para 4.7
