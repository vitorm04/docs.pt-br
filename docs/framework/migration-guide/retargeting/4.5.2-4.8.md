...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-48"></a>Alterações de redirecionamento para a migração do .NET Framework 4.5.2 para 4.8
