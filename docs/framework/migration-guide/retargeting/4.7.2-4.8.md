...
---
# <a name="retargeting-changes-for-migration-from-net-framework-472-to-48"></a>Alterações de redirecionamento para a migração do .NET Framework 4.7.2 para 4.8
