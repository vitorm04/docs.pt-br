...
Se você estiver migrando do .NET Framework 4.5.1 para 4.6, revise os seguintes tópicos para problemas de compatibilidade de aplicativos que podem afetar seu aplicativo:
