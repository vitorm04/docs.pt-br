...
---
# <a name="retargeting-changes-for-migration-from-net-framework-451-to-462"></a>Alterações de redirecionamento para a migração do .NET Framework 4.5.1 para 4.6.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

Se você estiver migrando do .NET Framework 4.5.1 para 4.6.2, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:
