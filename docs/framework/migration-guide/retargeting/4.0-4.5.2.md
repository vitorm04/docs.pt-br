...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-452"></a>Alterações de redirecionamento para a migração do .NET Framework 4.0 para 4.5.2
