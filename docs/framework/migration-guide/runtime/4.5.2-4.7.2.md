---
title: Alterações de runtime para a migração do .NET Framework 4.5.2 para 4.7.2
description: Encontre informações sobre problemas de compatibilidade de aplicativos de alterações de tempo de execução que podem afetar seu aplicativo ao migrar de .NET Framework 4.5.2 para 4.7.2.
ms.date: 07/10/2019
...
ms.locfileid: "86442240"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-472"></a><span data-ttu-id="0c229-103">Alterações de runtime para a migração do .NET Framework 4.5.2 para 4.7.2</span><span class="sxs-lookup"><span data-stu-id="0c229-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="0c229-104">Se você estiver migrando do .NET Framework 4.5.2 para 4.7.2, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="0c229-104">If you are migrating from the .NET Framework 4.5.2 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="0c229-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0c229-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="0c229-106">Núcleo</span><span class="sxs-lookup"><span data-stu-id="0c229-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="0c229-107">Dados</span><span class="sxs-lookup"><span data-stu-id="0c229-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="0c229-108">Depurador</span><span class="sxs-lookup"><span data-stu-id="0c229-108">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="0c229-109">Globalização</span><span class="sxs-lookup"><span data-stu-id="0c229-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="0c229-110">Rede</span><span class="sxs-lookup"><span data-stu-id="0c229-110">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="0c229-111">Runtime</span><span class="sxs-lookup"><span data-stu-id="0c229-111">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="0c229-112">Segurança</span><span class="sxs-lookup"><span data-stu-id="0c229-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="0c229-113">Serialização</span><span class="sxs-lookup"><span data-stu-id="0c229-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="0c229-114">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="0c229-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="0c229-115">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="0c229-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="0c229-116">Aplicativos Web</span><span class="sxs-lookup"><span data-stu-id="0c229-116">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0c229-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0c229-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0c229-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0c229-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0c229-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="0c229-119">Windows Workflow Foundation (WF)</span></span>
