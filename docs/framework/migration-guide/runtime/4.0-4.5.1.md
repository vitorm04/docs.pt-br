---
title: Alterações de runtime para a migração do .NET Framework 4.0 para 4.5.1
description: Encontre informações sobre problemas de compatibilidade de aplicativos de alterações de tempo de execução que podem afetar seu aplicativo ao migrar do .NET Framework 4,0 para 4.5.1.
ms.date: 07/10/2019
...
ms.locfileid: "86443696"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="b1586-103">Alterações de runtime para a migração do .NET Framework 4.0 para 4.5.1</span><span class="sxs-lookup"><span data-stu-id="b1586-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="b1586-104">Se você estiver migrando do .NET Framework 4.0 para 4.5.1, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="b1586-104">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b1586-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b1586-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="b1586-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b1586-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b1586-107">Núcleo</span><span class="sxs-lookup"><span data-stu-id="b1586-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b1586-108">Dados</span><span class="sxs-lookup"><span data-stu-id="b1586-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="b1586-109">Depurador</span><span class="sxs-lookup"><span data-stu-id="b1586-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b1586-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b1586-110">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="b1586-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="b1586-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="b1586-112">MEF (Managed Extensibility Framework)</span><span class="sxs-lookup"><span data-stu-id="b1586-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="b1586-113">Rede</span><span class="sxs-lookup"><span data-stu-id="b1586-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="b1586-114">Imprimindo</span><span class="sxs-lookup"><span data-stu-id="b1586-114">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b1586-115">Serialização</span><span class="sxs-lookup"><span data-stu-id="b1586-115">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="b1586-116">Aplicativos Web</span><span class="sxs-lookup"><span data-stu-id="b1586-116">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b1586-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b1586-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="b1586-118">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="b1586-118">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b1586-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b1586-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="b1586-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="b1586-120">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="b1586-121">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="b1586-121">XML, XSLT</span></span>
