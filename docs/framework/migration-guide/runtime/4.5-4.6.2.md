...
ms.locfileid: "91609558"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="f9cf5-103">Alterações de runtime para a migração do .NET Framework 4.5 para 4.6.2</span><span class="sxs-lookup"><span data-stu-id="f9cf5-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="f9cf5-104">Se você estiver migrando do .NET Framework 4.5 para 4.6.2, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="f9cf5-104">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="f9cf5-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="f9cf5-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="f9cf5-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="f9cf5-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="f9cf5-107">Núcleo</span><span class="sxs-lookup"><span data-stu-id="f9cf5-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="f9cf5-108">Dados</span><span class="sxs-lookup"><span data-stu-id="f9cf5-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="f9cf5-109">Depurador</span><span class="sxs-lookup"><span data-stu-id="f9cf5-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="f9cf5-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="f9cf5-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="f9cf5-111">Globalização</span><span class="sxs-lookup"><span data-stu-id="f9cf5-111">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="f9cf5-112">Rede</span><span class="sxs-lookup"><span data-stu-id="f9cf5-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="f9cf5-113">Segurança</span><span class="sxs-lookup"><span data-stu-id="f9cf5-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="f9cf5-114">Serialização</span><span class="sxs-lookup"><span data-stu-id="f9cf5-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="f9cf5-115">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="f9cf5-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="f9cf5-116">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="f9cf5-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f9cf5-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f9cf5-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f9cf5-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f9cf5-118">Windows Presentation Foundation (WPF)</span></span>
