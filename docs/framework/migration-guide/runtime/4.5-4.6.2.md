...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="478bd-102">Alterações de tempo de execução para a migração do .NET Framework 4.5 para 4.6.2</span><span class="sxs-lookup"><span data-stu-id="478bd-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="478bd-103">Se você estiver migrando do .NET Framework 4.5 para 4.6.2, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="478bd-103">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="478bd-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="478bd-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="478bd-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="478bd-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="478bd-106">Núcleo</span><span class="sxs-lookup"><span data-stu-id="478bd-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="478bd-107">Dados</span><span class="sxs-lookup"><span data-stu-id="478bd-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="478bd-108">Depurador</span><span class="sxs-lookup"><span data-stu-id="478bd-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="478bd-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="478bd-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="478bd-110">Globalização</span><span class="sxs-lookup"><span data-stu-id="478bd-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="478bd-111">Rede</span><span class="sxs-lookup"><span data-stu-id="478bd-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="478bd-112">Segurança</span><span class="sxs-lookup"><span data-stu-id="478bd-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="478bd-113">Serialização</span><span class="sxs-lookup"><span data-stu-id="478bd-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="478bd-114">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="478bd-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="478bd-115">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="478bd-115">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="478bd-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="478bd-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="478bd-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="478bd-117">Windows Presentation Foundation (WPF)</span></span>
