...
author: chlowell
ms.openlocfilehash: 50e7a8541f15fc59f7589e08c7ed314893356181
ms.sourcegitcommit: 559fcfbe4871636494870a8b716bf7325df34ac5
ms.translationtype: HT
ms.contentlocale: pt-BR
ms.lasthandoff: 10/30/2019
ms.locfileid: "73086736"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-462"></a><span data-ttu-id="1d415-102">Alterações de tempo de execução para a migração do .NET Framework 4.6 para 4.6.2</span><span class="sxs-lookup"><span data-stu-id="1d415-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="1d415-103">Se você estiver migrando do .NET Framework 4.6 para 4.6.2, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="1d415-103">If you are migrating from the .NET Framework 4.6 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="1d415-104">Dados</span><span class="sxs-lookup"><span data-stu-id="1d415-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="1d415-105">Globalização</span><span class="sxs-lookup"><span data-stu-id="1d415-105">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="1d415-106">Segurança</span><span class="sxs-lookup"><span data-stu-id="1d415-106">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="1d415-107">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="1d415-107">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="1d415-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="1d415-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1d415-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1d415-109">Windows Presentation Foundation (WPF)</span></span>
