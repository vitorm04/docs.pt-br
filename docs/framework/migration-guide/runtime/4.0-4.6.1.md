---
title: Alterações de runtime para a migração do .NET Framework 4.0 para 4.6.1
description: Encontre informações sobre problemas de compatibilidade de aplicativos de alterações de tempo de execução que podem afetar seu aplicativo ao migrar do .NET Framework 4,0 para o 4.6.1.
ms.date: 07/10/2019
...
ms.locfileid: "91609402"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-461"></a><span data-ttu-id="69828-103">Alterações de runtime para a migração do .NET Framework 4.0 para 4.6.1</span><span class="sxs-lookup"><span data-stu-id="69828-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="69828-104">Se você estiver migrando do .NET Framework 4.0 para 4.6.1, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="69828-104">If you are migrating from the .NET Framework 4.0 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="69828-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="69828-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="69828-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="69828-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="69828-107">Núcleo</span><span class="sxs-lookup"><span data-stu-id="69828-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="69828-108">Dados</span><span class="sxs-lookup"><span data-stu-id="69828-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="69828-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="69828-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="69828-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="69828-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="69828-111">MEF (Managed Extensibility Framework)</span><span class="sxs-lookup"><span data-stu-id="69828-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="69828-112">Rede</span><span class="sxs-lookup"><span data-stu-id="69828-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="69828-113">Imprimindo</span><span class="sxs-lookup"><span data-stu-id="69828-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="69828-114">Serialização</span><span class="sxs-lookup"><span data-stu-id="69828-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="69828-115">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="69828-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="69828-116">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="69828-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="69828-117">Aplicativos Web</span><span class="sxs-lookup"><span data-stu-id="69828-117">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="69828-118">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="69828-118">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="69828-119">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="69828-119">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="69828-120">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="69828-120">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="69828-121">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="69828-121">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="69828-122">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="69828-122">XML, XSLT</span></span>
