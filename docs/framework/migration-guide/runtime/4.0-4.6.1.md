...
ms.locfileid: "58761217"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-461"></a><span data-ttu-id="61376-102">Alterações de tempo de execução para a migração do .NET Framework 4.0 para 4.6.1</span><span class="sxs-lookup"><span data-stu-id="61376-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="61376-103">Se você estiver migrando do .NET Framework 4.0 para 4.6.1, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="61376-103">If you are migrating from the .NET Framework 4.0 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="61376-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="61376-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="61376-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="61376-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="61376-106">Núcleo</span><span class="sxs-lookup"><span data-stu-id="61376-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="61376-107">Dados</span><span class="sxs-lookup"><span data-stu-id="61376-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="61376-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="61376-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="61376-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="61376-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="61376-110">MEF (Managed Extensibility Framework)</span><span class="sxs-lookup"><span data-stu-id="61376-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="61376-111">Rede</span><span class="sxs-lookup"><span data-stu-id="61376-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="61376-112">Imprimindo</span><span class="sxs-lookup"><span data-stu-id="61376-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="61376-113">Serialização</span><span class="sxs-lookup"><span data-stu-id="61376-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="61376-114">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="61376-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="61376-115">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="61376-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="61376-116">Aplicativos Web</span><span class="sxs-lookup"><span data-stu-id="61376-116">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="61376-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="61376-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="61376-118">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="61376-118">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="61376-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="61376-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="61376-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="61376-120">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="61376-121">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="61376-121">XML, XSLT</span></span>
