...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="697e5-102">Alterações de tempo de execução para a migração do .NET Framework 4.5 para 4.5.2</span><span class="sxs-lookup"><span data-stu-id="697e5-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="697e5-103">Se você estiver migrando do .NET Framework 4.5 para 4.5.2, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="697e5-103">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="697e5-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="697e5-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="697e5-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="697e5-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="697e5-106">Núcleo</span><span class="sxs-lookup"><span data-stu-id="697e5-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="697e5-107">Dados</span><span class="sxs-lookup"><span data-stu-id="697e5-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="697e5-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="697e5-108">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="697e5-109">Serialização</span><span class="sxs-lookup"><span data-stu-id="697e5-109">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="697e5-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="697e5-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="697e5-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="697e5-111">Windows Presentation Foundation (WPF)</span></span>
