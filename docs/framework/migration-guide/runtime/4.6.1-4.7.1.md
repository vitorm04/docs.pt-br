...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-471"></a>Alterações de tempo de execução para a migração do .NET Framework 4.6.1 para 4.7.1
