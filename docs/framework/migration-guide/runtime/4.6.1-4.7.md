...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a>Alterações de runtime para a migração do .NET Framework 4.6.1 para 4.7

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Se você estiver migrando do .NET Framework 4.6.1 para 4.7, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:
