...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-48"></a><span data-ttu-id="92674-102">Alterações de runtime para a migração do .NET Framework 4.5.1 para 4.8</span><span class="sxs-lookup"><span data-stu-id="92674-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="92674-103">Se você estiver migrando do .NET Framework 4.5.1 para 4.8, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que poderão afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="92674-103">If you are migrating from the .NET Framework 4.5.1 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="92674-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="92674-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="92674-105">Núcleo</span><span class="sxs-lookup"><span data-stu-id="92674-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="92674-106">Dados</span><span class="sxs-lookup"><span data-stu-id="92674-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="92674-107">Depurador</span><span class="sxs-lookup"><span data-stu-id="92674-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="92674-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="92674-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="92674-109">Globalização</span><span class="sxs-lookup"><span data-stu-id="92674-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="92674-110">Rede</span><span class="sxs-lookup"><span data-stu-id="92674-110">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="92674-111">Runtime</span><span class="sxs-lookup"><span data-stu-id="92674-111">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="92674-112">Segurança</span><span class="sxs-lookup"><span data-stu-id="92674-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="92674-113">Serialização</span><span class="sxs-lookup"><span data-stu-id="92674-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="92674-114">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="92674-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="92674-115">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="92674-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="92674-116">Aplicativos Web</span><span class="sxs-lookup"><span data-stu-id="92674-116">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="92674-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="92674-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="92674-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="92674-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="92674-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="92674-119">Windows Workflow Foundation (WF)</span></span>
