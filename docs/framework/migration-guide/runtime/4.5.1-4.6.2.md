...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-462"></a>Alterações de tempo de execução para a migração do .NET Framework 4.5.1 para 4.6.2
