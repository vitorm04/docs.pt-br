---
title: Alterações de runtime para a migração do .NET Framework 4.6 para 4.7
description: Encontre informações sobre problemas de compatibilidade de aplicativos de alterações de tempo de execução que podem afetar seu aplicativo ao migrar do .NET Framework 4,6 para 4,7.
ms.date: 07/10/2019
...
ms.locfileid: "86444021"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-47"></a><span data-ttu-id="4345f-103">Alterações de runtime para a migração do .NET Framework 4.6 para 4.7</span><span class="sxs-lookup"><span data-stu-id="4345f-103">Runtime Changes for Migration from .NET Framework 4.6 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="4345f-104">Se você estiver migrando do .NET Framework 4.6 para 4.7, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="4345f-104">If you are migrating from the .NET Framework 4.6 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="4345f-105">Dados</span><span class="sxs-lookup"><span data-stu-id="4345f-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="4345f-106">Globalização</span><span class="sxs-lookup"><span data-stu-id="4345f-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="4345f-107">JIT</span><span class="sxs-lookup"><span data-stu-id="4345f-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="4345f-108">Segurança</span><span class="sxs-lookup"><span data-stu-id="4345f-108">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="4345f-109">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="4345f-109">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4345f-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4345f-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4345f-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4345f-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="4345f-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="4345f-112">Windows Workflow Foundation (WF)</span></span>
