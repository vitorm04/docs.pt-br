...
ms.locfileid: "42935770"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="be38b-102">Alterações de tempo de execução para a migração do .NET Framework 4.5.2 para 4.6</span><span class="sxs-lookup"><span data-stu-id="be38b-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="be38b-103">Se você estiver migrando do .NET Framework 4.5.2 para 4.6, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="be38b-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="be38b-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="be38b-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="be38b-105">Núcleo</span><span class="sxs-lookup"><span data-stu-id="be38b-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="be38b-106">Dados</span><span class="sxs-lookup"><span data-stu-id="be38b-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="be38b-107">Depurador</span><span class="sxs-lookup"><span data-stu-id="be38b-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="be38b-108">Rede</span><span class="sxs-lookup"><span data-stu-id="be38b-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="be38b-109">Serialização</span><span class="sxs-lookup"><span data-stu-id="be38b-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="be38b-110">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="be38b-110">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="be38b-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="be38b-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="be38b-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="be38b-112">Windows Presentation Foundation (WPF)</span></span>
