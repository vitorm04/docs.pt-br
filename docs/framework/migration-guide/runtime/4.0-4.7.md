...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-47"></a>Alterações de tempo de execução para a migração do .NET Framework 4.0 a 4.7

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Se você estiver migrando do .NET Framework 4.0 para 4.7, revise os seguintes tópicos para problemas de compatibilidade de aplicativos que podem afetar seu aplicativo:
