...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="56e5f-102">Alterações de tempo de execução para a migração do .NET Framework 4.5.1 para 4.6</span><span class="sxs-lookup"><span data-stu-id="56e5f-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="56e5f-103">Se você estiver migrando do .NET Framework 4.5.1 para 4.6, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="56e5f-103">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="56e5f-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="56e5f-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="56e5f-105">Núcleo</span><span class="sxs-lookup"><span data-stu-id="56e5f-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="56e5f-106">Dados</span><span class="sxs-lookup"><span data-stu-id="56e5f-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="56e5f-107">Depurador</span><span class="sxs-lookup"><span data-stu-id="56e5f-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="56e5f-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="56e5f-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="56e5f-109">Rede</span><span class="sxs-lookup"><span data-stu-id="56e5f-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="56e5f-110">Serialização</span><span class="sxs-lookup"><span data-stu-id="56e5f-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="56e5f-111">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="56e5f-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="56e5f-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="56e5f-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="56e5f-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="56e5f-113">Windows Presentation Foundation (WPF)</span></span>
