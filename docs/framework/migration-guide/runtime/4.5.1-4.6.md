---
title: "Alterações de tempo de execução para a migração do .NET Framework 4.5.1 para 4.6"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="07654-102">Alterações de tempo de execução para a migração do .NET Framework 4.5.1 para 4.6</span><span class="sxs-lookup"><span data-stu-id="07654-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="07654-103">Se você estiver migrando do .NET Framework 4.5.1 para 4.6, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="07654-103">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="07654-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="07654-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="07654-105">Núcleo</span><span class="sxs-lookup"><span data-stu-id="07654-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="07654-106">Dados</span><span class="sxs-lookup"><span data-stu-id="07654-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="07654-107">Depurador</span><span class="sxs-lookup"><span data-stu-id="07654-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="07654-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="07654-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="07654-109">Rede</span><span class="sxs-lookup"><span data-stu-id="07654-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="07654-110">Serialização</span><span class="sxs-lookup"><span data-stu-id="07654-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="07654-111">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="07654-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="07654-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="07654-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="07654-113">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="07654-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="07654-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="07654-114">Windows Presentation Foundation (WPF)</span></span>
