...
ms.locfileid: "86442981"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="057dd-103">Alterações de runtime para a migração do .NET Framework 4.5 para 4.6</span><span class="sxs-lookup"><span data-stu-id="057dd-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="057dd-104">Se você estiver migrando do .NET Framework 4.5 para 4.6, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="057dd-104">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="057dd-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="057dd-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="057dd-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="057dd-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="057dd-107">Núcleo</span><span class="sxs-lookup"><span data-stu-id="057dd-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="057dd-108">Dados</span><span class="sxs-lookup"><span data-stu-id="057dd-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="057dd-109">Depurador</span><span class="sxs-lookup"><span data-stu-id="057dd-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="057dd-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="057dd-110">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="057dd-111">Rede</span><span class="sxs-lookup"><span data-stu-id="057dd-111">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="057dd-112">Serialização</span><span class="sxs-lookup"><span data-stu-id="057dd-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="057dd-113">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="057dd-113">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="057dd-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="057dd-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="057dd-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="057dd-115">Windows Presentation Foundation (WPF)</span></span>
