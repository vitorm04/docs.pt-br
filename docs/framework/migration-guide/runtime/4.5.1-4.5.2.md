...
author: chlowell
ms.openlocfilehash: 98efd897a268f05fb61415f5d0fc5fd26b6110da
ms.sourcegitcommit: 559fcfbe4871636494870a8b716bf7325df34ac5
ms.translationtype: HT
ms.contentlocale: pt-BR
ms.lasthandoff: 10/30/2019
ms.locfileid: "73105873"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a><span data-ttu-id="e4172-102">Alterações de runtime para a migração do .NET Framework 4.5.1 para 4.5.2</span><span class="sxs-lookup"><span data-stu-id="e4172-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="e4172-103">Se você estiver migrando do .NET Framework 4.5.1 para 4.5.2, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="e4172-103">If you are migrating from the .NET Framework 4.5.1 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="e4172-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e4172-104">ASP.NET</span></span>
...
## <a name="data"></a><span data-ttu-id="e4172-105">Dados</span><span class="sxs-lookup"><span data-stu-id="e4172-105">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e4172-106">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e4172-106">Entity Framework</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e4172-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e4172-107">Windows Presentation Foundation (WPF)</span></span>
