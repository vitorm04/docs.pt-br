...
---
# <a name="runtime-changes-for-migration-from-net-framework-462-to-471"></a>Alterações de tempo de execução para a migração do .NET Framework 4.6.2 para 4.7.1
