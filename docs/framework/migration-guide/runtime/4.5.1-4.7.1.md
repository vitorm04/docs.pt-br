...
ms.locfileid: "37072703"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-471"></a><span data-ttu-id="f8e5a-102">Alterações de tempo de execução para a migração do .NET Framework 4.5.1 para 4.7.1</span><span class="sxs-lookup"><span data-stu-id="f8e5a-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="f8e5a-103">Se você estiver migrando do .NET Framework 4.5.1 para 4.7.1, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="f8e5a-103">If you are migrating from the .NET Framework 4.5.1 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="f8e5a-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="f8e5a-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="f8e5a-105">Núcleo</span><span class="sxs-lookup"><span data-stu-id="f8e5a-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="f8e5a-106">Dados</span><span class="sxs-lookup"><span data-stu-id="f8e5a-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="f8e5a-107">Depurador</span><span class="sxs-lookup"><span data-stu-id="f8e5a-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="f8e5a-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="f8e5a-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="f8e5a-109">Globalização</span><span class="sxs-lookup"><span data-stu-id="f8e5a-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="f8e5a-110">Rede</span><span class="sxs-lookup"><span data-stu-id="f8e5a-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="f8e5a-111">Segurança</span><span class="sxs-lookup"><span data-stu-id="f8e5a-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="f8e5a-112">Serialização</span><span class="sxs-lookup"><span data-stu-id="f8e5a-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="f8e5a-113">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="f8e5a-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="f8e5a-114">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="f8e5a-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f8e5a-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f8e5a-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f8e5a-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f8e5a-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="f8e5a-117">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="f8e5a-117">Windows Workflow Foundation (WF)</span></span>
