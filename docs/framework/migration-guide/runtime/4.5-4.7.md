...
ms.locfileid: "59773773"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="4a98f-102">Alterações de tempo de execução para a migração do .NET Framework 4.5 para 4.7</span><span class="sxs-lookup"><span data-stu-id="4a98f-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="4a98f-103">Se você estiver migrando do .NET Framework 4.5 para 4.7, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="4a98f-103">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="4a98f-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="4a98f-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="4a98f-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="4a98f-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="4a98f-106">Núcleo</span><span class="sxs-lookup"><span data-stu-id="4a98f-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="4a98f-107">Dados</span><span class="sxs-lookup"><span data-stu-id="4a98f-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="4a98f-108">Depurador</span><span class="sxs-lookup"><span data-stu-id="4a98f-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="4a98f-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="4a98f-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="4a98f-110">Globalização</span><span class="sxs-lookup"><span data-stu-id="4a98f-110">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="4a98f-111">JIT</span><span class="sxs-lookup"><span data-stu-id="4a98f-111">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="4a98f-112">Rede</span><span class="sxs-lookup"><span data-stu-id="4a98f-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="4a98f-113">Segurança</span><span class="sxs-lookup"><span data-stu-id="4a98f-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="4a98f-114">Serialização</span><span class="sxs-lookup"><span data-stu-id="4a98f-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="4a98f-115">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="4a98f-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="4a98f-116">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="4a98f-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4a98f-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4a98f-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4a98f-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4a98f-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="4a98f-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="4a98f-119">Windows Workflow Foundation (WF)</span></span>
