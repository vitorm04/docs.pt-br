---
title: Alterações de runtime para a migração do .NET Framework 4.5 para 4.7
description: Encontre informações sobre problemas de compatibilidade de aplicativos de alterações de tempo de execução que podem afetar seu aplicativo ao migrar do .NET Framework 4,5 para 4,7.
ms.date: 07/10/2019
...
ms.locfileid: "91608061"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="b0e9f-103">Alterações de runtime para a migração do .NET Framework 4.5 para 4.7</span><span class="sxs-lookup"><span data-stu-id="b0e9f-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="b0e9f-104">Se você estiver migrando do .NET Framework 4.5 para 4.7, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="b0e9f-104">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b0e9f-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b0e9f-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="b0e9f-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b0e9f-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b0e9f-107">Núcleo</span><span class="sxs-lookup"><span data-stu-id="b0e9f-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b0e9f-108">Dados</span><span class="sxs-lookup"><span data-stu-id="b0e9f-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="b0e9f-109">Depurador</span><span class="sxs-lookup"><span data-stu-id="b0e9f-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b0e9f-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b0e9f-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="b0e9f-111">Globalização</span><span class="sxs-lookup"><span data-stu-id="b0e9f-111">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="b0e9f-112">JIT</span><span class="sxs-lookup"><span data-stu-id="b0e9f-112">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="b0e9f-113">Rede</span><span class="sxs-lookup"><span data-stu-id="b0e9f-113">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="b0e9f-114">Segurança</span><span class="sxs-lookup"><span data-stu-id="b0e9f-114">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b0e9f-115">Serialização</span><span class="sxs-lookup"><span data-stu-id="b0e9f-115">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="b0e9f-116">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="b0e9f-116">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="b0e9f-117">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="b0e9f-117">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b0e9f-118">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b0e9f-118">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b0e9f-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b0e9f-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="b0e9f-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="b0e9f-120">Windows Workflow Foundation (WF)</span></span>
