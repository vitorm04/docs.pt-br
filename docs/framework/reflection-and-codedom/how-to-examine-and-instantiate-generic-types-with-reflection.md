---
title: "Como examinar tipos genéricos e criar instâncias deles com a reflexão | Microsoft Docs"
ms.custom: 
ms.date: 03/30/2017
...
8.  Os atributos de restrição especial são sinalizadores e o mesmo sinalizador (<xref:System.Reflection.GenericParameterAttributes.None?displayProperty=fullName>) que não representa restrições especiais também não representa nenhuma covariância ou contravariância. Portanto, para testar se há alguma dessas condições, você deve usar a máscara apropriada. Nesse caso, use <xref:System.Reflection.GenericParameterAttributes.SpecialConstraintMask?displayProperty=fullName> para isolar os sinalizadores de restrição especial.  
