...
Este tópico aborda como um recurso (ou vários recursos) podem ser inscrita em uma transação, bem como os diferentes tipos de inscrição. O [confirmando uma transação de fase única e várias fases](../../../../docs/framework/data/transactions/committing-a-transaction-in-single-phase-and-multi-phase.md) tópico aborda como o compromisso de transação pode ser coordenado entre recursos.
