...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Executar recuperação](../../../../docs/framework/data/transactions/performing-recovery.md)  
  
 Descreve como um Gerenciador de recursos durável recupera de falha.  
  
 [Níveis de confiança de segurança de acesso a recursos](../../../../docs/framework/data/transactions/security-trust-levels-in-accessing-resources.md)  
