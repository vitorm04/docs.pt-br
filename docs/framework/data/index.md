...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Fornece links para a documentação relevante para LINQ (consulta integrada à linguagem C#) usando o.  
 ...
 [Transaction Processing](./transactions/index.md) (Processamento de transações)  
