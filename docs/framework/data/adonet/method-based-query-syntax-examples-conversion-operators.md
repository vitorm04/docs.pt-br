...
---
# <a name="method-based-query-syntax-examples-conversion-operators-linq-to-dataset"></a>Exemplos de sintaxe de consulta com base em método: Operadores de conversão (LINQ to DataSet)
