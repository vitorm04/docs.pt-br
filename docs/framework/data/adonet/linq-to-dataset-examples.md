...
## <a name="in-this-section"></a>Nesta seção  
 [Exemplos de expressão de consulta](../../../../docs/framework/data/adonet/query-expression-examples-linq-to-dataset.md)  
...
-   [Ordenando](../../../../docs/framework/data/adonet/query-expression-syntax-examples-ordering-linq-to-dataset.md)  
...
-   [Ordenando](../../../../docs/framework/data/adonet/method-based-query-syntax-examples-ordering-linq-to-dataset.md)  
...
-   [Join](../../../../docs/framework/data/adonet/method-based-query-syntax-examples-join-linq-to-dataset.md)  
 ...
 [Exemplos de operador de DataSet específicos](../../../../docs/framework/data/adonet/dataset-specific-operator-examples-linq-to-dataset.md)  
