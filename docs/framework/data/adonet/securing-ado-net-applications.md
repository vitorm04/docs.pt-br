...
## <a name="related-sections"></a>Seções relacionadas  
 ...
 [Ferramentas de segurança](http://msdn.microsoft.com/en-us/2a3eb98a-2de6-4fba-b41c-01a74d354c11)  
 As ferramentas do .NET Framework para proteger e administrar a política de segurança.  
  
 [Recursos para a criação de aplicativos seguros](http://msdn.microsoft.com/en-us/0ebf5f69-76f2-498a-a2df-83cf3443e132)  
