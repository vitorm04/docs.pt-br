...
## <a name="prerequisites"></a>Pré-requisitos  
 Você deve ter concluído [passo a passo: modelo de objeto simples e de consulta (c#)](../../../../../../docs/framework/data/adonet/sql/linq/walkthrough-simple-object-model-and-query-csharp.md). Este passo a passo é baseado naquele, incluindo a presença do arquivo northwnd.mdf em c:\linqtest5.  
