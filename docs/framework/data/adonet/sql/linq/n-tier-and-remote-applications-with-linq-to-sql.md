...
-   [LINQ to SQL com aplicativos cliente-servidor estreitamente ligado](../../../../../../docs/framework/data/adonet/sql/linq/linq-to-sql-with-tightly-coupled-client-server-applications.md)  
