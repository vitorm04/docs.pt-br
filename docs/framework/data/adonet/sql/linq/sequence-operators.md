...
---
# <a name="sequence-operators"></a><span data-ttu-id="f7427-102">Operadores de sequência</span><span class="sxs-lookup"><span data-stu-id="f7427-102">Sequence Operators</span></span>
<span data-ttu-id="f7427-103">Em termos gerais, [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] não suporta os operadores de sequência que têm uma ou mais das seguintes qualidades:</span><span class="sxs-lookup"><span data-stu-id="f7427-103">Generally speaking, [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] does not support sequence operators that have one or more of the following qualities:</span></span>  
  
-   <span data-ttu-id="f7427-104">Leva um método com um parâmetro de índice.</span><span class="sxs-lookup"><span data-stu-id="f7427-104">Take a lambda with an index parameter.</span></span>  
  
-   <span data-ttu-id="f7427-105">Confie nas propriedades de linhas sequenciais, como o <xref:System.Linq.Queryable.TakeWhile%2A>.</span><span class="sxs-lookup"><span data-stu-id="f7427-105">Rely on the properties of sequential rows, such as <xref:System.Linq.Queryable.TakeWhile%2A>.</span></span>  
  
-   <span data-ttu-id="f7427-106">Confie em uma implementação arbitrária de CLR, como <xref:System.Collections.Generic.IComparer%601>.</span><span class="sxs-lookup"><span data-stu-id="f7427-106">Rely on an arbitrary CLR implementation, such as <xref:System.Collections.Generic.IComparer%601>.</span></span>  
  
|<span data-ttu-id="f7427-107">Exemplos de sem suporte</span><span class="sxs-lookup"><span data-stu-id="f7427-107">Examples of Unsupported</span></span>|  
|-----------------------------|  
...
## <a name="differences-from-net"></a><span data-ttu-id="f7427-108">Diferenças do .NET</span><span class="sxs-lookup"><span data-stu-id="f7427-108">Differences from .NET</span></span>  
 <span data-ttu-id="f7427-109">Todos os operadores suporte a sequência funciona como esperado em Common Language Runtime (CLR) a exceção de `Average`.</span><span class="sxs-lookup"><span data-stu-id="f7427-109">All supported sequence operators work as expected in the common language runtime (CLR) except for `Average`.</span></span> <span data-ttu-id="f7427-110">`Average` retorna um valor do mesmo tipo que o tipo que está sendo especificado média, enquanto em CLR `Average` sempre retorna <xref:System.Double> ou <xref:System.Decimal>.</span><span class="sxs-lookup"><span data-stu-id="f7427-110">`Average` returns a value of the same type as the type being averaged, whereas in the CLR `Average` always returns either a <xref:System.Double> or a <xref:System.Decimal>.</span></span> <span data-ttu-id="f7427-111">Se o argumento de origem é dobrar explicitamente convertida/decimal ou o seletor converte dobrar/decimal, o SQL resultante também terá uma conversão e o resultado será como esperado.</span><span class="sxs-lookup"><span data-stu-id="f7427-111">If the source argument is explicitly cast to double / decimal or the selector casts to double / decimal, the resulting SQL will also have such a conversion and the result will be as expected.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="f7427-112">Consulte também</span><span class="sxs-lookup"><span data-stu-id="f7427-112">See Also</span></span>  
 [<span data-ttu-id="f7427-113">Funções e tipos de dados</span><span class="sxs-lookup"><span data-stu-id="f7427-113">Data Types and Functions</span></span>](../../../../../../docs/framework/data/adonet/sql/linq/data-types-and-functions.md)
