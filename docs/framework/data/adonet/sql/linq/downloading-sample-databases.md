...
2.  Vá para o [Northwind e Pubs Sample Databases](http://go.microsoft.com/fwlink?linkid=64296) site da Web.  
  
3.  Clique em **Baixar**.  
  
4.  No **Download de arquivo** caixa de diálogo, selecione **salvar**.  
  
5.  Depois que o arquivo baixado, clique duas vezes o **Nwind.exe** arquivo para instalar o banco de dados.  
...
## <a name="downloading-sql-server-express-edition"></a>Baixando o SQL Server Express Edition  
 O SQL Server Express Edition está disponível gratuitamente, e você pode redistribuí-lo com os aplicativos. Se você estiver usando o [!INCLUDE[vsprvs](../../../../../../includes/vsprvs-md.md)], o SQL Server Express Edition será incluído nas edições Pro e posteriores.  
  
#### <a name="to-download-and-install-sql-server-express-edition"></a>Para baixar e instalar o SQL Server Express Edition  
  
1.  Inicie o Internet Explorer.  
  
2.  Vá para o [Microsoft Download Center](http://go.microsoft.com/fwlink?linkid=74602) site da Web.  
  
3.  Na caixa palavras-chave, digite **SQL Server Express**.  
...
## <a name="downloading-management-studio-express"></a>Baixando o Management Studio Express  
 Se você quiser modificar um banco de dados que você baixou, você pode acessar o banco de dados de **Server Explorer** no [!INCLUDE[vs_current_short](../../../../../../includes/vs-current-short-md.md)] ambiente de desenvolvimento integrado (IDE) ou use o Microsoft SQL Server Management Studio Express ( SSMSE).  
  
#### <a name="to-download-management-studio-express"></a>Para baixar o Management Studio Express  
  
-   Siga as instruções no [site SSMSE](http://go.microsoft.com/fwlink/?LinkId=95933).  
