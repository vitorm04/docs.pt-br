...
ms.locfileid: "33360109"
---
# <a name="reference"></a>Referência
Esta seção fornece informações de referência para desenvolvedores do [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)].  
  
 Também é recomendável para pesquisar Microsoft Docs problemas específicos e especialmente para participar de [Fórum do LINQ](http://go.microsoft.com/fwlink/?LinkId=76488), onde você pode abordar tópicos mais complexos detalhadamente com especialistas. Além disso, você pode estudar um white paper detalhando a tecnologia do [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)], completo com os exemplos de código do Visual Basic e de C#. Para obter mais informações, consulte [LINQ to SQL: consulta integrada para dados relacionais](http://go.microsoft.com/fwlink/?LinkId=93205).  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Descreve o [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] abordagem mapeamento externo para o mapeamento de um [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] modelo de objeto para um banco de dados do SQL Server. Fornece a definição do esquema XSD para arquivos de mapeamento.  
