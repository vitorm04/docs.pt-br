...
## <a name="a-closer-look-at-the-extensibility-points"></a>Uma visão mais profunda dos pontos de extensibilidade  
 O exemplo a seguir mostra parte do código gerado `DataContext` pelo Object Relational Designer para a classe que possui duas tabelas: `Customers` e `Orders`. Observe que os métodos Insert, Update e Delete são definidos para cada tabela da classe.  
...
```  
 ...
 Na sua parte da classe, você escreve uma definição de implementação do método. No Visual Studio, `partial` depois de digitar você verá o IntelliSense para as definições de método na outra parte da classe.  
...
```  
 ...
 [Passo a passo: Adicionar validação a classes de entidade](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2013/bb629301(v=vs.120))  
...
- [LINQ para Ferramentas SQL no Visual Studio](/visualstudio/data-tools/linq-to-sql-tools-in-visual-studio2)
