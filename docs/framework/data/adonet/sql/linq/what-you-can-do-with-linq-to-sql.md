...
o [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] dá suporte a todos os principais recursos que você esperaria como um desenvolvedor do SQL. Você pode consultar informações, e inserir, atualizar e excluir informações de tabelas.  
