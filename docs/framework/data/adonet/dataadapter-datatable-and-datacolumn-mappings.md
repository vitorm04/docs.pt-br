...
```  
 ...
 Duas tabelas são criadas na **DataSet**: **clientes** e **Customers1**. Você pode usar mapeamentos de tabela para garantir que a segunda tabela é denominada **pedidos** em vez de **Customers1**. Para fazer isso, mapeie a tabela de origem do **Customers1** para o **DataSet** tabela **pedidos**, conforme mostrado no exemplo a seguir.  
