...
## <a name="working-with-the-data-provider-for-oracle-and-unicode-data"></a>Trabalhando com os Provedor de Dados para dados do Oracle e Unicode  
 A seguir está uma lista de problemas relacionados a Unicode que você deve considerar ao trabalhar com o .NET Framework Provedor de Dados para bibliotecas de cliente Oracle e Oracle. Para obter mais informações, consulte a documentação do Oracle.  
