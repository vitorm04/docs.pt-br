...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Modelo de Dados de Entidade: Herda](entity-data-model-inheritance.md)  
...
- [Especificação de CSDL](./ef/language-reference/csdl-specification.md)
