...
-   [Dando vida aos modelos](#LifeToModels)  
...
## <a name="entity-data-model-tools"></a>Ferramentas do Modelo de Dados de Entidade  
 Juntamente com o tempo de execução do [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)], o [!INCLUDE[vs_current_long](../../../../../includes/vs-current-long-md.md)] inclui as ferramentas de mapeamento e modelagem. Para obter mais informações, consulte [modelagem e mapeamento](../../../../../docs/framework/data/adonet/ef/modeling-and-mapping.md).  
...
## <a name="learning-more"></a>Aprendendo mais  
 ...
 Fornecer informações sobre como entrar em funcionamento rapidamente usando o [Quickstart](https://msdn.microsoft.com/library/0bc534be-789f-4819-b9f6-76e51d961675), que mostra como criar um simples [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] aplicativo.  
