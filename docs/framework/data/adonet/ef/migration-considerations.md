...
-   Qualquer aplicativo que usa o [!INCLUDE[dnprdnshort](../../../../../includes/dnprdnshort-md.md)] começando com a versão 3.5 SP1 pode ser migrado para o Entity Framework, como o provedor de dados da fonte de dados que é usado pelo aplicativo dá suporte ao Entity Framework.  
...
1.  Atualizar o aplicativo.  
     ...
     Um projeto criado usando uma versão anterior do Visual Studio e o [!INCLUDE[dnprdnshort](../../../../../includes/dnprdnshort-md.md)] devem ser atualizados para usar [!INCLUDE[vsOrcas](../../../../../includes/vsorcas-md.md)] SP1 e o [!INCLUDE[dnprdnshort](../../../../../includes/dnprdnshort-md.md)] começando com a versão 3.5 SP1.  
...
## <a name="considerations-for-applications-that-use-adonet-providers"></a>Considerações para aplicativos que usam provedores ADO.NET  
 ...
 Você pode considerar executar uma [!INCLUDE[esql](../../../../../includes/esql-md.md)] de consulta usando o provedor EntityClient e enumerar ao longo retornado <xref:System.Data.EntityClient.EntityDataReader> objeto. Faça isso apenas se seu aplicativo exibe dados de tabela usando um leitor de dados e não requer que os recursos fornecidos pelo [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] para materializar dados em objetos, controle de alterações e fazer atualizações. Você pode continuar a usar o código de acesso de dados existente que faz atualizações para a fonte de dados, mas você pode usar a conexão existente acessado a partir de <xref:System.Data.EntityClient.EntityConnection.StoreConnection%2A> propriedade <xref:System.Data.EntityClient.EntityConnection>. Para obter mais informações, consulte [provedor EntityClient para Entity Framework](../../../../../docs/framework/data/adonet/ef/entityclient-provider-for-the-entity-framework.md).  
  
 Trabalhando com DataSets.  
 O [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] fornece muitas das funcionalidades mesmo fornecidas pelo conjunto de dados, incluindo a persistência de memória, controle de alterações, associação de dados e serializar objetos como dados XML. Para obter mais informações, consulte [trabalhando com objetos](../../../../../docs/framework/data/adonet/ef/working-with-objects.md).  
...
## <a name="considerations-for-applications-that-bind-data-to-controls"></a>Considerações para aplicativos que associam dados a controles  
 O [!INCLUDE[dnprdnshort](../../../../../includes/dnprdnshort-md.md)] permite que encapsulam os dados em uma fonte de dados, como um conjunto de dados ou um [!INCLUDE[vstecasp](../../../../../includes/vstecasp-md.md)] controle de fonte de dados e, em seguida, vincular elementos de interface do usuário para esses controles de dados. A lista a seguir descreve as considerações para associar controles aos dados do Entity Framework.  
  
 Associando dados a controles  
 Quando você consulta o modelo conceitual, o [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] retorna os dados como objetos que são instâncias de tipos de entidade. Esses objetos podem ser vinculados diretamente a controles, e essa associação oferece suporte a atualizações. Isso significa que as alterações nos dados de um controle, como uma linha em uma <xref:System.Windows.Forms.DataGridView>, automaticamente são salvos no banco de dados quando o <xref:System.Data.Objects.ObjectContext.SaveChanges%2A> método é chamado.  
