...
#### <a name="return-the-correct-amount-of-data"></a>Retornar a quantidade correta de dados  
 ...
 Para evitar retornar dados demais em uma única consulta, pagine os resultados da consulta em grupos mais gerenciáveis. Para obter mais informações, consulte [como: página por meio de resultados da consulta](https://msdn.microsoft.com/library/ffc0f920-e7de-42e0-9b12-ef356421d030).  
