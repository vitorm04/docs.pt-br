...
## <a name="example"></a>Exemplo  
 O exemplo a seguir mostra como navegar em relações em [!INCLUDE[esql](../../../../../includes/esql-md.md)] usando o [NAVIGATE](../../../../../docs/framework/data/adonet/ef/language-reference/navigate-entity-sql.md) operador. O `Navigate` operador usa os seguintes parâmetros: uma instância de uma entidade, o tipo de relação, a extremidade da relação e o início da relação. Opcionalmente, você pode passar apenas uma instância de uma entidade e o tipo de relação para o `Navigate` operador.  
