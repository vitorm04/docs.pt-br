...
```  
 ...
 <span data-ttu-id="ddb2a-106">O [SpatialEdmFunctions métodos](http://msdn.microsoft.com/library/hh749531.aspx) página lista todos os métodos Entity Framework canônicos espaciais.</span><span class="sxs-lookup"><span data-stu-id="ddb2a-106">The [SpatialEdmFunctions Methods](http://msdn.microsoft.com/library/hh749531.aspx) page lists all spatial canonical Entity Framework methods.</span></span> <span data-ttu-id="ddb2a-107">Clique em um método de interesse ver quais parâmetros devem ser passados para uma função.</span><span class="sxs-lookup"><span data-stu-id="ddb2a-107">Click on a method of interest to see what parameters should be passed to a function.</span></span>
