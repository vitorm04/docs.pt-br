...
Uma agregação é uma construção de linguagem que condense uma coleção em um escalar como parte de uma operação de grupo. [!INCLUDE[esql](../../../../../../includes/esql-md.md)] agregações vêm em duas formas:  
