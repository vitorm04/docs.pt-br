...
```  
 ...
 Onde OrderCustomer está `relationship`, e o cliente e ordem são `to-end` (cliente) e `from-end` (ordem) da relação. Se OrderCustomer foi uma relação n:1, o tipo de resultado da expressão navegar é Ref\<cliente >.  
...
```  
 ...
 Da mesma forma, em uma consulta do formulário a seguir, a expressão de navegar produziria uma coleção < Ref\<ordem >>.  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Como: navegar relações com o operador de navegar](../../../../../../docs/framework/data/adonet/ef/language-reference/navigate-entity-sql.md)
