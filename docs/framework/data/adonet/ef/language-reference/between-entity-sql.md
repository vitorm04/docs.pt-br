...
Determina se uma expressão resulta em um valor em um intervalo especificado. A expressão [!INCLUDE[esql](../../../../../../includes/esql-md.md)] BETWEEN tem a mesma funcionalidade que o Transact-SQL entre a expressão.  
