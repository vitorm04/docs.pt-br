...
## <a name="aliasing-rules"></a>Regras de serrilha  
 É recomendável especificar aliases em consultas [!INCLUDE[esql](../../../../../../includes/esql-md.md)] sempre que necessário, incluindo as seguintes construções [!INCLUDE[esql](../../../../../../includes/esql-md.md)]:  
...
### <a name="alias-generation"></a>Geração do alias  
 Se nenhum alias for especificado em uma expressão de consulta [!INCLUDE[esql](../../../../../../includes/esql-md.md)], [!INCLUDE[esql](../../../../../../includes/esql-md.md)] tentará gerar um alias com base nas seguintes regras simples:  
...
### <a name="query-expressions"></a>Expressões de consulta  
 Uma expressão de consulta [!INCLUDE[esql](../../../../../../includes/esql-md.md)] introduz um novo escopo. Os nomes definidos na cláusula FROM são introduzidos no escopo from em ordem de aparência, da esquerda para a direita. Na lista de junção, as expressões podem se referir a nomes que foram definidos anteriormente na lista. As propriedades públicas (campos e assim por diante) dos elementos identificadas na cláusula não são adicionadas ao - escopo. Sempre devem ser referenciados pelo nome alias- qualificado. Normalmente, todas as partes da expressão SELECT são considerados - dentro do escopo.  
...
### <a name="aggregate-handling"></a>Tratamento aggregate  
 ...
 Ao resolver uma agregação, [!INCLUDE[esql](../../../../../../includes/esql-md.md)] primeiro tenta tratá-la como uma agregação baseada em coleção. Se isso falhar, [!INCLUDE[esql](../../../../../../includes/esql-md.md)] transformará a entrada de agregação em uma referência à agregação Nest e tentará resolver essa nova expressão, conforme ilustrado no exemplo a seguir.  
