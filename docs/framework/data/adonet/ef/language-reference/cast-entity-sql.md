...
## <a name="remarks"></a>Comentários  
 A expressão cast tem semântica semelhantes a expressão Transact-SQL converter. A expressão cast é usada para converter um valor de um tipo em um valor de outro tipo.  
