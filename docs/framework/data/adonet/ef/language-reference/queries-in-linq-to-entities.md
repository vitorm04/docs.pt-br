...
-   [Exemplos de sintaxe de expressão de consulta: Ordenando](../../../../../../docs/framework/data/adonet/ef/language-reference/query-expression-syntax-examples-ordering.md)  
...
-   [Exemplos de sintaxe de expressão de consulta: Relações de navegação](../../../../../../docs/framework/data/adonet/ef/language-reference/query-expression-syntax-examples-navigating-relationships.md)  
...
-   [Exemplos de sintaxe de consulta baseada em método: Ordenando](../../../../../../docs/framework/data/adonet/ef/language-reference/method-based-query-syntax-examples-ordering.md)  
...
-   [Exemplos de sintaxe de consulta baseada em método: Relações de navegação](../../../../../../docs/framework/data/adonet/ef/language-reference/method-based-query-syntax-examples-navigating-relationships.md)  
