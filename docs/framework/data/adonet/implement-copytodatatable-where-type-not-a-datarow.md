...
---
# <a name="how-to-implement-copytodatatablelttgt-where-the-generic-type-t-is-not-a-datarow"></a>Como implementar CopyToDataTable&lt;T&gt; quando o tipo genérico T não é um DataRow
