...
---
# <a name="query-expression-syntax-examples-element-operators-linq-to-dataset"></a>Exemplos de sintaxe de expressão de consulta: Operadores de elemento (LINQ to DataSet)
