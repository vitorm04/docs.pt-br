...
2. **Visual Studio Development Server**
    ...
    - Esse servidor tem problemas com o processamento do caractere de período (`.`) em uma URL, embora esse caractere tenha suporte WCF Data Services em valores de chave.
