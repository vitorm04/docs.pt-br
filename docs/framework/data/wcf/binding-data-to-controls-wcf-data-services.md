...
## <a name="binding-data-to-windows-presentation-foundation-elements"></a>Associando dados aos elementos do Windows Presentation Foundation  
 ...
 Para obter mais informações, confira [Como: Associar dados a elementos](bind-data-to-wpf-elements-wcf-data-services.md)de Windows Presentation Foundation.  
...
## <a name="binding-paged-data"></a>Associando dados paginados  
 ...
 Os objetos relacionados são carregados de uma maneira semelhante. Para obter mais informações, confira [Como: Associar dados a elementos](bind-data-to-wpf-elements-wcf-data-services.md)de Windows Presentation Foundation.  
...
> O [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] não executa nenhuma validação dos comportamentos personalizados que você implementa nesses delegados.  
 ...
 Para obter mais informações, confira [Como: Personalizar comportamentos](how-to-customize-data-binding-behaviors-wcf-data-services.md)de vinculação de dados.  
...
- [Como: Gerar manualmente classes de serviço de dados do cliente](how-to-manually-generate-client-data-service-classes-wcf-data-services.md)
