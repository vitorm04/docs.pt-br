...
## <a name="data-source-providers"></a>Provedores de fontes de dados  
 [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] os provedores a seguir têm suporte para definir o modelo de dados de um serviço de dados.  
