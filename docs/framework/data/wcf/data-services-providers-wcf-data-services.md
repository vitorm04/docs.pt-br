...
ms.locfileid: "73975350"
---
# <a name="data-services-providers-wcf-data-services"></a>Provedores de serviços de dados (WCF Data Services)
o [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] dá suporte a vários modelos de provedor para expor dados como um feed Protocolo Open Data (OData). Este tópico fornece informações para permitir que você selecione o melhor provedor de [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] para sua fonte de dados.  
  
## <a name="data-source-providers"></a>Provedores de fontes de dados  
 o [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] dá suporte aos provedores a seguir para definir o modelo de dados de um serviço de dados.  
...
## <a name="other-data-service-providers"></a>Outros provedores de serviços de dados  
 o [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] tem o seguinte provedor de serviços de dados adicional que aprimora o desempenho de uma fonte de dados definida usando um dos outros provedores.  
