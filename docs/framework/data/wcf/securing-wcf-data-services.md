...
OData e autenticação – parte 7 – autenticação de formulários] (https://devblogs.microsoft.com/odata/odata-and-authentication-part-7-forms-authentication/).|  
...
OData e autenticação – parte 8 – OAuth WRAP] (https://devblogs.microsoft.com/odata/odata-and-authentication-part-8-oauth-wrap/).|  
