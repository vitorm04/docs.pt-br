...
|Membro <xref:System.Linq.Expressions.Expression?qualifyHint=False&autoUpgrade=True>|Função do [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] suportada|  
|---------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|  
