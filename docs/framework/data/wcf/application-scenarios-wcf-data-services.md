...
[!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]dá suporte a um conjunto principal de cenários para expor e consumir dados [!INCLUDE[ssODataFull](../../../../includes/ssodatafull-md.md)] como feeds. Este tópico aponta os tópicos relevantes a esses cenários.
...
- [Como: Associar dados do serviço de dados a controles (cliente Silverlight)](https://docs.microsoft.com/previous-versions/dotnet/wcf-data-services/ee681614(v=vs.103))
...
- [OData Formato de JavaScript Object Notation (JSON)](https://go.microsoft.com/fwlink/?LinkId=185790)
