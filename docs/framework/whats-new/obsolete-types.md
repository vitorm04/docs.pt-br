...
|<xref:System.ComponentModel.Design.Serialization.RootDesignerSerializerAttribute?displayProperty=nameWithType>|Esse atributo foi substituído. Use <xref:System.ComponentModel.Design.Serialization.DesignerSerializerAttribute?displayProperty=nameWithType> em seu lugar. Por exemplo, para especificar um designer raiz para CodeDom, use `DesignerSerializerAttribute\(...,typeof\(TypeCodeDomSerializer\)\)`.|  
...
|<xref:System.Web.UI.MobileControls.List?displayProperty=nameWithType>|O assembly System.Web.Mobile.dll foi substituído e não deve ser mais usado. Para saber mais sobre como desenvolver aplicativos móveis ASP.NET, confira [ASP.NET for Mobiles](http://go.microsoft.com/fwlink/?LinkId=157231) (ASP.NET para mobilidade).|  
...
|<xref:System.Web.UI.MobileControls.SelectionList?displayProperty=nameWithType>|O assembly System.Web.Mobile.dll foi substituído e não deve ser mais usado. Para saber mais sobre como desenvolver aplicativos móveis ASP.NET, confira [ASP.NET for Mobiles](http://go.microsoft.com/fwlink/?LinkId=157231) (ASP.NET para mobilidade).|  
...
|Tipo|Mensagem|  
|----------|-------------|  
|<xref:Microsoft.JScript.Vsa.BaseVsaEngine?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.BaseVsaSite?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.BaseVsaStartup?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.IJSVsaCodeItem?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.IJSVsaEngine?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.IJSVsaError?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.IJSVsaGlobalItem?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.IJSVsaItem?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.IJSVsaItems?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.IJSVsaPersistSite?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.IJSVsaReferenceItem?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.IJSVsaSite?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.JSVsaError?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.JSVsaException?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.JSVsaItemFlag?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.JSVsaItemType?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.ResInfo?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
|<xref:Microsoft.JScript.Vsa.VsaEngine?displayProperty=nameWithType>|O uso desse tipo não é recomendado porque está sendo substituído no Visual Studio 2005; não haverá substituição desse recurso. Consulte a documentação de <xref:System.CodeDom.Compiler.ICodeCompiler?displayProperty=nameWithType> para obter ajuda adicional.|  
