...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Como manipular eventos de entrada do usuário em controles dos Windows Forms](../../../docs/framework/winforms/how-to-handle-user-input-events-in-windows-forms-controls.md)  
...
## <a name="related-sections"></a>Seções relacionadas  
 Veja também [Criando manipuladores de eventos nos Windows Forms](https://msdn.microsoft.com/library/dacysss4\(v=vs.110\)).
