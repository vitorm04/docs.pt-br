...
## <a name="related-sections"></a>Seções relacionadas  
 ...
 Apresenta diversas opções para implantar [!INCLUDE[ndptecclick](../../../includes/ndptecclick-md.md)] aplicativos.  
 ...
 Descreve diversos problemas que podem ocorrer ao implantar [!INCLUDE[ndptecclick](../../../includes/ndptecclick-md.md)] documentos e aplicativos de mensagens de erro de nível superior [!INCLUDE[ndptecclick](../../../includes/ndptecclick-md.md)] pode gerar.  
  
 [O ClickOnce e as configurações de aplicativo](/visualstudio/deployment/clickonce-and-application-settings)  
 Descreve como [!INCLUDE[ndptecclick](../../../includes/ndptecclick-md.md)] implantação funciona com configurações do aplicativo, que armazena configurações de aplicativo e usuário para recuperação futura.  
 ...
 Demonstra usando de linha de comando e ferramentas SDK para implantar um [!INCLUDE[ndptecclick](../../../includes/ndptecclick-md.md)] aplicativo sem usar o Visual Studio.  
 ...
 Demonstra a configuração de computadores cliente necessária para implantação de aplicativos confiáveis.  
 ...
 Demonstra como configurar um [!INCLUDE[ndptecclick](../../../includes/ndptecclick-md.md)] aplicativo, usando ferramentas SDK, para verificar um local diferente para novas versões de um aplicativo.  
 ...
 Demonstra como usar chamadas de API para recuperar um assembly na primeira vez que o aplicativo tentar carregá-lo.  
 ...
 Demonstra como marcar um arquivo para que ele está disponível na [!INCLUDE[ndptecclick](../../../includes/ndptecclick-md.md)] diretório de dados.  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Depurando aplicativos ClickOnce que usam System.Deployment.Application](http://msdn.microsoft.com/library/86f31948-2ca8-47c0-8e8b-c2b817bbf79f)  
