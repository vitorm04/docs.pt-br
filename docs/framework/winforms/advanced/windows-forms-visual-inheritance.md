...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Como: Herdar Formulários usando a caixa de diálogo Seletor de herança](how-to-inherit-forms-using-the-inheritance-picker-dialog-box.md)  
 ...
 [Passo a passo: Demonstração da herança Visual](walkthrough-demonstrating-visual-inheritance.md)  
...
## <a name="related-sections"></a>Seções relacionadas  
 [Noções básicas de herança (Visual Basic)](../../../visual-basic/programming-guide/language-features/objects-and-classes/inheritance-basics.md)  
