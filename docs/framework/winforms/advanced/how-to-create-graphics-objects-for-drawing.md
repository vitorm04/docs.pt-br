...
Antes que você pode desenhar linhas e formas, renderizar texto ou exibir e manipular imagens com o GDI+, você precisará criar um <xref:System.Drawing.Graphics> objeto. O <xref:System.Drawing.Graphics> objeto representa uma superfície de desenho GDI+ e é o objeto que é usado para criar imagens gráficas.  
