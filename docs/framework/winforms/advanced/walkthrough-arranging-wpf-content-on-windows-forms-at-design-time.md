...
---
# <a name="walkthrough-arrange-wpf-content-on-windows-forms-at-design-time"></a>Passo a passo: Organizar o conteúdo do WPF nos Windows Forms em tempo de design
...
Abra o Visual Studio e crie um novo projeto de aplicativo do Windows Forms no Visual Basic ou Visual C# nomeado `ArrangeElementHost`.
