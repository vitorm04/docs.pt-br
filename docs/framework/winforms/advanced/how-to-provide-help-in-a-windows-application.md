...
ms.locfileid: "65959615"
---
# <a name="how-to-provide-help-in-a-windows-application"></a>Como: fornecer ajuda em um aplicativo do Windows

Você pode fazer uso do <xref:System.Windows.Forms.HelpProvider> componente para anexar tópicos da Ajuda em um arquivo de ajuda a controles específicos em formulários do Windows. O arquivo de Ajuda pode ser HTML ou HTMLHelp 1.x ou formato maior.

## <a name="provide-help"></a>Fornecer ajuda

1. No Visual Studio, do **caixa de ferramentas**, arraste um <xref:System.Windows.Forms.HelpProvider> ao seu formulário.
