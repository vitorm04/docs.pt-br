...
## <a name="2-d-vector-graphics"></a>Gráficos vetoriais 2D  
 ...
 [!INCLUDE[ndptecgdiplus](../../../../includes/ndptecgdiplus-md.md)] fornece classes e estruturas que armazenam informações sobre os próprios primitivos, classes que armazenam informações sobre como os primitivos serão desenhados e classes que realmente fazem o desenho. Por exemplo, o <xref:System.Drawing.Rectangle> estrutura armazena o local e o tamanho de um retângulo; a <xref:System.Drawing.Pen> classe armazena informações sobre a cor da linha, largura da linha e estilo da linha; e o <xref:System.Drawing.Graphics> classe tem métodos para desenhar linhas, retângulos, caminhos, e outras figuras. Há também vários <xref:System.Drawing.Brush> fechado de classes que armazenam informações sobre como figuras e caminhos serão preenchidos com cores ou padrões.  
...
## <a name="typography"></a>Tipografia  
 Tipografia é a exibição do texto em uma variedade de fontes, tamanhos e estilos. [!INCLUDE[ndptecgdiplus](../../../../includes/ndptecgdiplus-md.md)] fornece suporte extensivo para essa tarefa complexa. Um dos novos recursos do [!INCLUDE[ndptecgdiplus](../../../../includes/ndptecgdiplus-md.md)] é a suavização de subpixel, que proporciona ao texto renderizado em uma tela LCD uma aparência mais suave.  
