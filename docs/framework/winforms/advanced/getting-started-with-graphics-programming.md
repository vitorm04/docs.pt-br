...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Como: Desenhar texto Vertical em um formulário do Windows](how-to-draw-vertical-text-on-a-windows-form.md)  
 ...
 [Como: Criar um formulário do Windows moldado](how-to-create-a-shaped-windows-form.md)  
