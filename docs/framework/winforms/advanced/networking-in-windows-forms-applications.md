...
## <a name="reference"></a>Referência  
 <xref:System.Net>  
 O namespace raiz para as classes do .NET Framework que manipulam conectividade de rede.  
  
 <xref:System.Net.WebClient>  
 Uma classe conveniente para recuperar o conteúdo Web ou baseado em HTTP por meio de programação.  
  
 <xref:System.Net.FtpWebRequest>  
 Uma classe para recuperar e enviar arquivos via FTP.  
  
 <xref:System.Windows.Forms.WebBrowser>  
 Uma classe wrapper gerenciada para o controle `WebBrowser` que está incluído no Windows.  
