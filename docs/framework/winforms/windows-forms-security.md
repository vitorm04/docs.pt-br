...
## <a name="related-sections"></a>Seções relacionadas  
 [NIB: política de segurança padrão](https://msdn.microsoft.com/library/2c086873-0894-4f4d-8f7e-47427c1a3b55)  
 Lista as permissões padrão concedidas nos conjuntos de permissão de Confiança Total, Intranet Local e Internet.  
  
 [NIB: administração de política de segurança geral](https://msdn.microsoft.com/library/5121fe35-f0e3-402c-94ab-4f35b0a87b4b)  
 ...
 [NIB: determinando quando modificar a política de segurança](https://msdn.microsoft.com/library/af749b17-e461-409d-84b9-a3d44789db16)  
 Explica como determinar quando seus aplicativos precisam divergir da política de segurança padrão.  
  
 [NIB: implantando a política de segurança](https://msdn.microsoft.com/library/f936c1e5-033b-4bd9-a3bd-a39ba733a681)  
