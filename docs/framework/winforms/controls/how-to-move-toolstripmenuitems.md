...
Em tempo de design, você pode mover todos os menus de nível superior e seus itens de menu para um local <xref:System.Windows.Forms.MenuStrip>diferente no. Você também pode mover itens de menu individuais entre menus de nível superior ou alterar a posição dos itens de menu dentro de um menu.
