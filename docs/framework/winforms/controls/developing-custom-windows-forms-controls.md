...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Layout em controles do Windows Forms](../../../../docs/framework/winforms/controls/layout-in-windows-forms-controls.md)  
 Mostra como criar layouts para seus controles e formulários.  
  
 [Multithreading em controles do Windows Forms](../../../../docs/framework/winforms/controls/multithreading-in-windows-forms-controls.md)  
