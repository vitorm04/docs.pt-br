...
1. No Visual Studio, crie um projeto de biblioteca de controles do Windows chamado **TestContainerExample**. Para obter detalhes, consulte [Modelo da Biblioteca de Controles do Windows](https://docs.microsoft.com/previous-versions/kxczf775(v=vs.100)).
...
3. Pressione **F5** para compilar o projeto e executar o **contêiner de teste de UserControl**. O contêiner de teste é exibido com seu <xref:System.Windows.Forms.UserControl> no **visualização** painel.
...
## <a name="test-user-controls-from-another-project"></a>Controles de usuário de outro projeto de teste
