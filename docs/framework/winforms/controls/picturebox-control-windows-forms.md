...
ms.locfileid: "33535204"
---
# <a name="picturebox-control-windows-forms"></a>Controle PictureBox (Windows Forms)
Windows Forms `PictureBox` controle é usado para exibir elementos gráficos em formato de bitmap, GIF, JPEG, metarquivo ou ícone.  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Explica o que o <xref:System.Windows.Forms.PictureBox.SizeMode%2A> propriedade faz e como configurá-la.  
