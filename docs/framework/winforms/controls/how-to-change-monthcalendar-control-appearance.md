...
---
# <a name="how-to-change-the-windows-forms-monthcalendar-controls-appearance"></a>Como alterar a aparência do controle MonthCalendar dos Windows Forms
O controle de <xref:System.Windows.Forms.MonthCalendar> de Windows Forms permite que você personalize a aparência do calendário de várias maneiras. Por exemplo, você pode definir o esquema de cores e optar por exibir ou ocultar os números de semana e a data atual.  
  
### <a name="to-change-the-month-calendars-color-scheme"></a>Alterar o esquema de cores do calendário do mês  
  
- Defina propriedades como <xref:System.Windows.Forms.MonthCalendar.TitleBackColor%2A>, <xref:System.Windows.Forms.MonthCalendar.TitleForeColor%2A> e <xref:System.Windows.Forms.MonthCalendar.TrailingForeColor%2A>. A propriedade <xref:System.Windows.Forms.MonthCalendar.TitleBackColor%2A> também determina a cor da fonte para os dias da semana. A propriedade <xref:System.Windows.Forms.MonthCalendar.TrailingForeColor%2A> determina a cor das datas que precedem e seguem o mês ou os meses exibidos.  
