...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Apresenta os conceitos gerais do `TrackBar` controle, que permite aos usuários navegar por meio das informações ao ajustar visualmente um ajuste numérico.  
