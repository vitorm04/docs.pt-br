...
Consulte também [como: Adicionar e remover nós com o Windows Forms controle TreeView usando o designer](add-and-remove-nodes-with-wf-treeview-control-using-the-designer.md)e [como anexar um menu de atalho a um TreeNode usando o designer](how-to-attach-a-shortcut-menu-to-a-treenode-using-the-designer.md).  
