...
Um motivo para implementar o modo virtual no <xref:System.Windows.Forms.DataGridView> controle é recuperar os dados conforme o necessário. Isso é chamado de *carregamento de dados Just-In-Time*.  
 ...
 Para copiar o código neste tópico como uma única listagem, consulte [Como implementar o modo virtual com carregamento de dados Just-In-Time no controle DataGridView dos Windows Forms](../../../../docs/framework/winforms/controls/virtual-mode-with-just-in-time-data-loading-in-the-datagrid.md).  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Como implementar o modo virtual com carregamento de dados Just-In-Time no controle DataGridView dos Windows Forms](../../../../docs/framework/winforms/controls/virtual-mode-with-just-in-time-data-loading-in-the-datagrid.md)
