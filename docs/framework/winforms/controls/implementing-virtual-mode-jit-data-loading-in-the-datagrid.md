...
Um motivo para implementar o modo virtual no <xref:System.Windows.Forms.DataGridView> controle é recuperar dados somente conforme necessário. Isso é chamado de *carregamento de dados Just-In-Time*.  
 ...
 Para copiar o código neste tópico como uma única lista, consulte [como: Implementar o modo Virtual com carregamento de dados Just-In-Time para o Windows Forms DataGridView Control](../../../../docs/framework/winforms/controls/virtual-mode-with-just-in-time-data-loading-in-the-datagrid.md).  
