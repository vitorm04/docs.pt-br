...
Este tópico explica o significado e o uso da lista de erros de tempo de design que aparece no Visual Studio quando o Designer de formulários do Windows Falha ao carregar. Se essa lista de erros aparecer, não a interprete como um bug do designer, mas como um auxílio para a correção de erros no código.
