...
## <a name="see-also"></a>Consulte também  
 ...
 [Como Selecionar um Item no Controle ListView dos Windows Forms](../../../../docs/framework/winforms/controls/how-to-select-an-item-in-the-windows-forms-listview-control.md)  
