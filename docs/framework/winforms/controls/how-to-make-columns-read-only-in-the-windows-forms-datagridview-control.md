...
---
# <a name="how-to-make-columns-read-only-in-the-windows-forms-datagridview-control"></a>Como: Tornar colunas somente leitura no controle DataGridView do Windows Forms
