...
---
# <a name="default-keyboard-and-mouse-handling-in-the-windows-forms-datagridview-control"></a>Teclado e mouse manipulando no controle DataGridView do Windows Forms padrão
...
|F3|Classifica a coluna atual, se o <xref:System.Windows.Forms.DataGridViewColumn.SortMode%2A?displayProperty=nameWithType> é o valor da propriedade <xref:System.Windows.Forms.DataGridViewColumnSortMode.Automatic>. É o mesmo que clicar no cabeçalho da coluna atual. Disponível desde o .NET Framework 4.7.2. Para habilitar esse recurso, os aplicativos devem direcionar o .NET Framework 4.7.2 ou versões posteriores ou aceitar explicitamente as melhorias de acessibilidade usando as opções do AppContext.|  
|F4|Se a célula atual for um <xref:System.Windows.Forms.DataGridViewComboBoxCell>, colocará a célula no modo de edição e exibe a lista suspensa.|  
|ALT+SETA PARA CIMA/PARA BAIXO|Se a célula atual for um <xref:System.Windows.Forms.DataGridViewComboBoxCell>, colocará a célula no modo de edição e exibe a lista suspensa.|  
|ESPAÇO|Se a célula atual for um <xref:System.Windows.Forms.DataGridViewButtonCell>, <xref:System.Windows.Forms.DataGridViewLinkCell>, ou <xref:System.Windows.Forms.DataGridViewCheckBoxCell>, gera a <xref:System.Windows.Forms.DataGridView.CellClick> e <xref:System.Windows.Forms.DataGridView.CellContentClick> eventos. Se a célula atual for um <xref:System.Windows.Forms.DataGridViewButtonCell>, também pressionará o botão. Se a célula atual for um <xref:System.Windows.Forms.DataGridViewCheckBoxCell>, também altera o estado de seleção.|  
...
|------------------|-----------------|  
|Botão esquerdo do mouse para baixo|Torna a célula clicada a célula atual e gera o <xref:System.Windows.Forms.DataGridView.CellMouseDown?displayProperty=nameWithType> eventos.|  
...
|Botão esquerdo do mouse para baixo e arrastar em uma célula de cabeçalho de coluna|Se o <xref:System.Windows.Forms.DataGridView.AllowUserToOrderColumns%2A?displayProperty=nameWithType> é de propriedade `true`, move a coluna para que ele pode ser descartado em uma nova posição.|  
...
### <a name="mouse-selection"></a>Seleção de mouse
 ...
 Se o <xref:System.Windows.Forms.DataGridView.MultiSelect%2A> estiver definida como `false` e o <xref:System.Windows.Forms.DataGridView.SelectionMode%2A> estiver definida como <xref:System.Windows.Forms.DataGridViewSelectionMode.CellSelect>, ocorrerá o seguinte comportamento.  
...
|Clicar com o botão direito do mouse|Exibe um menu de atalho, se estiver disponível.|  
 ...
 O mesmo comportamento ocorre quando o <xref:System.Windows.Forms.DataGridView.SelectionMode%2A> é definido como <xref:System.Windows.Forms.DataGridViewSelectionMode.RowHeaderSelect> ou <xref:System.Windows.Forms.DataGridViewSelectionMode.ColumnHeaderSelect>, exceto que, dependendo do modo de seleção, clicar em um cabeçalho de linha ou coluna selecionará a linha ou coluna inteira e definir a célula atual para a primeira célula na linha ou coluna.  
  
 Se <xref:System.Windows.Forms.DataGridView.SelectionMode%2A> é definido como <xref:System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect> ou <xref:System.Windows.Forms.DataGridViewSelectionMode.FullColumnSelect>, clicar em qualquer célula em uma linha ou coluna selecionará a linha ou coluna inteira.  
  
 Se <xref:System.Windows.Forms.DataGridView.MultiSelect%2A> é definido como `true`, clicar em uma célula mantendo a tecla CTRL ou SHIFT modificará uma seleção de várias célula.  
 ...
 Se <xref:System.Windows.Forms.DataGridView.MultiSelect%2A> é definido como `true` e <xref:System.Windows.Forms.DataGridView.SelectionMode%2A> é definido como <xref:System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect> ou <xref:System.Windows.Forms.DataGridViewSelectionMode.FullColumnSelect>, clicar em uma célula mantendo a tecla SHIFT ou CTRL se comporta da mesma forma, exceto que completa somente linhas e colunas são afetadas.  
