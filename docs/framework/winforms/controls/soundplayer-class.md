...
## <a name="related-sections"></a>Seções relacionadas  
 ...
 Veja também [HYPERLINK "http://msdn.microsoft.com/library/11bxex12(v=vs.110)" My.Computer Object](http://msdn.microsoft.com/library/11bxex12\(v=vs.110\)) ou [My.Computer Object](http://msdn.microsoft.com/library/11bxex12\(v=vs.120\)).
