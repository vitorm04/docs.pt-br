...
|Nome|Descrição|  
|----------|-----------------|  
|<xref:System.Windows.Forms.ToolStripProgressBar.MarqueeAnimationSpeed%2A>|Obtém ou define um valor que representa o atraso entre cada atualização de exibição <xref:System.Windows.Forms.ProgressBarStyle.Marquee>, em milissegundos.|  
|<xref:System.Windows.Forms.ProgressBar.Maximum%2A>|Obtém ou define o limite superior do intervalo definido para esse <xref:System.Windows.Forms.ToolStripProgressBar>.|  
|<xref:System.Windows.Forms.ToolStripProgressBar.Minimum%2A>|Obtém ou define o limite inferior do intervalo que está definido para esse <xref:System.Windows.Forms.ToolStripProgressBar>.|  
