...
### <a name="to-copy-a-control"></a>Para copiar um controle  
  
1.  Selecione o controle e o **editar** menu escolha **cópia**.  
  
 Esse controle agora pode ser colado em qualquer formato que aceita o tipo de controle. Além disso, o controle foi adicionado à área de transferência.  
