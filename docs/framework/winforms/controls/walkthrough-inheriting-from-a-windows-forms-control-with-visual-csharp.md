...
---
# <a name="walkthrough-inheriting-from-a-windows-forms-control-with-visual-c"></a>Passo a passo: Herdar de um controle de Windows Forms com o Visual C\#
...
2. Selecione o modelo de projeto da **biblioteca de controle de Windows Forms** na C# lista de projetos visuais `ValueButtonLib` e digite na caixa **nome** .
...
5. Localize a `class` linha de instrução `public partial class ValueButton`, e altere o tipo do <xref:System.Windows.Forms.UserControl> qual <xref:System.Windows.Forms.Button>esse controle herda. Isso permite que o controle herdado herde toda a funcionalidade <xref:System.Windows.Forms.Button> do controle.
