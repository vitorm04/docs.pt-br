...
2.  Selecione o modelo de projeto **Biblioteca de Controles dos Windows Forms** na lista de projetos [!INCLUDE[csprcs](../../../../includes/csprcs-md.md)] e digite `ValueButtonLib` na caixa **Nome**.  
