...
## <a name="related-sections"></a>Seções relacionadas  
 ...
 [Visão geral do componente FontDialog](../../../../docs/framework/winforms/controls/fontdialog-component-overview-windows-forms.md)  
 ...
 [Visão geral do componente PrintDialog](../../../../docs/framework/winforms/controls/printdialog-component-overview-windows-forms.md)  
 ...
 Veja também [Caixas de diálogo nos Windows Forms](../dialog-boxes-in-windows-forms.md).
