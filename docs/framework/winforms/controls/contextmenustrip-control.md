...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Veja também [Caixa de diálogo de tarefas ContextMenuStrip](https://msdn.microsoft.com/library/ms233646\(v=vs.110\)) ou [Editor de coleção de itens ContextMenuStrip](https://msdn.microsoft.com/library/ms233641\(v=vs.110\)).  
