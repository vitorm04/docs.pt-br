...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Descreve como o controle de `DataGridView` melhora e substitui o controle de <xref:System.Windows.Forms.DataGrid>.  
...
## <a name="reference"></a>Referência  
 ...
 Fornece documentação de referência para o componente <xref:System.Windows.Forms.BindingSource>. O controle de <xref:System.Windows.Forms.DataGridView> e o componente <xref:System.Windows.Forms.BindingSource> são projetados para trabalhar juntos.  
