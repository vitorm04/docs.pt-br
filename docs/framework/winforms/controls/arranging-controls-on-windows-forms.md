...
## <a name="in-this-section"></a>Nesta seção
 ...
 Descreve como você pode colocar controles em formulários usando o <xref:System.Windows.Forms.Control.Margin%2A>, <xref:System.Windows.Forms.Control.Padding%2A>, e <xref:System.Windows.Forms.Control.AutoSize%2A> propriedades dentro de **Designer de formulários** no Visual Studio.
