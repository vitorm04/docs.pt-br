...
> [!NOTE]
> Não é necessário ter uma compreensão completa da herança, mas talvez seja útil consultar [noções básicas de herança (Visual Basic)](../../../visual-basic/programming-guide/language-features/objects-and-classes/inheritance-basics.md).  
