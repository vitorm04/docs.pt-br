...
Você pode usar o componente Windows Forms <xref:System.Windows.Forms.ErrorProvider> para exibir erros de coluna em um conjunto de dados ou em outra fonte. Para um componente <xref:System.Windows.Forms.ErrorProvider> exibir erros de dados em um formulário, ele não precisa estar diretamente associado a um controle. Depois de associado a uma fonte de dados, ele pode exibir um ícone de erro ao lado de qualquer controle que esteja associado à mesma fonte de dados.  
  
> [!NOTE]
> Se você alterar as propriedades de <xref:System.Windows.Forms.ErrorProvider.DataSource%2A> e <xref:System.Windows.Forms.ErrorProvider.DataMember%2A> do provedor de erros em tempo de execução, deverá usar o método <xref:System.Windows.Forms.ErrorProvider.BindToDataAndErrors%2A> para evitar conflitos.  
...
2. Defina a propriedade <xref:System.Windows.Forms.ErrorProvider.ContainerControl%2A> como o formulário.  
