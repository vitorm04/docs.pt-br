...
2.  Na lista de projetos do [!INCLUDE[vbprvb](../../../../includes/vbprvb-md.md)], selecione o modelo de projeto **Biblioteca de Controles do Windows**, digite `ctlClockLib` na caixa **Nome** e clique em **OK**.  
