...
7. Também é possível testar e depurar o controle criando um novo projeto, como um Aplicativo do Windows, e colocá-lo em um contêiner. Esse processo é demonstrado como parte [do passo a passos: Criação de um controle composto com Visual Basic](walkthrough-authoring-a-composite-control-with-visual-basic.md).
