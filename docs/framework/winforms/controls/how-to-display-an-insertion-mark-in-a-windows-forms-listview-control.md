...
- [Passo a passo: executar uma operação do tipo "arrastar e soltar" no Windows Forms](../advanced/walkthrough-performing-a-drag-and-drop-operation-in-windows-forms.md)
