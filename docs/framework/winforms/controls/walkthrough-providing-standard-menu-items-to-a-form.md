...
1. No Visual Studio, crie um projeto de aplicativo do Windows chamado **StandardMenuForm** (**arquivo** > **novo** > **projeto**   >  **Visual C#**  ou **Visual Basic** > **área de trabalho clássica**  >  **Aplicativo de formulários do Windows**).
...
## <a name="handle-item-selection"></a>Lidar com a seleção de item
