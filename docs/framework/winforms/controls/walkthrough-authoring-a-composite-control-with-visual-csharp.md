...
2.  Na lista de projetos do [!INCLUDE[csprcs](../../../../includes/csprcs-md.md)], selecione o modelo de projeto **Biblioteca de Controles dos Windows Forms**, digite `ctlClockLib` na caixa **Nome** e clique em **OK**.  
