...
1. Desenhe um controle de <xref:System.Windows.Forms.GroupBox> em um formulário.  
  
2. Adicione outros controles à caixa de grupo desenhando cada um deles dentro da caixa de grupo.  
  
     Se você tiver controles existentes que deseja incluir em uma caixa de grupo, poderá selecionar todos os controles, recortá-los para a área de transferência, selecionar o controle de <xref:System.Windows.Forms.GroupBox> e, em seguida, colá-los na caixa de grupo. Você também pode arrastá-los para a caixa de grupo.  
