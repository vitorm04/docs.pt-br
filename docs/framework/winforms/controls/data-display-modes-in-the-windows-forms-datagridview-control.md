...
## <a name="unbound"></a>Não Associado  
 ...
 Para obter um exemplo que usa somente leitura não associado <xref:System.Windows.Forms.DataGridView>, consulte [como: Criar um controle de DataGridView não associado do Windows Forms](../../../../docs/framework/winforms/controls/how-to-create-an-unbound-windows-forms-datagridview-control.md).  
...
## <a name="bound"></a>Associado  
 ...
 Para obter um exemplo que usa um limite <xref:System.Windows.Forms.DataGridView> de controle, consulte [passo a passo: Validando dados em que o Windows Forms DataGridView Control](../../../../docs/framework/winforms/controls/walkthrough-validating-data-in-the-windows-forms-datagridview-control.md).  
