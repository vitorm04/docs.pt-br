...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Como: Navegar em dados nos Windows Forms](how-to-navigate-data-in-windows-forms.md)  
 ...
 [Como: Verifique se que a linha selecionada em uma tabela filho permaneça na posição correta](ensure-the-selected-row-in-a-child-table-correct.md)  
 ...
 Consulte também [Interfaces relacionadas à associação de dados](interfaces-related-to-data-binding.md), [como: Navegar em dados nos Windows Forms](how-to-navigate-data-in-windows-forms.md), e [como: Criar um controle associado simples em um formulário do Windows](how-to-create-a-simple-bound-control-on-a-windows-form.md).  
