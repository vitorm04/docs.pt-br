...
### <a name="validation-and-verification"></a>Validação e verificação  
 Para fornecer isolamento de assembly e integridade, o [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] usa um processo de validação. [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] a validação garante que os assemblies são isolados por meio da validação de seu formato de arquivo PE (executável portátil) para endereços que apontam para fora do assembly. [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] validação também valida a integridade dos metadados inseridos em um assembly.  
...
-   Várias caixas de diálogo de segurança em alguns sites.  
 ...
 A mesma lógica de iniciação pelo usuário também é aplicada a **aberto**/**salvar** avisos de segurança. [!INCLUDE[TLA2#tla_actx](../../../includes/tla2sharptla-actx-md.md)] caixas de diálogo de instalação sempre são interceptadas na barra de informações, a menos que elas representem uma atualização de um controle instalado anteriormente. Essas medidas são combinadas para fornecer aos usuários uma experiência do usuário mais segura e mais controlada, já que eles estão protegidos contra sites que os induzem a instalar software indesejado ou mal-intencionado.  
