...
-   Para remover um <xref:System.Windows.Media.Animation.Storyboard> iniciada com um gatilho de evento, consulte [como: remover um Storyboard](http://msdn.microsoft.com/en-us/7fe39531-de2f-46a0-a69f-b783d04235ee).  
