...
## <a name="example"></a>Exemplo  
 ...
 O código foi omitido neste exemplo. Para o código completo, consulte o [exemplo de comportamento de tempo de animação](https://go.microsoft.com/fwlink/?LinkID=159970).
