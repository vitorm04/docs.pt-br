...
## <a name="image-metadata"></a>Metadados de imagem  
 ...
 Acesso aos metadados é fornecido por meio de <xref:System.Windows.Media.Imaging.BitmapSource.Metadata%2A> propriedade de um <xref:System.Windows.Media.Imaging.BitmapSource> objeto. <xref:System.Windows.Media.Imaging.BitmapSource.Metadata%2A> Retorna um <xref:System.Windows.Media.Imaging.BitmapMetadata> objeto que inclui todos os metadados contidos pela imagem. Esses dados podem estar em um esquema de metadados ou em uma combinação de esquemas diferentes. [!INCLUDE[TLA2#tla_wic](../../../../includes/tla2sharptla-wic-md.md)] dá suporte a esquemas de metadados de imagem a seguir: [!INCLUDE[TLA#tla_exif](../../../../includes/tlasharptla-exif-md.md)], o texto (dados textuais PNG), [!INCLUDE[TLA#tla_ifd](../../../../includes/tlasharptla-ifd-md.md)], [!INCLUDE[TLA#tla_iptc](../../../../includes/tlasharptla-iptc-md.md)], e [!INCLUDE[TLA#tla_xmp](../../../../includes/tlasharptla-xmp-md.md)].  
