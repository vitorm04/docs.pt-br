...
---
# <a name="how-to-create-a-new-bitmapsource"></a>Como: Criar um novo BitmapSource
Este exemplo demonstra como usar o <xref:System.Windows.Media.Imaging.BitmapSource.Create%2A> método de <xref:System.Windows.Media.Imaging.BitmapSource> para criar um novo <xref:System.Windows.Media.Imaging.BitmapSource> objeto.  
