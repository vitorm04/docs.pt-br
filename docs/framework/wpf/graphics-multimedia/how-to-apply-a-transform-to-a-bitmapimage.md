...
---
# <a name="how-to-apply-a-transform-to-a-bitmapimage"></a>Como: Aplicar uma transformação a um BitmapImage
Este exemplo demonstra como aplicar uma <xref:System.Windows.Media.Transform> para um <xref:System.Windows.Media.Imaging.BitmapImage>.  
...
- [Girar uma imagem](../controls/how-to-rotate-an-image.md)
