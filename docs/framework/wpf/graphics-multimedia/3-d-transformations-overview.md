...
## <a name="translation-transformations"></a>Transformações de translação  
 ...
 ![Valor de translação](./media/transforms-translate.png "traduzir de transformações")  
...
## <a name="scale-transformations"></a>Dimensionar transformações  
 ...
 ![Uniforme ScaleTransform3D](./media/threecubes-uniformscale-1.png "threecubes_uniformscale_1")  
Exemplo de ScaleVector  
 ...
 ![Três cubos dimensionados com o ponto central especificado](./media/threecubes-scaledwithcenter-1.png "threecubes_scaledwithcenter_1")  
...
Rotação com o novo centro especificado  
 ...
 ![Rotação de 60 graus em x&#45; e y&#45;eixos](./media/twocubes-rotation2axes-1.png "twocubes_rotation2axes_1")  
Exemplo de rotação  
