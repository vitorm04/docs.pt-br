...
ms.locfileid: "61910007"
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="60fdb-102">Como: Converter um BitmapSource em um formato de pixel indexado</span><span class="sxs-lookup"><span data-stu-id="60fdb-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="60fdb-103">Este exemplo mostra como converter um <xref:System.Windows.Media.Imaging.BitmapSource> em um formato de pixel indexado.</span><span class="sxs-lookup"><span data-stu-id="60fdb-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="60fdb-104">Exemplo</span><span class="sxs-lookup"><span data-stu-id="60fdb-104">Example</span></span>  
