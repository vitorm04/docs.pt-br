...
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="cea31-102">Como converter um BitmapSource em um formato de pixel indexado</span><span class="sxs-lookup"><span data-stu-id="cea31-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="cea31-103">Este exemplo mostra como converter um <xref:System.Windows.Media.Imaging.BitmapSource> em um formato de pixel indexado.</span><span class="sxs-lookup"><span data-stu-id="cea31-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="cea31-104">Exemplo</span><span class="sxs-lookup"><span data-stu-id="cea31-104">Example</span></span>  
