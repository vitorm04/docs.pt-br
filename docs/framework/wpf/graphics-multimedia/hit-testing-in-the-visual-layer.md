...
## <a name="hit-testing-and-z-order"></a>Teste de clique e ordem z  
 ...
 ![Diagrama de o z&#45;ordem de uma árvore visual](./media/wcpsdk-mmgraphics-visuals-hittest-2.png "wcpsdk_mmgraphics_visuals_hittest_2")  
...
## <a name="using-a-hit-test-filter-callback"></a>Usando um retorno de chamada de filtro de teste de clique  
 ...
 ![Aparando uma árvore visual usando um filtro de teste de hit](./media/filteredvisualtree-01.png "FilteredVisualTree_01")  
