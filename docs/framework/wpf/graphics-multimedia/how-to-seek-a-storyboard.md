...
O exemplo a seguir mostra como usar o <xref:System.Windows.Media.Animation.Storyboard.Seek%2A> método de um <xref:System.Windows.Media.Animation.Storyboard> para ir para qualquer posição em uma animação de storyboard.  
...
## <a name="example"></a>Exemplo  
 Abaixo está o código usado junto com o XAML acima.  
