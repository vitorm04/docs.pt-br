...
## <a name="example"></a>Exemplo  
 O exemplo a seguir usa <xref:System.Windows.Controls.MediaElement> e <xref:System.Windows.Media.MediaTimeline> em um <xref:System.Windows.Media.Animation.Storyboard> para reproduzir um clipe de mídia em um loop infinito.  
