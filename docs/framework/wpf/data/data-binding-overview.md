...
## <a name="what-is-data-binding"></a>O que é a vinculação de dados?  
 ...
 ![Tela de exemplo de associação de dados](./media/databinding-databindingdemo.png "DataBinding_DataBindingDemo")  
...
##### <a name="using-a-default-view"></a>Usando uma exibição padrão  
 ...
 Para obter a exibição padrão, você deve usar o <xref:System.Windows.Data.CollectionViewSource.GetDefaultView%2A> método. Para obter um exemplo, consulte [Como obter a exibição padrão de uma coleção de dados](how-to-get-the-default-view-of-a-data-collection.md).  
