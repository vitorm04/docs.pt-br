...
## <a name="example"></a>Exemplo  
 A propriedade <xref:System.Windows.Controls.TextBox.Text%2A> do elemento <xref:System.Windows.Controls.TextBox> tem por padrão o valor de <xref:System.Windows.Data.UpdateSourceTrigger.LostFocus>. Isso significa que se um aplicativo tem um <xref:System.Windows.Controls.TextBox> com uma associação de dados para a propriedade <xref:System.Windows.Controls.TextBox>.<xref:System.Windows.Controls.TextBox.Text%2A>, o texto digitado na <xref:System.Windows.Controls.TextBox> não atualiza a origem até que o <xref:System.Windows.Controls.TextBox> perca o foco (por exemplo, quando você clica fora do <xref:System.Windows.Controls.TextBox>).  
  
 Se você quiser que o código-fonte seja atualiado enquanto você digita, defina a associação de <xref:System.Windows.Data.Binding.UpdateSourceTrigger%2A> a <xref:System.Windows.Data.UpdateSourceTrigger.PropertyChanged>. No exemplo a seguir, as linhas realçadas de código mostram que a propriedade `Text` de ambos os <xref:System.Windows.Controls.TextBox> e o <xref:System.Windows.Controls.TextBlock> são associados à mesma propriedade de origem. A proprieadade <xref:System.Windows.Data.Binding.UpdateSourceTrigger%2A> do <xref:System.Windows.Controls.TextBox> associação é definida como <xref:System.Windows.Data.UpdateSourceTrigger.PropertyChanged>.  
