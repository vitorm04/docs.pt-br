...
Os tópicos nesta seção descrevem como usar a ligação de dados para associar elementos aos dados de uma variedade de fontes de dados na forma de objetos common language runtime (CLR) e XML.  
