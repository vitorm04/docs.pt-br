...
Este exemplo mostra como associar dados [!INCLUDE[TLA#tla_xml](../../../../includes/tlasharptla-xml-md.md)] usando um <xref:System.Windows.Data.XmlDataProvider>.  
  
 Com um <xref:System.Windows.Data.XmlDataProvider>, os dados subjacentes que podem ser acessados por meio da ligação de dados em seu aplicativo podem ser qualquer árvore de nós [!INCLUDE[TLA2#tla_xml](../../../../includes/tla2sharptla-xml-md.md)]. Em outras palavras, um <xref:System.Windows.Data.XmlDataProvider> fornece uma maneira conveniente de usar qualquer árvore de nós [!INCLUDE[TLA#tla_xml](../../../../includes/tlasharptla-xml-md.md)] como uma fonte de associação.  
...
> O nó raiz dos dados [!INCLUDE[TLA2#tla_xml](../../../../includes/tla2sharptla-xml-md.md)] tem um atributo **xmlns** que define o namespace [!INCLUDE[TLA2#tla_xml](../../../../includes/tla2sharptla-xml-md.md)] para uma cadeia de caracteres vazia. Esse é um requisito para aplicar consultas XPath a uma ilha de dados embutida na página [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)]. Nesse caso embutido, o [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] e, portanto, a ilha de dados, herda o namespace <xref:System.Windows>. Por isso, você precisa definir o namespace em branco para impedir que as consultas XPath sejam qualificadas pelo namespace <xref:System.Windows>, o que indiretoia as consultas.  
 ...
 O <xref:System.Windows.Controls.ListBox> mostrará os itens a seguir quando este exemplo for executado. Esses são os *Título*s de todos os elementos em *Livros* com um valor de *Estoque* de "*sem*" ou um valor de *Número* de 3 ou maior ou igual a 8. Observe que nenhum item de *CD* é retornado porque o valor <xref:System.Windows.Data.XmlDataProvider.XPath%2A> definido no <xref:System.Windows.Data.XmlDataProvider> indica que somente os elementos *Books* devem ser expostos (essencialmente definindo um filtro).  
 ...
 Neste exemplo, os títulos de livros são exibidos porque o <xref:System.Windows.Data.Binding.XPath%2A> da Associação <xref:System.Windows.Controls.TextBlock> no <xref:System.Windows.DataTemplate> é definido como "*título*". Se você quiser exibir o valor de um atributo, como o *ISBN*, defina esse valor <xref:System.Windows.Data.Binding.XPath%2A> como "`@ISBN`".  
  
 As propriedades **XPath** no [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] são manipuladas pelo método XmlNode.SelectNodes. Você pode modificar as consultas **XPath** para obter resultados diferentes. Aqui estão alguns exemplos para a consulta <xref:System.Windows.Data.Binding.XPath%2A> no @no__t associado-1 do exemplo anterior:  
...
- O `XPath="*[position()>3]"` retornará todos os elementos de livro exceto os três primeiros.  
 ...
 Se os dados [!INCLUDE[TLA2#tla_xml](../../../../includes/tla2sharptla-xml-md.md)] residirem em um arquivo remoto [!INCLUDE[TLA2#tla_xml](../../../../includes/tla2sharptla-xml-md.md)], você definirá o acesso aos dados atribuindo uma URL apropriada ao atributo <xref:System.Windows.Data.XmlDataProvider.Source%2A> da seguinte maneira:  
