...
## <a name="example"></a>Exemplo  
 Para retornar de uma função de página, você precisa chamar <xref:System.Windows.Navigation.PageFunction%601.OnReturn%2A> e passar uma instância de <xref:System.Windows.Navigation.ReturnEventArgs%601>.  
