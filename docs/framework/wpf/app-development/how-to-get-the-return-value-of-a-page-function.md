...
## <a name="example"></a>Exemplo  
 Para obter o resultado é retornado de uma função de página, você precisa tratar <xref:System.Windows.Navigation.PageFunction%601.Return> da função da página que você está chamando.  
