...
## <a name="example"></a>Exemplo  
 O código a seguir mostra como usar um **mailto:** [!INCLUDE[TLA#tla_uri](../../../../includes/tlasharptla-uri-md.md)] para abrir uma nova janela de email que contém um endereço de email e endereço de email e um assunto e um endereço de email, assunto e corpo.  
