...
## <a name="textbox-parts"></a>Partes de caixa de texto  
...
## <a name="textbox-states"></a>Estados de caixa de texto  
...
|ReadOnly|CommonStates|O usuário não pode alterar o texto a <xref:System.Windows.Controls.TextBox>.|  
...
## <a name="textbox-controltemplate-example"></a>Exemplo de ControlTemplate de caixa de texto  
