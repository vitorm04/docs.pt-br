...
## <a name="creating-a-richtextbox"></a>Criando um RichTextBox  
 ...
 Elementos como <xref:System.Windows.Documents.Paragraph> e <xref:System.Windows.Documents.Bold> determinar como o conteúdo dentro de um <xref:System.Windows.Controls.RichTextBox> é exibida. Conforme um usuário edita <xref:System.Windows.Controls.RichTextBox> conteúdo, eles alteram o conteúdo de fluxo. Para saber mais sobre os recursos do conteúdo de fluxo e como trabalhar com ele, consulte [Visão geral de documento de fluxo](../../../../docs/framework/wpf/advanced/flow-document-overview.md).  
