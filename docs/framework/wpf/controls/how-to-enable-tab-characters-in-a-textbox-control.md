...
## <a name="example"></a>Exemplo  
 Para habilitar a aceitação de caracteres de tabulação como entrada em um <xref:System.Windows.Controls.TextBox> controlar, defina o <xref:System.Windows.Controls.Primitives.TextBoxBase.AcceptsTab%2A> atributo **true**.  
