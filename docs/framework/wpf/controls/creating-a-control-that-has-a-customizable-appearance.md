...
![Uma caixa de seleção com o modelo de controle padrão. ](./media/ndp-checkboxdefault.png "NDP_CheckBoxDefault") A caixa de seleção que usa o modelo de controle padrão

![Uma caixa de seleção com um modelo de controle personalizado. ](./media/ndp-checkboxcustom.png "NDP_CheckBoxCustom") A caixa de seleção que usa um modelo de controle personalizado
...
![Controle NumericUpDown personalizado. ](./media/ndp-numericupdown.png "NDP_NumericUPDown") um controle NumericUpDown personalizado
