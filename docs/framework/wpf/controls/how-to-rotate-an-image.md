...
---
# <a name="how-to-rotate-an-image"></a><span data-ttu-id="c34d4-102">Como girar uma imagem</span><span class="sxs-lookup"><span data-stu-id="c34d4-102">How to: Rotate an Image</span></span>
<span data-ttu-id="c34d4-103">Este exemplo mostra como girar uma imagem 90 graus usando um <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> propriedade de um <xref:System.Windows.Media.Imaging.BitmapImage>.</span><span class="sxs-lookup"><span data-stu-id="c34d4-103">This example shows how to rotate an image 90 degrees by using a <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> property of a <xref:System.Windows.Media.Imaging.BitmapImage>.</span></span>  
  
## <a name="example"></a><span data-ttu-id="c34d4-104">Exemplo</span><span class="sxs-lookup"><span data-stu-id="c34d4-104">Example</span></span>  
