...
Como seu nome sugere, Windows Presentation Foundation (WPF) é excelente para fazer experiências de apresentação avançadas para os clientes. Essas instruções passo a passo mostram como personalizar a aparência e o comportamento de um botão (incluindo animações). Essa personalização é feita usando um estilo e modelo para que você possa aplicar esse botão personalizado facilmente aos botões em seu aplicativo. A ilustração a seguir mostra o botão personalizado que você criará.
 ...
 Os gráficos vetoriais que compõem a aparência do botão são criados usando [!INCLUDE[TLA#tla_xaml](../../../../includes/tlasharptla-xaml-md.md)]. [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] é semelhante ao HTML, exceto que ele é mais poderoso e extensível. [!INCLUDE[TLA#tla_xaml](../../../../includes/tlasharptla-xaml-md.md)] pode ser digitada manualmente usando o Visual Studio ou o bloco de notas, ou você pode usar uma ferramenta de Design Visual, como Blend para Visual Studio. O Blend funciona criando código XAML subjacente, portanto, ambos os métodos criam os mesmos elementos gráficos.

## <a name="in-this-section"></a>Nesta seção
 [Criar um botão usando o Microsoft Expression Blend](walkthrough-create-a-button-by-using-microsoft-expression-blend.md) Demonstra como criar botões com comportamento personalizado usando os recursos de designer do Expression Blend.
