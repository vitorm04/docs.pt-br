...
Este tópico descreve os estilos e modelos para o <xref:System.Windows.Window> controle. Você pode modificar o padrão <xref:System.Windows.Controls.ControlTemplate> para dar ao controle uma aparência exclusiva. Para obter mais informações, consulte [Personalizando a aparência de um controle existente criando um ControlTemplate](customizing-the-appearance-of-an-existing-control.md).  
  
## <a name="window-parts"></a>Partes da janela  
 O <xref:System.Windows.Window> controle não tem nenhuma parte nomeada.  
