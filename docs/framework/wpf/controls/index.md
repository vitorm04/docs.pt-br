...
### <a name="creating-a-style-for-a-control"></a>Criando um estilo para um controle  
 ...
 Você também pode aplicar um estilo somente determinados controles de um tipo específico atribuindo uma chave para o estilo e especificar essa chave no `Style` propriedade de seu controle.  Para obter mais informações sobre estilos, consulte [estilo e modelagem](styling-and-templating.md).  
