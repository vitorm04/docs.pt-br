...
|Novo no .NET?|[Visão geral do .NET Framework](../../get-started/overview.md)<br /><br /> [Fundamentos do aplicativo .NET Framework](../../../../docs/standard/application-essentials.md)<br /><br /> [Introdução ao Visual C# e ao Visual Basic](/visualstudio/ide/getting-started-with-visual-csharp-and-visual-basic)|  
