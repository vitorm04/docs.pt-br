...
|Novo no .NET?|[Visão geral do .NET Framework](../../get-started/overview.md)<br /><br /> [Fundamentos do aplicativo .NET Framework](../../../standard/application-essentials.md)<br /><br /> [Introdução ao Visual C# e ao Visual Basic](/visualstudio/ide/quickstart-visual-basic-console)|  
