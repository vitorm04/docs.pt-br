...
- Exiba o conteúdo do Direct3D9 usando a <xref:System.Windows.Interop.D3DImage> classe.
...
Crie um novo projeto de aplicativo do WPF no Visual C#, chamado `D3DHost`. Para obter mais informações, confira [Passo a passo: Meu primeiro aplicativo](../getting-started/walkthrough-my-first-wpf-desktop-application.md)de área de trabalho do WPF.
...
Você importa o conteúdo de Direct3D9 de uma dll não gerenciada usando o `DllImport` atributo.
...
Por fim, use <xref:System.Windows.Interop.D3DImage> a classe para hospedar o conteúdo do Direct3D9.
