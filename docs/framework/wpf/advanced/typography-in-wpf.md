...
## <a name="improved-quality-and-performance-of-text"></a>Melhor qualidade e desempenho de texto  
 ...
 ![Texto com y do ClearType&#45;direção&#45;alias](../../../../docs/framework/wpf/advanced/media/typographyinwpf02.gif "TypographyInWPF02")  
...
Texto utilizando uma SkewTransform  
 ...
 ![Captura de tela do efeito de texto girar texto](../../../../docs/framework/wpf/advanced/media/texteffect01.jpg "TextEffect01")  
...
Exemplo de um pincel de imagem aplicado ao traço e ao realce  
 ...
 Para obter mais informações sobre o <xref:System.Windows.Media.FormattedText> do objeto, consulte [Desenhando texto formatado](../../../../docs/framework/wpf/advanced/drawing-formatted-text.md).  
