...
As bibliotecas do Windows Presentation Foundation (WPF) expõem várias funções não gerenciadas que se destinam somente ao uso interno. Eles não devem ser chamados do código do usuário.  
