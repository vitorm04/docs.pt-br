...
1.  Adicionar um **aplicativo WPF (.NET Framework)** projeto chamado `WpfUserControlHost` à solução. Para obter mais informações, consulte [Como criar um novo projeto de aplicativo do WPF](https://msdn.microsoft.com/library/1f6aea7a-33e1-4d3f-8555-1daa42e95d82).
