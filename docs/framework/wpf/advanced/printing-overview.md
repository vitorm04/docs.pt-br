...
-   Desempenho de impressão aprimorado para aplicativos baseados em [!INCLUDE[TLA2#tla_winfx](../../../../includes/tla2sharptla-winfx-md.md)] e [!INCLUDE[TLA#tla_win32](../../../../includes/tlasharptla-win32-md.md)].  
...
## <a name="gdi-print-path"></a>Caminho de impressão GDI  
 Enquanto aplicativos [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] oferecem suporte nativo ao caminho de impressão [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)], os aplicativos [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] e [!INCLUDE[TLA2#tla_winforms](../../../../includes/tla2sharptla-winforms-md.md)] também podem aproveitar alguns recursos do [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)]. O driver de impressora [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)] (XPSDrv) pode converter saída baseada em [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] em formato [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)]. Para cenários avançados, há suporte para conversão personalizada de conteúdo usando o [Microsoft XPS documento conversor (MXDC)](https://msdn.microsoft.com/library/windows/desktop/ff686803.aspx). Da mesma forma, [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] aplicativos também podem produzir saída para o [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] caminho de impressão chamando um do <xref:System.Windows.Xps.XpsDocumentWriter.Write%2A> ou <xref:System.Windows.Xps.XpsDocumentWriter.WriteAsync%2A> métodos do <xref:System.Windows.Xps.XpsDocumentWriter> classe e designando uma impressora não-XpsDrv como o destino de fila de impressão.  
