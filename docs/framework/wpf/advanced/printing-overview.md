...
### <a name="print-path-architecture"></a>Arquitetura de caminho de impressão  
 Embora o [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] e o .NET Framework aplicativos ofereçam [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] suporte a XPS e Windows Forms [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] aplicativos usam uma conversão para XPS a fim de criar conteúdo formatado em XPS para o driver de impressora XPS (XPSDrv). Esses aplicativos não são obrigados a usar o caminho de impressão XPS e podem continuar a usar a impressão baseada em metarquivos avançados (EMF). No entanto, a maioria dos recursos e aprimoramentos do XPS só está disponível para aplicativos direcionados ao caminho de impressão XPS.  
  
 Para habilitar o uso de impressoras baseadas em XPSDrv por [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] e Windows Forms aplicativos, o driver de impressora XPS (XPSDrv) dá suporte [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] à conversão do formato XPS. O modelo XPSDrv também fornece um conversor para que o [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] XPS seja formatado [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] para que os [!INCLUDE[TLA2#tla_xps](../../../../includes/tla2sharptla-xps-md.md)] aplicativos possam imprimir documentos. Para [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] aplicativos, [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] <xref:System.Windows.Xps.XpsDocumentWriter.WriteAsync%2A> a conversão<xref:System.Windows.Xps.XpsDocumentWriter.Write%2A> de XPS em formato é feita automaticamente pelos métodos e da classesemprequeafiladeimpressãodedestinodaoperaçãodegravaçãonãotemumdriverXPSDrv.<xref:System.Windows.Xps.XpsDocumentWriter> (Windows Forms aplicativos não podem [!INCLUDE[TLA2#tla_xps](../../../../includes/tla2sharptla-xps-md.md)] imprimir documentos.)  
...
## <a name="gdi-print-path"></a>Caminho de impressão GDI  
 Embora [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] os aplicativos ofereçam suporte nativo ao caminho de [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] impressão XPS, e os aplicativos Windows Forms também podem aproveitar alguns recursos do XPS. O driver de impressora XPS (XPSDrv) pode [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] converter a saída baseada em formato XPS. Para cenários avançados, há suporte para a conversão personalizada de conteúdo usando o [Microsoft XPS Document Converter (MXDC)](/windows/desktop/printdocs/microsoft-xps-document-converter--mxdc-). Da mesma [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] forma, os aplicativos também podem [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] gerar saída para o caminho de impressão <xref:System.Windows.Xps.XpsDocumentWriter.Write%2A> chamando <xref:System.Windows.Xps.XpsDocumentWriter.WriteAsync%2A> um dos métodos <xref:System.Windows.Xps.XpsDocumentWriter> ou da classe e designando uma impressora não XPSDrv como a fila de impressão de destino.  

Para aplicativos que não exigem suporte ou funcionalidade XPS, o caminho de [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] impressão atual permanece inalterado.  
  
- Para obter material de referência adicional [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] sobre o caminho de impressão e as várias opções de conversão de XPS, consulte [Microsoft XPS Document Converter (MXDC)](/windows/desktop/printdocs/microsoft-xps-document-converter--mxdc-) e [drivers de impressora XPSDrv](/windows-hardware/drivers/print/xpsdrv-printer-drivers).  
...
## <a name="xpsdrv-driver-model"></a>Modelo de driver XPSDrv  
 ...
 EMF é um formato fechado que representa a saída do aplicativo como uma série de [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] chamadas para serviços de renderização. Diferentemente do EMF, o formato de spool XPS representa o documento real sem a necessidade de mais interpretação quando a saída para um driver de impressora baseado em XPS (XPSDrv). Os drivers podem operar diretamente nos dados no formato. Esse recurso elimina os dados e as conversões de espaço de cores necessárias ao usar arquivos EMF [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)]e drivers de impressão baseados em.  
