 ...
 **Observação** Para simplificar, o exemplo acima usa a presença de \*uma extensão. XPS como seu teste de que um arquivo é XPS. No entanto, os arquivos XPS não precisam ter essa extensão. O [isXPS. exe (ferramenta de conformidade do isXPS)](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/aa348104(v=vs.100)) é uma maneira de testar um arquivo para a validade do XPS.  
