...
O exemplo a seguir demonstra que <xref:System.Windows.Controls.Image> o não herda o <xref:System.Windows.FlowDirection> do <xref:System.Windows.Controls.StackPanel> que o contém.
