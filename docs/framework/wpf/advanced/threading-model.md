...
## <a name="overview-and-the-dispatcher"></a>Visão geral e o dispatcher  
 ...
 Historicamente, o Windows [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] permite que os elementos sejam acessados somente pelo thread que os criou. Isso significa que um thread de segundo plano responsável por uma tarefa de execução longa não pode atualizar uma caixa de texto quando ele é concluído. O Windows faz isso para garantir a integridade [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] dos componentes. Uma caixa de listagem poderá ter uma aparência estranha se seu conteúdo for atualizado por um thread de segundo plano durante a pintura.  
