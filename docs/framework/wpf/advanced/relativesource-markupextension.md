...
Especifica as propriedades de <xref:System.Windows.Data.RelativeSource> uma fonte de associação, a ser usada em uma [extensão de marcação de associação](binding-markup-extension.md)ou <xref:System.Windows.Data.Binding.RelativeSource%2A> ao definir a <xref:System.Windows.Data.Binding> propriedade de um elemento estabelecido em XAML.
...
|||
|-|-|
|`modeEnumValue`|Um dos seguintes:<br /><br /> -O token `Self`da cadeia de caracteres; corresponde a um <xref:System.Windows.Data.RelativeSource> as criado com sua <xref:System.Windows.Data.RelativeSource.Mode%2A> propriedade definida como <xref:System.Windows.Data.RelativeSourceMode.Self>.<br />-O token `TemplatedParent`da cadeia de caracteres; corresponde a um <xref:System.Windows.Data.RelativeSource> as criado com sua <xref:System.Windows.Data.RelativeSource.Mode%2A> propriedade definida como <xref:System.Windows.Data.RelativeSourceMode.TemplatedParent>.<br />-O token `PreviousData`da cadeia de caracteres; corresponde a um <xref:System.Windows.Data.RelativeSource> as criado com sua <xref:System.Windows.Data.RelativeSource.Mode%2A> propriedade definida como <xref:System.Windows.Data.RelativeSourceMode.PreviousData>.<br />– Veja abaixo para obter informações sobre o modo `FindAncestor`.|
...
No exemplo a seguir, o primeiro <xref:System.Windows.Controls.TextBlock> no modelo de itens exibe o número atual. A segunda <xref:System.Windows.Controls.TextBlock> associação é um <xref:System.Windows.Data.MultiBinding> que, de maneira nominal <xref:System.Windows.Data.Binding> , tem dois constituintes: o registro atual e uma associação que usa deliberadamente o registro `{RelativeSource PreviousData}`de dados anterior usando. Em seguida, um conversor em <xref:System.Windows.Data.MultiBinding> calcula a diferença e retorne à associação.
...
Na implementação [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] do processador XAML, o tratamento para essa extensão de marcação é definido pela <xref:System.Windows.Data.RelativeSource> classe.
