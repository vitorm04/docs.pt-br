...
---
# <a name="how-to-drag-and-drop-ink"></a>Como: Arrastar e soltar tinta
## <a name="example"></a>Exemplo  
 O exemplo a seguir cria um aplicativo que permite que o usuário arraste traços selecionados de uma <xref:System.Windows.Controls.InkCanvas> para outro.  
