...
---
# <a name="how-to-drag-and-drop-ink"></a><span data-ttu-id="7d26b-102">Como arrastar e soltar tinta</span><span class="sxs-lookup"><span data-stu-id="7d26b-102">How to: Drag and Drop Ink</span></span>
## <a name="example"></a><span data-ttu-id="7d26b-103">Exemplo</span><span class="sxs-lookup"><span data-stu-id="7d26b-103">Example</span></span>  
 <span data-ttu-id="7d26b-104">O exemplo a seguir cria um aplicativo que permite ao usuário arrastar traços selecionados de um <xref:System.Windows.Controls.InkCanvas> para outro.</span><span class="sxs-lookup"><span data-stu-id="7d26b-104">The following example creates an application that enables the user to drag selected strokes from one <xref:System.Windows.Controls.InkCanvas> to the other.</span></span>  
