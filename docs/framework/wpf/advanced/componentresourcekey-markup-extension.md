...
- Acessando um recurso de tema do assembly, quando você está remodelando o controle, mas deseja usar valores de propriedade que vêm dos recursos fornecidos pelos temas do controle.  
 ...
 O `ComponentResourceKey` pode ser usado na sintaxe de elemento de objeto. Nesse caso, especificar o valor de ambas as <xref:System.Windows.ComponentResourceKey.TypeInTargetAssembly%2A> Propriedades e <xref:System.Windows.ComponentResourceKey.ResourceId%2A> é necessário para inicializar corretamente a extensão.  
  
 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] Na implementação do leitor, o tratamento para essa extensão de marcação é definido pela <xref:System.Windows.ComponentResourceKey> classe.  
