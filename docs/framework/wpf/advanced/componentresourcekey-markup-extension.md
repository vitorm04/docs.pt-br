...
|`targetID`|A chave para o recurso. Quando recursos forem pesquisados, `targetID` será análogo à [Diretiva X:Key](../../../../docs/framework/xaml-services/x-key-directive.md) do recurso.|  
