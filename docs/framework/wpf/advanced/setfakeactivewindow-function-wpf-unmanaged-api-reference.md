...
ms.locfileid: "62053399"
---
# <a name="setfakeactivewindow-function-wpf-unmanaged-api-reference"></a>Função SetFakeActiveWindow (referência de API não gerenciada WPF)
