...
A <xref:System.Windows.FrameworkElement> classe expõe várias propriedades que são usadas para posicionar precisamente os elementos filho. Este tópico discute quatro das propriedades mais <xref:System.Windows.FrameworkElement.HorizontalAlignment%2A>importantes: <xref:System.Windows.Controls.Border.Padding%2A>, <xref:System.Windows.FrameworkElement.Margin%2A>, e <xref:System.Windows.FrameworkElement.VerticalAlignment%2A>. É importante entender os efeitos dessas propriedades, pois eles fornecem a base para controlar a posição dos elementos em aplicativos [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)].  

<a name="wcpsdk_layout_amp_introduction"></a>   
## <a name="introduction-to-element-positioning"></a>Introdução ao posicionamento de elementos  
 Há diversas formas de posicionar elementos usando [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]. No entanto, obter layout ideal vai além de simplesmente <xref:System.Windows.Controls.Panel> escolher o elemento correto. O <xref:System.Windows.FrameworkElement.HorizontalAlignment%2A>controle fino do posicionamento requer uma compreensão das propriedades <xref:System.Windows.FrameworkElement.Margin%2A>, <xref:System.Windows.Controls.Border.Padding%2A>, e <xref:System.Windows.FrameworkElement.VerticalAlignment%2A> .  
...
## <a name="understanding-alignment-properties"></a>Compreendendo as propriedades de alinhamento  
 As <xref:System.Windows.FrameworkElement.HorizontalAlignment%2A> propriedades <xref:System.Windows.FrameworkElement.VerticalAlignment%2A> e descrevem como um elemento filho deve ser posicionado dentro do espaço de layout alocado de um elemento pai. Ao usar essas propriedades juntas, você pode posicionar elementos filho com precisão. Por exemplo, elementos filho de a <xref:System.Windows.Controls.DockPanel> podem especificar quatro alinhamentos horizontais diferentes <xref:System.Windows.HorizontalAlignment.Left>: <xref:System.Windows.HorizontalAlignment.Right>, ou <xref:System.Windows.HorizontalAlignment.Center>, ou para <xref:System.Windows.HorizontalAlignment.Stretch> preencher o espaço disponível. Valores semelhantes estão disponíveis para o posicionamento vertical.  
  
> [!NOTE]
> Explicitamente, as <xref:System.Windows.FrameworkElement.Height%2A> propriedades <xref:System.Windows.FrameworkElement.Width%2A> definidas e em um elemento têm precedência <xref:System.Windows.HorizontalAlignment.Stretch> sobre o valor da propriedade. <xref:System.Windows.FrameworkElement.Height%2A>Tentar definir `Stretch` , <xref:System.Windows.FrameworkElement.Width%2A>, e um <xref:System.Windows.FrameworkElement.HorizontalAlignment%2A> valor de `Stretch` resultados na solicitação sendo ignorada.  
...
|<xref:System.Windows.HorizontalAlignment.Stretch>Os|Os elementos filho são redimensionados para preencher o espaço de layout alocado do elemento pai. Explicit <xref:System.Windows.FrameworkElement.Width%2A> e<xref:System.Windows.FrameworkElement.Height%2A> Values têm precedência.|  
 ...
 O código anterior resulta num layout semelhante à imagem a seguir. Os efeitos de posicionamento de <xref:System.Windows.FrameworkElement.HorizontalAlignment%2A> cada valor são visíveis na ilustração.  
...
### <a name="verticalalignment-property"></a>Propriedade VerticalAlignment  
 A <xref:System.Windows.FrameworkElement.VerticalAlignment%2A> propriedade descreve as características de alinhamento vertical para aplicar aos elementos filho. A tabela a seguir mostra cada um dos valores possíveis para <xref:System.Windows.FrameworkElement.VerticalAlignment%2A> a propriedade.  
...
|<xref:System.Windows.VerticalAlignment.Stretch>Os|Os elementos filho são redimensionados para preencher o espaço de layout alocado do elemento pai. Explicit <xref:System.Windows.FrameworkElement.Width%2A> e<xref:System.Windows.FrameworkElement.Height%2A> Values têm precedência.|  
 ...
 O código anterior resulta num layout semelhante à imagem a seguir. Os efeitos de posicionamento de <xref:System.Windows.FrameworkElement.VerticalAlignment%2A> cada valor são visíveis na ilustração.  
...
## <a name="understanding-the-padding-property"></a>Entendendo a propriedade de preenchimento  
 O preenchimento é semelhante <xref:System.Windows.FrameworkElement.Margin%2A> a na maioria dos aspectos. A propriedade Padding é exposta somente em algumas classes, principalmente como uma conveniência <xref:System.Windows.Documents.Block>:, <xref:System.Windows.Controls.Border>, <xref:System.Windows.Controls.Control>e <xref:System.Windows.Controls.TextBlock> são exemplos de classes que expõem uma propriedade Padding. A <xref:System.Windows.Controls.Border.Padding%2A> Propriedade amplia o tamanho efetivo de um elemento filho pelo valor especificado <xref:System.Windows.Thickness> .  
  
 O exemplo a seguir mostra como aplicar <xref:System.Windows.Controls.Border.Padding%2A> a um elemento <xref:System.Windows.Controls.Border> pai.  
...
## <a name="using-alignment-margins-and-padding-in-an-application"></a>Usando alinhamento, margens e preenchimento em um aplicativo  
 <xref:System.Windows.FrameworkElement.HorizontalAlignment%2A>,, e fornecem<xref:System.Windows.FrameworkElement.VerticalAlignment%2A> o controle de posicionamento necessário para criar um complexo [!INCLUDE[TLA#tla_ui](../../../../includes/tlasharptla-ui-md.md)]. <xref:System.Windows.FrameworkElement.Margin%2A> <xref:System.Windows.Controls.Border.Padding%2A> Você pode usar os efeitos de cada propriedade para alterar o posicionamento do elemento filho, permitindo a flexibilidade na criação de aplicativos dinâmicos e experiências de usuário.  
  
 O exemplo a seguir demonstra cada um dos conceitos detalhados neste tópico. Com base na infraestrutura encontrada no primeiro exemplo deste tópico, este exemplo adiciona um <xref:System.Windows.Controls.Grid> elemento como filho <xref:System.Windows.Controls.Border> do no primeiro exemplo. <xref:System.Windows.Controls.Border.Padding%2A>é aplicado ao elemento pai <xref:System.Windows.Controls.Border> . O <xref:System.Windows.Controls.Grid> é usado para particionar o espaço entre <xref:System.Windows.Controls.StackPanel> três elementos filho. <xref:System.Windows.Controls.Button>os elementos são usados novamente para mostrar os vários efeitos <xref:System.Windows.FrameworkElement.Margin%2A> de <xref:System.Windows.FrameworkElement.HorizontalAlignment%2A>e. <xref:System.Windows.Controls.TextBlock>os elementos são adicionados a <xref:System.Windows.Controls.ColumnDefinition> cada um para definir melhor as várias propriedades aplicadas <xref:System.Windows.Controls.Button> aos elementos em cada coluna.  
 ...
 Quando compilado, o aplicativo anterior produz um [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] que parece com a ilustração a seguir. Os efeitos dos vários valores de propriedade são evidentes no espaçamento entre os elementos, e valores de propriedade significativos para os elementos em cada <xref:System.Windows.Controls.TextBlock> coluna são mostrados nos elementos.  
