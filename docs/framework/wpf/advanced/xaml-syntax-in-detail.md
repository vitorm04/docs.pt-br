...
-   Tipo deriva <xref:System.Array> (para obter mais informações sobre matrizes em XAML, consulte [extensão de marcação X:array](../../../../docs/framework/xaml-services/x-array-markup-extension.md).)  
