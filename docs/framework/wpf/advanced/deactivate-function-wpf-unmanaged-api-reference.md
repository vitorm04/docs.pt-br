---
title: Desativar função-referência de API não gerenciada do WPF
titleSuffix: ''
ms.date: 03/30/2017
dev_langs:
- cpp
...
ms.locfileid: "76737975"
---
# <a name="deactivate-function-wpf-unmanaged-api-reference"></a>Função Deactivate (referência de API não gerenciada do WPF)
