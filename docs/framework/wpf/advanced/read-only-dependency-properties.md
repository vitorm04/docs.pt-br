...
- Ao registrar sua propriedade, chame o método <xref:System.Windows.DependencyProperty.RegisterReadOnly%2A> em vez do método normal <xref:System.Windows.DependencyProperty.Register%2A> para o registro de propriedade.  
