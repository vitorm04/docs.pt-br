...
## <a name="see-also"></a>Consulte também  
 ...
 [Tipos de projeto do C#, F# e Visual Basic](/visualstudio/debugger/debugging-preparation-csharp-f-hash-and-visual-basic-project-types)   
