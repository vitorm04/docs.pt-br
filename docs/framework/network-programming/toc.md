...
### [O uso de fluxos na rede](using-streams-on-the-network.md)
### [Fazer solicitações assíncronas](making-asynchronous-requests.md)
...
### [TCP UDP](tcp-udp.md)
#### [Usando os serviços de TCP](using-tcp-services.md)
#### [Usando os serviços de UDP](using-udp-services.md)
### [Soquetes](sockets.md)
#### [Como criar um soquete](how-to-create-a-socket.md)
#### [Usando soquetes do cliente](using-client-sockets.md)
##### [Usando um soquete do cliente síncrona](using-a-synchronous-client-socket.md)
##### [Usando um soquete do cliente assíncrono](using-an-asynchronous-client-socket.md)
#### [Escutando com soquetes](listening-with-sockets.md)
##### [Usando um soquete de servidor síncrona](using-a-synchronous-server-socket.md)
##### [Usando um soquete assíncrono de servidor](using-an-asynchronous-server-socket.md)
...
### [Exceções e Noções básicas sobre problemas de WebRequest](understanding-webrequest-problems-and-exceptions.md)
...
### [Habilitar o rastreamento de rede](enabling-network-tracing.md)
...
#### [Básica e a autenticação Digest](basic-and-digest-authentication.md)
#### [A autenticação Kerberos e NTLM](ntlm-and-kerberos-authentication.md)
...
### [Par de nomes e IDs PNRP](peer-names-and-pnrp-ids.md)
### [Resolução e publicação de nome de ponto](peer-name-publication-and-resolution.md)
### [Nuvens PNRP](pnrp-clouds.md)
### [O PNRP Caches](pnrp-caches.md)
