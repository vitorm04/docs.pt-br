...
- [Como definir uma política de cache para uma solicitação](how-to-set-cache-policy-for-a-request.md)  
 ...
 Também é possível configurar uma política de cache usando os arquivos de configuração do aplicativo ou do computador. Para obter mais informações, consulte &#124; [ \<solicitarO elemento> (Configurações de rede)](../configure-apps/file-schema/network/requestcaching-element-network-settings.md).  
