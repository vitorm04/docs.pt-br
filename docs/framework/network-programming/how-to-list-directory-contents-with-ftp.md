...
Se precisar listar um diretório específico, basta adicionar o diretório ao final do URI que você está usando no método <xref:System.Net.WebRequest.Create%2A?displayProperty=nameWithType>:
