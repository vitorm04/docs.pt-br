...
Esta seção contém informações sobre o suporte para tipos de [!INCLUDE[TLA#tla_uiautomation](../../../includes/tlasharptla-uiautomation-md.md)]controle no.
