...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.NameProperty>|Consulte observações.|O valor da propriedade `Name` do controle da caixa de seleção é o texto que é exibido ao lado da caixa que mantém o estado de alternância.|  
...
|---------------------|-------------|-----------|  
|<xref:System.Windows.Automation.Provider.IToggleProvider>|Necessário|Permite que a caixa de seleção seja alternada por meio de seus Estados internos programaticamente.|  
...
|<xref:System.Windows.Automation.TogglePatternIdentifiers.ToggleStateProperty> evento de alteração de propriedade.|Necessário|{1&gt;Nenhum&lt;1}|  
