...
|Propriedade de padrão de controle|Suporte|Anotações|
|------------------------------|-------------|-----------|
...
|[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] evento|Suporte/valor|Anotações|
|---------------------------------------------------------------------------------|--------------------|-----------|
