...
A exibição de controle do controle de item de menu tem o [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] mostrada acima de estrutura de árvore. Observe que o **ajudar** item de menu está incluído para ilustrar melhor a estrutura em um menu típico para a hierarquia de submenu.
