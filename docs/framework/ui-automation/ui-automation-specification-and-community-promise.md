...
## <a name="see-also"></a>Consulte também  
 [Especificação de automação de interface do usuário](http://go.microsoft.com/fwlink/?LinkId=108541)  
 [Promessa de comunidade de automação de interface do usuário](http://go.microsoft.com/fwlink/?LinkId=108542)
