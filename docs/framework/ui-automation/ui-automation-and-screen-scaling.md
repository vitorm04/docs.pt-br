...
## <a name="scaling-in-ui-automation-clients"></a>Dimensionamento em clientes de automação de interface do usuário  
 O [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] API não usa coordenadas lógicas. Os métodos e propriedades a seguir retornam coordenadas físicas ou levá-los como parâmetros.  
