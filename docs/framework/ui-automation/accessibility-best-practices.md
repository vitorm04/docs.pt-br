...
## <a name="see-also"></a>Consulte também  
 ...
 [Diretrizes para Design de Interface do usuário de teclado](/previous-versions/windows/desktop/dnacc/guidelines-for-keyboard-user-interface-design)
