...
|------------------|------------------|  
|TitleBar<br /><br /> -Menu (0 ou 1)<br />-Botão (0 ou mais)|Não aplicável. (o controle de barra de título não tem conteúdo.)|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsOffscreenProperty>|Dependem|Esse controle retornará um valor dependendo se a barra de título está visível na tela.|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsEnabledProperty>evento de alteração de propriedade.|Nunca|Nenhum|  
