...
|WebBrowser|  
 ...
 Os seguintes controles estão expostos a [!INCLUDE[TLA#tla_uiautomation](../../../includes/tlasharptla-uiautomation-md.md)] somente através de seu suporte para Microsoft Active Accessibility. Algumas funcionalidades podem não estar disponíveis.  
