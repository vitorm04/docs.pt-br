...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsContentElementProperty>|verdadeiro|The data item control must always be content.|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.IsControlElementProperty>|verdadeiro|The data item control must always be a control.|  
...
|<xref:System.Windows.Automation.Provider.ISelectionItemProvider>|Sim|All data items must support the Selection Item pattern to indicate when the item is selected.|  
