...
## <a name="silverlight-usage-notes"></a>Notas de uso do Silverlight  
 `x:Name` para Silverlight está documentado separadamente. Para obter mais informações, consulte [XAML namespace (x:) Recursos de linguagem (Silverlight)](https://docs.microsoft.com/previous-versions/windows/silverlight/dotnet-windows-silverlight/cc188995(v=vs.95)).  
