...
## <a name="white-space-definition"></a>Definição de espaço em branco  
 Consistente com XML, os caracteres de espaço em branco em [!INCLUDE[TLA2#tla_xaml](../../../includes/tla2sharptla-xaml-md.md)] são espaço, avanço de alimentação e tabulação. Elas correspondem aos valores Unicode 0020, 000A e 0009, respectivamente.  
