...
Você também pode encapsular várias versões de uma biblioteca de tipos. Para obter instruções, consulte [Como encapsular várias versões de bibliotecas de tipos](/previous-versions/dotnet/netframework-4.0/1565h6hc(v=vs.100)).
