...
![COM Callable Wrapper](./media/ccw.gif "ccw") Como acessar objetos .NET por meio do COM Callable Wrapper
...
![Interfaces COM](./media/ccwwithinterfaces.gif "ccwwithinterfaces") Interfaces COM e COM Callable Wrapper
