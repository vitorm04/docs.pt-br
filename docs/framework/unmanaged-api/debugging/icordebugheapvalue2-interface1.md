...
---
# <a name="icordebugheapvalue2-interface1"></a>Interface1 ICorDebugHeapValue2
Uma extensão de ICorDebugHeapValue que oferece suporte a common language runtime (CLR) trata.  
