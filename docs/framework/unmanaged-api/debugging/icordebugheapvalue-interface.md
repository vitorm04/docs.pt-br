...
|[Método IsValid](../../../../docs/framework/unmanaged-api/debugging/icordebugheapvalue-isvalid-method.md)|Obtém um valor que indica se o objeto representado por este `ICorDebugHeapValue` é válido ou se foi recuperado pelo coletor de lixo. Esse método foi preterido no .NET Framework versão 2,0.|  
