...
|Método|Descrição|  
|------------|-----------------|  
|[Método Next](icordebugcodeenum-next-method.md)|Obtém o número especificado de instâncias de `ICorDebugCode` da enumeração, começando na posição atual.|  
