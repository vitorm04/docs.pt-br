...
|Método|Descrição|  
|------------|-----------------|  
|[Método Next](../../../../docs/framework/unmanaged-api/debugging/icordebugprocessenum-next-method.md)|Obtém o número especificado de `ICorDebugProcess` instâncias da enumeração, começando na posição atual.|  
