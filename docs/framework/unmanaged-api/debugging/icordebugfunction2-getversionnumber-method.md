...
## <a name="remarks"></a>Comentários  
 ...
 O número de versão obtido pelo método `GetVersionNumber` pode ser menor que o obtido por [ICorDebugFunction:: GetCurrentVersionNumber](icordebugfunction-getcurrentversionnumber-method.md).  
