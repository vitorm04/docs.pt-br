...
|Método|Descrição|  
|------------|-----------------|  
|[Método EnumMemoryRegions](../../../../docs/framework/unmanaged-api/debugging/iclrdataenummemoryregions-enummemoryregions-method.md)|Enumera a áreas específicas de memória.|  
