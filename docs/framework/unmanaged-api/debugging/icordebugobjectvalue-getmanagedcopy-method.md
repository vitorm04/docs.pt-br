...
## <a name="syntax"></a><span data-ttu-id="f9e5f-105">Sintaxe</span><span class="sxs-lookup"><span data-stu-id="f9e5f-105">Syntax</span></span>  
...
## <a name="requirements"></a><span data-ttu-id="f9e5f-106">Requisitos</span><span class="sxs-lookup"><span data-stu-id="f9e5f-106">Requirements</span></span>  
 <span data-ttu-id="f9e5f-107">**Cabeçalho:** CorDebug.idl, CorDebug.h</span><span class="sxs-lookup"><span data-stu-id="f9e5f-107">**Header:** CorDebug.idl, CorDebug.h</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="f9e5f-108">Consulte também</span><span class="sxs-lookup"><span data-stu-id="f9e5f-108">See Also</span></span>  
