...
|Método|Descrição|  
|------------|-----------------|  
|[Método GetID](../../../../docs/framework/unmanaged-api/debugging/icorpublishappdomain-getid-method.md)|Obtém o identificador exclusivo para este `ICorPublishAppDomain`.|  
