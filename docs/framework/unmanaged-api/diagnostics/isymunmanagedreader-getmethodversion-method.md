...
Obtém a versão do método. A versão do método começa em 1 e é incrementada toda vez que o método é recompilado. A recompilação pode ocorrer sem alterações para o método.  
