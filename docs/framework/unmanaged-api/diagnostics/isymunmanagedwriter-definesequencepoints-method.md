...
## <a name="parameters"></a>Parâmetros  
 ...
 `endLines`  
 [in] The ending line numbers of the sequence points. Esse parâmetro é opcional.  
  
 `endColumns`  
 [in] The ending column numbers of the sequence points. Esse parâmetro é opcional.  
