...
## <a name="remarks"></a>Comentários  
 O método `BeginCustomDump` define a configuração de despejo de pilha personalizado. O método `EndCustomDump` limpa a configuração de despejo de pilha personalizada e libera qualquer estado associado. Ele deve ser chamado após a conclusão do despejo personalizado.  
