...
|Método|Descrição|  
|------------|-----------------|  
|Validar|Valida o arquivo de linguagem intermediária (MSIL) PE ou Microsoft especificado.|  
|FormatEventInfo|Obtém a mensagem de erro correspondente para o erro de validação especificado.|  
