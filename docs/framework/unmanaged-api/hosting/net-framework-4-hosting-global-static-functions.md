...
O [!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)] apresenta um novo método exportado em mscoree. dll: [CLRCreateIntstance](../../../../docs/framework/unmanaged-api/hosting/clrcreateinstance-function.md).  
  
## <a name="in-this-section"></a>Nesta seção  
 [Função CLRCreateInstance](../../../../docs/framework/unmanaged-api/hosting/clrcreateinstance-function.md)  
