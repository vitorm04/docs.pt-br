...
O .NET Framework 4 apresenta um novo método exportado em mscoree. dll: [CLRCreateIntstance](../../../../docs/framework/unmanaged-api/hosting/clrcreateinstance-function.md).  
