...
ms.locfileid: "33441462"
---
# <a name="net-framework-4-hosting-global-static-functions"></a>.NET Framework 4 hospedando funções estáticas globais
O [!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)] apresenta um novo método exportado no MSCOREE: [CLRCreateIntstance](../../../../docs/framework/unmanaged-api/hosting/clrcreateinstance-function.md).  
