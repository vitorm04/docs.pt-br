...
|Método|Descrição|  
|------------|-----------------|  
|[Método RequestVirtualMemLimit](../../../../docs/framework/unmanaged-api/hosting/igchostcontrol-requestvirtualmemlimit-method.md)|Solicitações do host para alterar os limites de memória virtual.|  
