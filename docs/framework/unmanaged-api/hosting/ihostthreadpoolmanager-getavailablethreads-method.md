...
ms.locfileid: "33441209"
---
# <a name="ihostthreadpoolmanagergetavailablethreads-method"></a>Método IHostThreadPoolManager::GetAvailableThreads
Obtém o número de threads no pool de threads que não estão em processamento itens de trabalho.  
...
#### <a name="parameters"></a>Parâmetros  
 ...
 [out] Ponteiro para o número de threads no pool de threads que não estão em processamento itens de trabalho.  
