...
## <a name="remarks"></a>Comentários  
 O CLR chama `SuspensionStarting` para informar o host que a coleta de lixo está ocorrendo.  
  
> [!IMPORTANT]
>  Não reagende essa tarefa. O host deve reagendar uma tarefa quando [ThreadIsBlockingForSuspension](../../../../docs/framework/unmanaged-api/hosting/ihostgcmanager-threadisblockingforsuspension-method.md) é chamado.  
