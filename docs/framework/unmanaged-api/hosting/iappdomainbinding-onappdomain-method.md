...
#### <a name="parameters"></a>Parâmetros  
 `pAppdomain`  
 [in] Um ponteiro para um [IUnknown](https://msdn.microsoft.com/library/94as6ehy(v=vs.110).aspx) objeto de interface que representa o novo domínio de aplicativo.  
