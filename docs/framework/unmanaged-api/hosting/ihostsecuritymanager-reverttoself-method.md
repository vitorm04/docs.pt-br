...
## <a name="remarks"></a>Comentários  
 `RevertToSelf` é chamado para retornar ao token de thread original, após uma chamada anterior para o método [ImpersonateLoggedOnUser](../../../../docs/framework/unmanaged-api/hosting/ihostsecuritymanager-impersonateloggedonuser-method.md) .  
