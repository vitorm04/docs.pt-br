...
## <a name="parameters"></a>Parâmetros  
 ...
 `ppEvent`  
 fora Um ponteiro para o endereço de uma instância de [IHostManualEvent](../../../../docs/framework/unmanaged-api/hosting/ihostmanualevent-interface.md) ou NULL se o objeto de evento não pôde ser criado.  
...
## <a name="remarks"></a>Comentários  
 O CLR chama `CreateRWLockReaderEvent` para obter uma referência a uma instância de `IHostManualEvent` para usar em sua implementação de um bloqueio de leitor. O host pode usar o cookie para determinar quais tarefas estão aguardando no bloqueio do leitor consultando a interface [ICLRSyncManager](../../../../docs/framework/unmanaged-api/hosting/iclrsyncmanager-interface.md) .  
