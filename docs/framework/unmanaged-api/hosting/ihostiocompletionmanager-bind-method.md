...
> [!NOTE]
>  Quando uma solicitação de e/s é concluída, o host deve chamar o [Iclriocompletionmanager](../../../../docs/framework/unmanaged-api/hosting/iclriocompletionmanager-oncomplete-method.md) método.  
