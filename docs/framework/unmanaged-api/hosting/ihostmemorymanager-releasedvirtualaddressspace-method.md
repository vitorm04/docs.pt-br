...
## <a name="remarks"></a>Comentários  
 O método `ReleasedVirtualAddressSpace` é um método de retorno de chamada e deve ser implementado pelo gravador do aplicativo de hospedagem. Ele é chamado pelo CLR.  
