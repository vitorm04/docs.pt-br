...
Obtém o nível de prioridade de thread da tarefa representada pela instância de [IHostTask](ihosttask-interface.md) atual.  
...
## <a name="remarks"></a>Comentários  
 Os valores de nível de prioridade de thread são definidos pela função do Win32 `SetThreadPriority` .  
