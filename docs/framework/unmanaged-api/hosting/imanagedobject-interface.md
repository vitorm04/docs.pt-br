...
|[Método GetSerializedBuffer](../../../../docs/framework/unmanaged-api/hosting/imanagedobject-getserializedbuffer-method.md)|Obtém a representação de cadeia de caracteres do objeto gerenciado.|  
