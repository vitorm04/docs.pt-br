...
## <a name="remarks"></a>Comentários  
 Um host poderá controle exclusivo sobre o número de threads que podem ser alocadas para processar solicitações de e/s, por motivos como implementação, o desempenho ou a escalabilidade. Por esse motivo, o host não é necessário para implementar `SetMinThreads`. Nesse caso, o host deve retornar E_NOTIMPL deste método.  
