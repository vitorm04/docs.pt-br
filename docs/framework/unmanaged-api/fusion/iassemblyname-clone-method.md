...
Cria uma cópia superficial deste [IAssemblyName](../../../../docs/framework/unmanaged-api/fusion/iassemblyname-interface.md) objeto.  
...
#### <a name="parameters"></a>Parâmetros  
 `pName`  
 [out] A cópia retornada deste `IAssemblyName` objeto.  
