...
| `WBEM_E_ILLEGAL_NULL` | 0x80041028 | um `null` foi especificado para uma propriedade que não pode ser `null`, como uma que esteja marcada por um qualificador **indexado** ou **NOT_NULL** . |
...
| `WBEM_E_ALREADY_EXISTS` | 0x80041019 | O sinalizador de `WBEM_FLAG_CREATE_ONLY` foi especificado, mas a instância já existe. |
