...
| [Função CreateInstanceEnumWmi](createinstanceenumwmi.md) | Retorna um enumerador que retorna as instâncias de uma classe especificada que atendem aos critérios de seleção selecionados. |
