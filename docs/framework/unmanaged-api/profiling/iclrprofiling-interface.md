...
|Método|Descrição|  
|------------|-----------------|  
|[Método AttachProfiler](../../../../docs/framework/unmanaged-api/profiling/iclrprofiling-attachprofiler-method.md)|Attaches the specified profiler to the specified process.|  
