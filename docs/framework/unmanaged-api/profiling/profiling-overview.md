...
No .NET Framework 2,0 e posterior, você pode usar o método [ICorProfilerInfo2::D ostacksnapshot](icorprofilerinfo2-dostacksnapshot-method.md) para essa funcionalidade.
