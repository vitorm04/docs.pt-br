...
## <a name="net-framework-version-1-profiling-functions"></a>Funções de criação de perfil do .NET framework versão 1  
 ...
 Notifica o criador de perfil que uma função está prestes a retornar ao chamador. Preterido no .NET Framework 2.0.  
  
 [Função FunctionTailcall](../../../../docs/framework/unmanaged-api/profiling/functiontailcall-function.md)  
 Notifica o criador de perfil que a função atualmente em execução está prestes a realizar uma chamada tail para outra função. Preterido no .NET Framework 2.0.  
...
## <a name="net-framework-version-4-profiling-functions"></a>Funções de criação de perfil do .NET framework versão 4  
 ...
 `FunctionIDMapper2` estende o [FunctionIDMapper](../../../../docs/framework/unmanaged-api/profiling/functionidmapper-function.md) funcionar com um `clientData` parâmetro, que os criadores de perfis podem usar para resolver a ambiguidade os tempos de execução.  
