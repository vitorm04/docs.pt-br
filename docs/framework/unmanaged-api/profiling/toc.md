...
## [Visão geral de criação de perfil](profiling-overview.md)
...
#### [Próximo método](icorprofilerfunctionenum-next-method.md)
...
#### [Próximo método](icorprofilermoduleenum-next-method.md)
...
#### [Próximo método](icorprofilerobjectenum-next-method.md)
...
#### [Próximo método](icorprofilerthreadenum-next-method.md)
...
## [Funções estáticas globais de criação de perfil](profiling-global-static-functions.md)
...
## [Enumerações de criação de perfil](profiling-enumerations.md)
