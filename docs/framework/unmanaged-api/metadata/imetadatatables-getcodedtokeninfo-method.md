...
## <a name="parameters"></a>parâmetros  
 `ixCdTkn`  
 [em] O tipo de token codificado para retornar.  
  
 `pcTokens`  
 [fora] Um ponteiro para `ppTokens`o comprimento de .  
  
 `ppTokens`  
 [fora] Um ponteiro para um ponteiro para uma matriz que contém a lista de tokens retornados.  
  
 `ppName`  
 [fora] Um ponteiro para um ponteiro para o `ixCdTkn`nome do token em .  
