...
|`tdSerializable`|<span data-ttu-id="30bea-129">Especifica que o tipo é serializável.</span><span class="sxs-lookup"><span data-stu-id="30bea-129">Specifies that the type is serializable.</span></span>|  
