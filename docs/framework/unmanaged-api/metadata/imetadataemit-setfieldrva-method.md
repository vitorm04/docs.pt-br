...
Define um valor variável global para o endereço virtual relativo do campo referenciado pelo token especificado.  
...
## <a name="parameters"></a>parâmetros  
 ...
 `ulRVA`  
 [em] O endereço de um código ou área de dados.  
