...
Define os recursos da assinatura de PInvoke do método referenciada pelo token especificado.  
...
#### <a name="parameters"></a>Parâmetros  
 ...
 `dwMappingFlags`  
 [in] Sinalizadores usados pelo PInvoke para fazer o mapeamento.  
