...
> [!IMPORTANT]
> Você pode instalar somente assemblies de nome forte no cache de assembly global. Para obter informações de como criar um assembly de nome forte, confira [Como: assinar um assembly com um nome forte](../../standard/assembly/sign-strong-name.md).
