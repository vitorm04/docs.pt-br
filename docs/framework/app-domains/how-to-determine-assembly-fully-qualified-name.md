---
title: Como determinar o nome totalmente qualificado de um assembly | Microsoft Docs
ms.custom: 
ms.date: 03/30/2017
...
-   Se o assembly já estiver carregado pelo aplicativo, você poderá recuperar o valor da propriedade <xref:System.Reflection.Assembly.FullName%2A?displayProperty=fullName> para obter o nome totalmente qualificado. Você pode usar essa abordagem se o assembly estiver ou não no GAC. O exemplo fornece uma ilustração.  
  
-   Se você souber o caminho do sistema de arquivos do assembly, poderá chamar o método (`Shared` no Visual Basic) <xref:System.Reflection.AssemblyName.GetAssemblyName%2A?displayProperty=fullName> estático para obter o nome totalmente qualificado do assembly. Este é um exemplo simples.  
