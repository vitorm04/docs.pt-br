...
2. Pressione botão **Voltar** do navegador. Você deve ser apresentado com uma **erro de servidor no aplicativo '/'** página com a seguinte descrição: *ID1062: Reprodução foi detectada para: Token: 'Samlsecuritytoken'*, seguido por um *AssertionId* e uma *emissor*.  
