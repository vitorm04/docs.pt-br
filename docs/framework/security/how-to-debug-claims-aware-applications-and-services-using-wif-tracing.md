...
1. A ferramenta Visualizador de Rastreamento (SvcTraceViewer.exe) é fornecida como parte do SDK do Windows. Se você ainda não instalou o SDK do Windows, você pode baixá-lo aqui: [SDK do Windows](https://www.microsoft.com/download/en/details.aspx?id=8279).  
...
5. Clique na guia **Atividade**. Você deverá ver entradas de rastreamento detalhadas na área principal da ferramenta. Use a lista suspensa **nível** no menu para filtrar o nível específico de rastreamentos, por exemplo: **Todos**, **aviso**, **erros**, **informações**etc.  
