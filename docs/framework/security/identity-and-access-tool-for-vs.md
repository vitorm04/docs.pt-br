...
Este tópico descreve a nova Ferramenta de Identidade e Acesso para o Visual Studio 11. Você pode baixar essa ferramenta da seguinte URL: <https://go.microsoft.com/fwlink/?LinkID=245849> ou diretamente no Visual Studio 11 pesquisando por "identidade" diretamente no Gerenciador de extensões.  
...
- A ferramenta aproveita os recursos do serviço de controle de acesso (ACS) do Windows Azure com uma lista simples de caixas de seleção para todos os provedores de identidade que você deseja usar: Facebook, Google, Live ID, Yahoo!, qualquer provedor de OpenID e qualquer provedor de WS-Federation. Selecione seus provedores de identidade, clique em OK e pressione F5. Seu aplicativo e o ACS serão configurados automaticamente e seu aplicativo de teste será baseado no ACS.  
