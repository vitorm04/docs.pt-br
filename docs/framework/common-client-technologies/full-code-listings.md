...
ms.locfileid: "32742017"
---
# <a name="full-code-listings"></a>Listagens de códigos completas
Este tópico contém a listagem de código completa para um aplicativo que usa os processadores de [Manipulações e inércia](../../../docs/framework/common-client-technologies/manipulations-and-inertia.md).  
  
## <a name="gamepiece-class"></a>Classe GamePiece  
 O código a seguir mostra toda a classe **GamePiece**.  
...
## <a name="gamepiececollection-class"></a>Classe GamePieceCollection  
 O código a seguir mostra toda a classe **GamePieceCollection**.  
...
## <a name="game1-class"></a>Classe Game1  
 O código a seguir mostra toda a classe **Game1**.  
