...
- [Páginas da Web do ASP.NET](https://go.microsoft.com/fwlink/p/?LinkId=251040)
- [ASP.NET Web API](https://go.microsoft.com/fwlink/p/?LinkId=251041)  
- [Criar um aplicativo Web ASP.NET Framework no Azure](/azure/app-service/app-service-web-get-started-dotnet-framework)
...
Confira [Por que usar o ASP.NET Core?](/aspnet/core#why-use-aspnet-core) para obter uma lista expandida de benefícios.

Para saber mais sobre o ASP.NET Core](/aspnet/core), confira:

- [Introdução a Páginas do Razor](/aspnet/core/tutorials/razor-pages/razor-pages-start)
