...
.NET Framework requer privilégios de administrador para instalação. Se você não tiver direitos de administrador para o computador em que deseja instalar .NET Framework, entre em contato com o administrador da rede.
...
- Em sistemas Windows 7, .NET Framework requer o Windows 7 SP1. Se você usa o Windows 7 e ainda não instalou o Service Pack 1, faça isso antes de instalar o .NET Framework.
...
- Em sistemas operacionais de 64 bits, .NET Framework dá suporte a WOW64 (processamento de 32 bits em um computador de 64 bits) e processamento nativo de 64 bits.
...
- No Windows Server 2008 SP2, não há suporte para .NET Framework na função Server Core.
