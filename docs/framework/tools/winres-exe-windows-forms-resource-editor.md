...
> [!IMPORTANT]
> Você deve carregar e usar arquivos. resx apenas de fontes confiáveis. Arquivos ResX podem conter código executável e devem ser tratados como arquivos executáveis (.exe) do ponto de vista da segurança.
