...
|**Delete (excluir)**|**Editar**||Exclui um elemento selecionado no momento em uma lista, como uma licença de confiança na guia **Manifesto de Implantação**.|  
...
|Elemento da interface do usuário|Description|  
|----------------|-----------------|  
...
|**UICulture**|Opcional. O código ISO de país e região composto por duas partes em que o aplicativo é executado. O padrão é `neutral`.|  
...
|**UICulture**|Opcional. O código ISO de país/região composto por duas partes em que o aplicativo é executado. O padrão é `neutral`.|  
