...
|**-e**[**xecution**] {**on** &#124; **off**}|Ativa ou desativa o mecanismo que verifica a permissão para execução antes do código iniciar a execução. **Observação:**  Essa opção é removida no [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)] e em versões posteriores. Para saber mais, confira [Alterações de segurança](../../../docs/framework/security/security-changes.md).|  
