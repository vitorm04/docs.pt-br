...
- [CorFlags.exe (Ferramenta de Conversão de CorFlags)](corflags-exe-corflags-conversion-tool.md)  
Permite configurar a seção CorFlags do cabeçalho de uma imagem PE.

- [Fuslogvw.exe (Visualizador do Log de Associações de Assembly)](fuslogvw-exe-assembly-binding-log-viewer.md)  
