...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Cert2spc.exe (Ferramenta de Teste de Certificado do Fornecedor do Software)](../../../docs/framework/tools/cert2spc-exe-software-publisher-certificate-test-tool.md)  
 ...
 [CorFlags.exe (Ferramenta de Conversão de CorFlags)](../../../docs/framework/tools/corflags-exe-corflags-conversion-tool.md)  
 Permite configurar a seção CorFlags do cabeçalho de uma imagem PE.  
  
 [Fuslogvw.exe (Visualizador do Log de Associações de Assembly)](../../../docs/framework/tools/fuslogvw-exe-assembly-binding-log-viewer.md)  
