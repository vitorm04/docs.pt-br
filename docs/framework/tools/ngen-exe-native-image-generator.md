---
title: Ngen.exe (Gerador de Imagens Nativas) | Microsoft Docs
ms.custom: 
ms.date: 03/30/2017
...
-   Algumas causas da invalidação de imagem são eliminadas.  
 ...
 No Windows 8, confira [Tarefa de Imagem Nativa](http://msdn.microsoft.com/en-us/9b1f7590-4e0d-4737-90ef-eaf696932afb).  
  
 Para saber mais sobre como usar o Ngen.exe e o serviço de imagem nativa, confira [Serviço de imagem nativa](http://msdn.microsoft.com/en-us/b15e0e32-59cb-4ae4-967c-6c9527781309).  
  
> [!NOTE]
>  A sintaxe de Ngen.exe para as versões 1.0 e 1.1 do .NET Framework pode ser encontrada em [Sintaxe herdada do Gerador de Imagens Nativas (Ngen.exe)](http://msdn.microsoft.com/en-us/5a69fc7a-103f-4afc-8ab4-606adcb46324).  
...
|`executeQueuedItems` [`1``&#124;``2``&#124;``3`]<br /><br /> -ou-<br /><br /> `eqi` [1&#124;2&#124;3]|Execute o trabalho de compilação enfileirado.<br /><br /> Se uma prioridade for especificada, trabalhos de compilação com prioridade maior ou igual serão executados. Se nenhuma prioridade for especificada, todos os trabalhos de compilação enfileirados serão executados.|  
...
|`3`|As imagens nativas são instaladas quando o serviço de imagem nativa detecta que o computador está ocioso. Confira [Serviço de imagens nativas](http://msdn.microsoft.com/en-us/b15e0e32-59cb-4ae4-967c-6c9527781309).|  
...
>  Não execute Ngen.exe em assemblies que não sejam totalmente confiáveis. Desde o [!INCLUDE[net_v40_long](../../../includes/net-v40-long-md.md)], Ngen.exe compila assemblies com confiança total, e a política de segurança de acesso de código (CAS) deixa de ser avaliada.  
 ...
 Desde o [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)], as imagens nativas geradas com Ngen.exe não podem mais ser carregadas em aplicativos em execução com confiança parcial. Em vez disso, o compilador JIT é invocado.  
...
> [!IMPORTANT]
>  Não use o método <xref:System.Reflection.Assembly.LoadFrom%2A?displayProperty=fullName> com imagens nativas. Uma imagem carregada com esse método não pode ser usada por outros assemblies no contexto da execução.  
 ...
 Se você estiver gerando uma imagem nativa para um assembly no cache de assembly global, especifique seu nome para exibição. Consulte <xref:System.Reflection.Assembly.FullName%2A?displayProperty=fullName>.  
...
-   Defina a propriedade <xref:System.AppDomainSetup.LoaderOptimization%2A?displayProperty=fullName> quando você cria informações de configuração para um novo domínio de aplicativo.  
...
### <a name="opting-out-of-native-image-generation"></a>Recusa da geração automática de imagem nativa  
 ...
 No entanto, observe que `BypassNGenAttribute` não está definido como um tipo na biblioteca de classes do .NET Framework. Para consumir o atributo em seu código, primeiro definia-o da seguinte maneira:  
...
```  
 ...
 Para obter exemplos relacionados ao serviço de imagem nativa, confira [Serviço de imagem nativa](http://msdn.microsoft.com/en-us/b15e0e32-59cb-4ae4-967c-6c9527781309).  
...
|NET Framework NGEN v4.0.30319 64|Não|Sim|  
 ...
 A tarefa de imagem nativa está disponível no .NET Framework 4.5 e em versões posteriores ao ser executado no Windows 8 ou versão mais recente. Em versões anteriores do Windows, o .NET Framework usava o [Serviço de imagem nativa](http://msdn.microsoft.com/en-us/b15e0e32-59cb-4ae4-967c-6c9527781309).  
...
## <a name="see-also"></a>Consulte também  
 [Serviço de imagens nativas](http://msdn.microsoft.com/en-us/b15e0e32-59cb-4ae4-967c-6c9527781309)   
 [Tarefa de imagem nativa](http://msdn.microsoft.com/en-us/9b1f7590-4e0d-4737-90ef-eaf696932afb)   
