---
title: "SOS.dll (Extensão de Depuração SOS) | Microsoft Docs"
ms.custom: 
ms.date: 03/30/2017
...
|**EEHeap** [**-gc**] [**-loader**]|Exibe informações sobre a memória do processo consumida por estruturas de dados internas do Common Language Runtime.<br /><br /> As opções **-gc** e **-loader** limitam a saída desse comando ao coletor de lixo ou a estruturas de dados do carregador.<br /><br /> As informações do coletor de lixo lista os intervalos de cada segmento no heap gerenciado.  Se o ponteiro estiver dentro de um intervalo de segmentos indicado por **-gc**, o ponteiro será um ponteiro de objeto.|  
...
|**EEVersion**|Exibe a versão do Common Language Runtime.|  
