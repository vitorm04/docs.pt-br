...
- [Documentação do Windows Presentation Foundation (WPF) para .NET Core](/dotnet/desktop/wpf/) – Adicionar página de aterrissagem para o WPF de área de trabalho
...
- [Aprimoramentos de acessibilidade em controles de Windows Forms para .NET Core 3,0](/dotnet/desktop/winforms/windows-forms-accessibility-improvements) -adicionando o documento de acessibilidade para WinForms principais
