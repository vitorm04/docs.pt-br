...
### [Como: usar e depurar a Capacidade de descarregamento de assembly no .NET Core](standard/assembly/unloadability-howto.md)
...
### [Portabilizar projetos do Windows Forms](core/porting/winforms.md)
...
### [Estender as funcionalidades de dados usando a correspondência de padrões](csharp/tutorials/pattern-matching.md)
...
### [Recomendação de filme (recomendação)](machine-learning/tutorials/movie-recommmendation.md)
