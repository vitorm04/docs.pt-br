...
## [Ferramentas do .NET Core RC4](core/preview3/tools/index.md)
### [Visão geral das alterações na CLI](core/preview3/tools/layering.md)
### [Gerenciamento de dependência](core/preview3/tools/dependencies.md)
### [Implantando aplicativos](core/preview3/deploying/index.md)
### [Adições ao formato csproj](core/preview3/tools/csproj.md)
### [Telemetria](core/preview3/tools/telemetry.md)
### [Modelo de Extensibilidade](core/preview3/tools/extensibility.md)
### [Integração Contínua](core/preview3/tools/using-ci-with-cli.md)
