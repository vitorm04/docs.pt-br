...
#### [O tipo subjacente <typename> de Enum não está em conformidade com CLS](visual-basic/language-reference/error-messages/underlying-type-typename-of-enum-is-not-cls-compliant.md)
