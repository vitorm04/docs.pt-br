...
### [Diretrizes de uso de Memória\<T> e Extensão\<T>](standard/memory-and-spans/memory-t-usage-guidelines.md)
...
## Visão geral
### [O que é ML.NET?](machine-learning/what-is-mldotnet.md)
### [Conceitos de treinamento de modelo](machine-learning/basic-concepts-model-training-in-mldotnet.md)
...
### [Pétalas de íris (clustering)](machine-learning/tutorials/iris-clustering.md)
...
### [Uma previsão por vez com PredictionFunction](machine-learning/how-to-guides/single-predict-model-ml-net.md)
...
### [Usar modelos aditivos generalizados para explicação do modelo](machine-learning/how-to-guides/use-gams-for-model-explainability.md)
### [Usar métricas para avaliar a qualidade do modelo](machine-learning/how-to-guides/verify-model-quality-ml-net.md)
## Referência
