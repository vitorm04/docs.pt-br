...
### [Aprenda noções básicas do Docker com o .NET Core](core/docker/docker-basics-dotnet-core.md)
...
### [Teste de unidade do F# com dotnet test e xUnit](core/testing/unit-testing-fsharp-with-dotnet-test.md)
### [Teste de unidade do F# com dotnet test e MSTest](core/testing/unit-testing-fsharp-with-mstest.md)
...
### [Introdução ao Visual Studio](fsharp/get-started/get-started-visual-studio.md)
...
### [Especificação da Linguagem](visual-basic/reference/language-specification/)
