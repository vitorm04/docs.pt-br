...
Este artigo aborda como você pode começar a usar a F # no núcleo do .NET. Ele percorrerá criando uma solução multiprojeto com uma biblioteca de classe que é chamado por um aplicativo de Console.
