...
description: Guia para usar os serviços do Azure comF#
author: sylvanc
ms.date: 09/22/2016
...
## <a name="using-azure-functions-with-f"></a>Usando Azure Functions com F\#
...
## <a name="using-azure-storage-with-f"></a>Usando o armazenamento do Azure com o F\#

O Armazenamento do Azure é uma camada base de serviços de armazenamento para aplicativos modernos que dependem de durabilidade, disponibilidade e escalabilidade para atender às necessidades dos clientes. F#os programas podem interagir diretamente com os serviços de armazenamento do Azure, usando as técnicas descritas nos artigos a seguir.
...
## <a name="using-azure-app-service-with-f"></a>Usando o serviço de Azure App com o F\#
...
1. Por meio da criação F# de Azure Functions que reagem ou causam alterações em coleções de Azure Cosmos DB. Confira [Azure Cosmos DB associações para Azure Functions](/azure/azure-functions/functions-bindings-cosmosdb)ou
...
## <a name="using-webjobs-with-f"></a>Usando trabalhos Web com F\#
