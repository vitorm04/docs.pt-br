...
|atraso|-|-|(1)|-|-|Retorna uma sequência que é criada da especificação de atrasada determinada de uma sequência.|
|diferença|-|-|-|-|O (M &#42; log N)|Retorna um novo conjunto com os elementos do segundo conjunto removidos do primeiro conjunto.|
|DISTINCT|||(1) &#42;|||Retorna uma sequência que não contém nenhum entradas duplicadas de acordo com genéricas comparações de igualdade e de hash nas entradas. Se um elemento ocorrer várias vezes na sequência, ocorrências posteriores serão descartadas.|
|distinctBy|||(1) &#42;|||Retorna uma sequência que não contém nenhum entradas duplicadas de acordo com as comparações de igualdade e hash genéricas nas chaves que retorna a função de geração de chave fornecida. Se um elemento ocorrer várias vezes na sequência, ocorrências posteriores serão descartadas.|
|empty|(1)|(1)|(1)|(1)|(1)|Cria uma coleção vazia.|
...
|obter / enésimo|(1)|(N)|(N)|-|-|Retorna um elemento de uma coleção fornecida seu índice.|
|Cabeçalho|-|(1)|(1)|-|-|Retorna o primeiro elemento da coleção.|
|Init|(N)|(N)|(1)|-|-|Cria uma coleção fornecida a dimensão e uma função de gerador para computar os elementos.|
|initInfinite|-|-|(1)|-|-|Gera uma sequência que, quando iteradas, retorna elementos sucessivos chamando a função determinada.|
|Se cruzam|-|-|-|-|O (log N &#42; log M)|Calcula a interseção de dois conjuntos.|
|intersectMany|-|-|-|-|O (N1 &#42; N2...)|Calcula a interseção de uma sequência de conjuntos. A sequência não deve ficar vazia.|
|IsEmpty|(1)|(1)|(1)|(1)|-|Retorna `true` se a coleção está vazia.|
...
|length|(1)|(N)|(N)|-|-|Retorna o número de elementos na coleção.|
|map|(N)|(N)|(1)|-|-|Cria uma coleção cujos elementos são os resultados da aplicação da função fornecida para cada elemento da matriz.|
|map2|(N)|(N)|(1)|-|-|Cria uma coleção cujos elementos são os resultados da aplicação da função de determinada para os elementos correspondentes das duas coleções de cache. As duas matrizes de entrada devem ter o mesmo comprimento.|
...
|ofArray|-|(N)|(1)|(N)|(N)|Cria uma coleção que contém os mesmos elementos que a matriz fornecida.|
|ofList|(N)|-|(1)|(N)|(N)|Cria uma coleção que contém os mesmos elementos que a lista fornecida.|
...
|Singleton|-|-|(1)|-|(1)|Retorna uma sequência que gera apenas um item.|
|set|(1)|-|-|-|-|Define um elemento de uma matriz para o valor especificado.|
...
|Final|-|(1)|-|-|-|Retorna a lista sem o primeiro elemento.|
|Take|-|-|(N)|-|-|Retorna os elementos da sequência de até uma contagem especificada.|
|takeWhile|-|-|(1)|-|-|Retorna uma sequência que, quando iteradas, produz elementos da sequência de subjacente enquanto o determinado retorna predicado `true` e, em seguida, retorna não mais elementos.|
|ToArray|-|(N)|(N)|(N)|(N)|Cria uma matriz de determinada coleção.|
|ToList|(N)|-|(N)|(N)|(N)|Cria uma lista de determinada coleção.|
|toSeq|(1)|(1)|-|(1)|(1)|Cria uma sequência de determinada coleção.|
|Truncar|-|-|(1)|-|-|Retorna uma sequência que, quando enumerada, retorna não mais de N elementos.|
