...
ms.locfileid: "87795470"
---
# <a name="f-language-reference"></a>Referência da linguagem F#

Esta seção é uma referência à linguagem F #, uma linguagem de programação de vários paradigmas direcionada ao .NET. A linguagem F# oferece suporte a modelos de programação imprescindíveis, funcionais e orientados a objeto.
