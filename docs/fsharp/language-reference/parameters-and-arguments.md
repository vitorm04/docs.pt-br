...
Você também pode especificar um novo objeto como um valor de parâmetro padrão. Por exemplo, o `Foo` membro pode ter um opcional `CancellationToken` como entrada em vez disso:
