...
Você pode desenvolver aplicativos do Docker usando ferramentas da Microsoft com linguagens mais modernas. A seguir está uma lista inicial, mas não se limitam a ele:
