...
Conforme mostrado na Figura 5-13, a primeira fase é o pipeline de build/CI. Nos serviços de DevOps do Azure, você pode criar pipelines de build/CI que compilar o código, criar as imagens do Docker e enviar por push para um registro de Docker, como o Hub do Docker ou registro de contêiner do Azure.
