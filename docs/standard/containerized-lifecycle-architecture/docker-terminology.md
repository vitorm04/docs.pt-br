...
**Imagem de vários arcos**: Para várias arquiteturas, é um recurso que simplifica a seleção da imagem apropriada, de acordo com a plataforma em que o Docker está sendo executado; por exemplo, quando um Dockerfile solicita uma imagem base **`FROM mcr.microsoft.com/dotnet/core/sdk:2.2`** do registro, na verdade, ele obtém **`2.2-nanoserver-1709`** , **`2.2-nanoserver-1803`** , **`2.2-nanoserver-1809`** ou **`2.2-stretch`** , dependendo do sistema operacional e da versão em que o Docker está sendo executado.
