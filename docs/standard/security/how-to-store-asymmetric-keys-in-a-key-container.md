...
1. Crie uma nova instância de uma classe de <xref:System.Security.Cryptography.CspParameters> e passe o nome que você deseja chamar o contêiner de chave para o campo <xref:System.Security.Cryptography.CspParameters.KeyContainerName?displayProperty=nameWithType>.  
...
2. Crie uma nova instância de uma classe derivada da classe **AsymmetricAlgorithm** (geralmente **RSACryptoServiceProvider** ou **DSACryptoServiceProvider**) e passe o objeto **CspParameters** criado anteriormente para seu construtor.  
