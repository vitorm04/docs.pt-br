...
```  
 ...
 Para obter mais informações sobre como usar expressões lambda, consulte [expressões Lambda em PLINQ e TPL](../../../docs/standard/parallel-programming/lambda-expressions-in-plinq-and-tpl.md).  
