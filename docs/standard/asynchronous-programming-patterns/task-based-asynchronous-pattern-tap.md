...
O .NET fornece a <xref:System.Progress%601> classe, que implementa <xref:System.IProgress%601> . A classe <xref:System.Progress%601> é declarada da seguinte forma:  
