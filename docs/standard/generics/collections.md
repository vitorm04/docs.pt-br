...
> [!NOTE]
> No C# e Visual Basic não é necessário usar <xref:System.Nullable%601> explicitamente, pois a linguagem tem sintaxe para tipos que permitem valor nulo. Consulte [tipos de valores anuláveis (guia deC# programação)](../../csharp/programming-guide/nullable-types/index.md) e [tipos de valores anuláveis (Visual Basic)](../../visual-basic/programming-guide/language-features/data-types/nullable-value-types.md).
