...
> [!NOTE]
> As primeiras cinco etapas nessa lista são opcionais. O runtime do .NET Framework automaticamente gerarão o serviço Web da primeira vez que o serviço for solicitado.  
  
> [!NOTE]
> As seguintes etapas são necessárias para criar o exemplo.  
  
1. Abra o explorador de arquivos e navegue até o subdiretório \CS.  
...
2. Digite `http://localhost/[virtual directory]/Service.asmx`, onde `[virtual directory]` representa o diretório virtual que você criou quando criou o exemplo.  
