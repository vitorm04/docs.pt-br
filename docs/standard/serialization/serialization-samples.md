...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Ordem de serialização personalizada com o XmlSerializer](../../../docs/standard/serialization/custom-serialization-order-with-xmlserializer.md)  
 Mostra como controlar a ordem de elementos serializados e desserializados para serialização de XML.  
