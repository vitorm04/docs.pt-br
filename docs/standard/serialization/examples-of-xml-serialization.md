...
Você também pode serializar instâncias de um <xref:System.Xml.XmlElement> ou <xref:System.Xml.XmlNode> de classe, conforme mostrado no exemplo de código a seguir.
