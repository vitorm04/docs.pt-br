# [Microsserviços do .NET: Arquitetura para aplicativos .NET em contêineres](index.md)
...
### [Arquitetura orientada a serviços](architect-microservice-container-applications/service-oriented-architecture.md)
