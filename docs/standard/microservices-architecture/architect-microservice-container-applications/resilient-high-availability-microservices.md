...
-   **Conectar computadores Windows ao serviço Log Analytics no Azure**
    [*https://docs.microsoft.com/azure/log-analytics/log-analytics-windows-agents*](https://docs.microsoft.com/azure/log-analytics/log-analytics-windows-agents)

-   **Registrando em log o que você quer dizer: usando o bloco de aplicativo de registro em log semântico**
    [*https://msdn.microsoft.com/library/dn440729(v=pandp.60).aspx*](https://msdn.microsoft.com/library/dn440729(v=pandp.60).aspx)

-   **Splunk.** Site oficial.
    [*http://www.splunk.com*](http://www.splunk.com)

-   **Classe EventSource**. API para rastreamento de eventos para Windows (ETW) [ *https://docs.microsoft.com/dotnet/api/system.diagnostics.tracing.eventsource*](https://docs.microsoft.com/dotnet/api/system.diagnostics.tracing.eventsource)
