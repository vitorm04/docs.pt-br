...
[Anterior] (../multi-container-microservice-net-applications/background-tasks-with-ihostedservice.md) [Próximo] (apply-simplified-microservice-cqrs-ddd-patterns.md)
