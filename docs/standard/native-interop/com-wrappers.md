...
O COM difere do modelo de objeto de tempo de execução do .NET de várias maneiras importantes:  
...
- [Como: Personalizar RCWs (Runtime Callable Wrappers) no .NET Framework](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/56kh4hy7(v=vs.100))
