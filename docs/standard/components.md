...
keywords: .NET, .NET Standard, .NET Core, .NET Framework, Mono, Xamarin, MSBuild, C#, F#, VB e compiladores
author: cartermp
ms.author: mairaw
ms.date: 08/10/2017
ms.topic: article
