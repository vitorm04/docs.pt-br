...
|[Exemplos de expressão regular](regular-expression-examples.md)|Oferece exemplos de código que ilustram usos típicos de expressões regulares.|  
