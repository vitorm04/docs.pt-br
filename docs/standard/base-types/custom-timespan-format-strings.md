...
|'*string*'|Delimitador de cadeia de caracteres literal.<br /><br /> Mais informações: [outros caracteres](#other-characters).|`new TimeSpan(14, 32, 17):`<br /><br /> `hh':'mm':'ss` --> "14:32:17"|
