...
|"dd"-"dddddddd"|O número de dias inteiros no intervalo de tempo, preenchido com zeros à esquerda, conforme necessário.<br /><br /> Para saber mais: [Os especificadores de formato personalizados "dd"–"dddddddd"](#ddSpecifier).|`new TimeSpan(6, 14, 32, 17, 685):`<br /><br /> `ddd` --> "006"<br /><br /> `dd\.hh\:mm` --> "06.14:32"|
