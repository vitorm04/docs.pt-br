...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Fornece um exemplo que você pode usar para verificar se uma cadeia de caracteres está no formato de email válido.  
  
## <a name="reference"></a>Referência  
 <xref:System.Text.RegularExpressions>  
 Fornece informações de referência de biblioteca de classes para o namespace **System.Text.RegularExpressions** do .NET.  
