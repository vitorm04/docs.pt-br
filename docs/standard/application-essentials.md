...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Acessibilidade](../../docs/framework/ui-automation/index.md) Fornece informações sobre a Microsoft UI Automation, que é uma estrutura de acessibilidade que atende às necessidades de produtos de tecnologia assistiva e estruturas de teste automatizadas, fornecendo acesso programático às informações sobre a interface do usuário (UI).  
