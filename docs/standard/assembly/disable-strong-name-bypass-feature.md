...
---
# <a name="how-to-disable-the-strong-name-bypass-feature"></a>Como: Desativar o recurso de bypass de nome forte
...
## <a name="disable-the-strong-name-bypass-feature-for-all-applications"></a>Desativar o recurso de bypass de nome forte para todos os aplicativos  
...
## <a name="disable-the-strong-name-bypass-feature-for-a-single-application"></a>Desativar o recurso de bypass de nome forte para um único aplicativo  
  
1. Abra ou crie o arquivo de configuração de aplicativo.  
  
    Para obter mais informações sobre este arquivo, consulte a seção Arquivos de configuração de aplicativos em [Configure aplicativos](../../framework/configure-apps/index.md).  
...
2. Adicione a seguinte entrada:  
 ...
 Você pode restaurar o recurso de desvio para o aplicativo removendo `true`a configuração do arquivo de configuração ou definindo o atributo para .  
...
- [\<ignorarTrustedAppStrongNames> elemento](../../framework/configure-apps/file-schema/runtime/bypasstrustedappstrongnames-element.md)
