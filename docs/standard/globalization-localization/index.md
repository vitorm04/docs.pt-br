...
-   Isso resulta em aplicativos localizados que são mais estáveis e possuem menos bugs.  
 ...
 Para saber mais, confira [Centro de Desenvolvedores da Go Global](http://go.microsoft.com/fwlink/?LinkId=235015).  
...
## <a name="reference"></a>Referência  
 Namespace <xref:System.Globalization?displayProperty=fullName>  
