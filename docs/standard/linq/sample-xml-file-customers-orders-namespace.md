---
title: 'Arquivo XML de exemplo: clientes e pedidos em um namespace-LINQ to XML'
description: Esse arquivo XML — que é usado em exemplos — tem dados, em um namespace, sobre clientes e pedidos.
ms.date: 07/20/2015
ms.assetid: 2da1c474-f658-4dca-a457-c35ef5ba4aff
ms.openlocfilehash: 31cec4bb28dd7f2bdac3c05ede6eeb5d8601aa89
ms.sourcegitcommit: 0c3ce6d2e7586d925a30f231f32046b7b3934acb
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/08/2020
ms.locfileid: "89552050"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace-linq-to-xml"></a><span data-ttu-id="02cc0-103">Arquivo XML de exemplo: Customers e Orders em um namespace (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="02cc0-103">Sample XML file: Customers and orders in a namespace (LINQ to XML)</span></span>

<span data-ttu-id="02cc0-104">O arquivo XML a seguir é usado em vários exemplos na documentação do LINQ to XML.</span><span class="sxs-lookup"><span data-stu-id="02cc0-104">The following XML file is used in various examples in the LINQ to XML documentation.</span></span> <span data-ttu-id="02cc0-105">Este arquivo contém clientes e pedidos.</span><span class="sxs-lookup"><span data-stu-id="02cc0-105">This file contains customers and orders.</span></span> <span data-ttu-id="02cc0-106">XML é em um namespace.</span><span class="sxs-lookup"><span data-stu-id="02cc0-106">The XML is in a namespace.</span></span>

## <a name="customersordersinnamespacexml"></a><span data-ttu-id="02cc0-107">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="02cc0-107">CustomersOrdersInNamespace.xml</span></span>
