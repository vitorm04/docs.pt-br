---
title: Como projetar um grafo de objeto-LINQ to XML
description: Você pode usar C# ou Visual Basic para projetar ou preencher um grafo de objeto do XML. O exemplo neste artigo mostra como.
ms.date: 07/20/2015
dev_langs:
- csharp
- vb
...
ms.locfileid: "89552080"
---
# <a name="how-to-project-an-object-graph-linq-to-xml"></a><span data-ttu-id="39b5b-104">Como projetar um grafo de objeto (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="39b5b-104">How to project an object graph (LINQ to XML)</span></span>

<span data-ttu-id="39b5b-105">Você pode usar C# ou Visual Basic para projetar ou preencher um grafo de objeto do XML.</span><span class="sxs-lookup"><span data-stu-id="39b5b-105">You can use C# or Visual Basic to project or populate an object graph from XML.</span></span>

## <a name="example-populate-an-object-graph-from-xml"></a><span data-ttu-id="39b5b-106">Exemplo: popular um grafo de objeto do XML</span><span class="sxs-lookup"><span data-stu-id="39b5b-106">Example: Populate an object graph from XML</span></span>

<span data-ttu-id="39b5b-107">Este exemplo popula um gráfico de objeto com as `Address` `PurchaseOrder` classes, e `PurchaseOrderItem` do arquivo XML de exemplo de documento XML [: ordem de compra típica](sample-xml-file-typical-purchase-order.md).</span><span class="sxs-lookup"><span data-stu-id="39b5b-107">This example populates an object graph with the `Address`, `PurchaseOrder`, and `PurchaseOrderItem` classes from XML document [Sample XML file: Typical purchase order](sample-xml-file-typical-purchase-order.md).</span></span>
...
<span data-ttu-id="39b5b-108">O resultado da consulta LINQ é retornado como um <xref:System.Collections.Generic.IEnumerable%601> de `PurchaseOrderItem` .</span><span class="sxs-lookup"><span data-stu-id="39b5b-108">The result of the LINQ query is returned as an <xref:System.Collections.Generic.IEnumerable%601> of `PurchaseOrderItem`.</span></span> <span data-ttu-id="39b5b-109">Os itens na classe de `PurchaseOrder` são do tipo <xref:System.Collections.Generic.IEnumerable%601> de `PurchaseOrderItem`.</span><span class="sxs-lookup"><span data-stu-id="39b5b-109">The items in the `PurchaseOrder` class are of type <xref:System.Collections.Generic.IEnumerable%601> of `PurchaseOrderItem`.</span></span> <span data-ttu-id="39b5b-110">O código usa o método de extensão de <xref:System.Linq.Enumerable.ToList%2A> para criar uma coleção de <xref:System.Collections.Generic.List%601> dos resultados da consulta.</span><span class="sxs-lookup"><span data-stu-id="39b5b-110">The code uses the <xref:System.Linq.Enumerable.ToList%2A> extension method to create a <xref:System.Collections.Generic.List%601> collection from the results of the query.</span></span>

<span data-ttu-id="39b5b-111">Esse exemplo gera a saída a seguir:</span><span class="sxs-lookup"><span data-stu-id="39b5b-111">This example produces the following output:</span></span>
...
## <a name="see-also"></a><span data-ttu-id="39b5b-112">Confira também</span><span class="sxs-lookup"><span data-stu-id="39b5b-112">See also</span></span>
