...
| Aplicativos implantados em VMs no Azure | Aplicativos de monolítico ou de N camadas implantados para o serviço de aplicativo do Azure, instância de contêiner do Azure (ACI), VMs com contêineres ou AKS (serviço de Kubernetes do Azure) | Microsserviços em contêineres no serviço de Kubernetes do Azure (AKS) e/ou microsserviços sem servidor com base nas funções do Azure. |
| **Destino de dados** |
