...
## <a name="string-uri"></a>URI de cadeia de caracteres  
 ...
 Para obter mais informações, consulte [Resolvendo recursos durante o XSLT processamento externo](../../../../docs/standard/data/xml/resolving-external-resources-during-xslt-processing.md).  
