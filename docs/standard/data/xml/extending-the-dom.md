...
### <a name="example"></a>Exemplo  
 O exemplo conta o número de elementos em um documento XML.  
...
```  
 ...
 Para um exemplo que mostra como estender as classes DOM XML (System.Xml), consulte www.gotdotnet.com/userfiles/XMLDom/extendDOM.zip.  
