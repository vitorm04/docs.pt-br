...
## <a name="in-this-section"></a>Nesta seção  
 [Objetos de extensão XSLT](../../../../docs/standard/data/xml/xslt-extension-objects.md)  
 Discute o uso da classe de <xref:System.Xml.Xsl.XsltArgumentList> para processar objetos de extensão XSLT.  
  
 [Parâmetros XSLT](../../../../docs/standard/data/xml/xslt-parameters.md)  
 Discute o uso da classe de <xref:System.Xml.Xsl.XsltArgumentList> para processar parâmetros XSLT.  
  
 [Blocos de script usando msxsl:script](../../../../docs/standard/data/xml/script-blocks-using-msxsl-script.md)  
