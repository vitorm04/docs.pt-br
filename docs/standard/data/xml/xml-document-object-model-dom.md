...
![Estrutura do documento XML](../../../../docs/standard/data/xml/media/xml-to-domtree.gif "XML_To_DOMTree") Estrutura do documento XML
...
Para saber mais sobre os tipos de nós gerados na memória, confira [Tipos de nós XML](../../../../docs/standard/data/xml/types-of-xml-nodes.md). Para saber mais sobre objetos criados na árvore de nós, confira [Mapeando a hierarquia de objetos para dados XML](../../../../docs/standard/data/xml/mapping-the-object-hierarchy-to-xml-data.md).

A Microsoft estendeu as APIs que estão disponíveis no Nível 1 e no Nível 2 do DOM do W3C (World Wide Web Consortium) para facilitar o trabalho com um documento XML. Para dar suporte total aos padrões do W3C, as classes, métodos e propriedades adicionais aumentam a funcionalidade além daquilo que pode ser feito com o DOM XML do W3C. As novas classes permitem que você acesse dados relacionais, oferecendo métodos para sincronização com dados ADO.NET, expondo, simultaneamente, os dados como XML. Para saber mais, confira [Sincronizando um DataSet com um XmlDataDocument](../../../../docs/framework/data/adonet/dataset-datatable-dataview/dataset-and-xmldatadocument-synchronization.md).
