...
## <a name="namespace-declarations"></a>Declarações de namespace  
 ...
 Os prefixos são definidos pelo formulário: `<e:Envelope>`e`” é uma abreviação para o URI formal de namespace. Você pode identificar o elemento de `Body` como um membro de namespace de `Envelope` usando a sintaxe: `e:Body`.  
