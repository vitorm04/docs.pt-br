...
### <a name="higher-performance-xpath-expressions"></a>Expressões XPath de desempenho mais alto  
 ...
 Para obter mais informações sobre o nó definir métodos de navegação do <xref:System.Xml.XPath.XPathNavigator> de classe, consulte [nó definido navegação usando XPathNavigator](../../../../docs/standard/data/xml/node-set-navigation-using-xpathnavigator.md).  
