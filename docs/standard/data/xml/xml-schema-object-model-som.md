...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Descreve como usar as classes no namespace <xref:System.Xml.Schema?displayProperty=nameWithType> para criar esquemas XML na memória.  
