 ...
 **X DO NOT** definir métodos de extensão implementando um recurso nos namespaces normalmente associados com outros recursos. Em vez disso, defini-los no namespace associado com o recurso que eles pertencem.  
