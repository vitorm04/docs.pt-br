...
Para criar uma biblioteca de classes portátil, use o modelo fornecido no Visual Studio. Crie um novo projeto (**arquivo** > **novo projeto**) e, na caixa de diálogo **novo projeto** , selecione sua linguagem de programação ( C# Visual ou Visual Basic). Em seguida, selecione o modelo **biblioteca de classes (portátil herdado)** . Insira um nome para seu projeto e escolha **OK**.
...
Se você quiser avaliar a portabilidade de seus assemblies antes de fazer alterações no Visual Studio, poderá usar o [analisador de portabilidade do .net](https://visualstudiogallery.msdn.microsoft.com/1177943e-cfb7-4822-a8a6-e56c7905292b).
