...
-   Desenvolvendo [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)] aplicativos com controles XAML, conforme descrito em [roteiro para aplicativos Windows Store usando c# ou Visual Basic](http://go.microsoft.com/fwlink/p/?LinkID=242212), [aplicativos da Windows Store de desenvolvimento (VB / c# / C++ e XAML)](http://go.microsoft.com/fwlink/p/?LinkId=238311)e [Visão geral de aplicativos .NET da Windows Store](http://go.microsoft.com/fwlink/p/?LinkId=238312) no Centro de desenvolvimento do Windows.  
...
-   [Aplicativos .NET da Windows Store](http://go.microsoft.com/fwlink/p/?LinkId=247912) fornece uma exibição simplificada das bibliotecas de classe do .NET Framework e incluir apenas os tipos e membros que você pode usar para criar [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)] aplicativos e [!INCLUDE[wrt](../../../includes/wrt-md.md)] componentes.  
    ...
    -   Recursos que envolvem simplesmente a API do sistema operacional também serão removidos porque o [!INCLUDE[wrt](../../../includes/wrt-md.md)] é fácil chamar a partir de código gerenciado.  
     ...
     Para saber mais sobre o [!INCLUDE[net_win8_profile](../../../includes/net-win8-profile-md.md)], consulte o [visão geral de aplicativos .NET da Windows Store](http://go.microsoft.com/fwlink/p/?LinkId=238312) Center.To de desenvolvimento do Windows ler sobre o processo de seleção de API, consulte o [.NET para aplicativos Windows Store](http://go.microsoft.com/fwlink/p/?LinkId=251061) entrada no .NET blog.  
  
-   O [tempo de execução do Windows](http://go.microsoft.com/fwlink/p/?LinkId=238319) fornece elementos de interface de usuário para criar [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)] aplicativos e fornece acesso aos recursos do sistema operacional. Como o .NET Framework, o [!INCLUDE[wrt](../../../includes/wrt-md.md)] tem metadados que permite que os compiladores c# e Visual Basic usar o [!INCLUDE[wrt](../../../includes/wrt-md.md)] bibliotecas de classe a maneira como eles usam o .NET Framework. O .NET Framework torna mais fácil de usar o [!INCLUDE[wrt](../../../includes/wrt-md.md)] ocultando algumas diferenças:  
...
### <a name="other-differences"></a>Outras diferenças  
 Em alguns casos, o fato de que os tipos do .NET Framework aparecem no seu código em vez de [!INCLUDE[wrt](../../../includes/wrt-md.md)] tipos exige ação de sua parte. Por exemplo, o [Windows](http://go.microsoft.com/fwlink/p/?LinkId=238376) classe aparece como <xref:System.Uri?displayProperty=nameWithType> no código do .NET Framework. <xref:System.Uri?displayProperty=nameWithType>permite que um URI relativo, mas [Windows](http://go.microsoft.com/fwlink/p/?LinkId=238376) requer um URI absoluto. Portanto, quando você passar um URI para um [!INCLUDE[wrt](../../../includes/wrt-md.md)] método, você deve garantir que ele é absoluto. (Consulte [passando um URI para o tempo de execução do Windows](../../../docs/standard/cross-platform/passing-a-uri-to-the-windows-runtime.md).)  
...
-   Você pode liberar as versões dos componentes reutilizáveis usando o [!INCLUDE[wrt](../../../includes/wrt-md.md)] [VersionAttribute](http://go.microsoft.com/fwlink/p/?LinkId=238563) atributo para identificar os tipos (e os membros dentro de um tipo) foram adicionados em versões diferentes.  
  
-   Os tipos no seu componente podem derivar [!INCLUDE[wrt](../../../includes/wrt-md.md)] tipos. Controles podem derivar dos tipos de controle primitivo no [Primitives](http://go.microsoft.com/fwlink/p/?LinkId=238564) namespace ou de mais concluído controles como [botão](http://go.microsoft.com/fwlink/p/?LinkId=238565).  
...
|Título|Descrição|  
|-----------|-----------------|  
|[Visão geral de aplicativos .NET da Windows Store](http://go.microsoft.com/fwlink/p/?LinkId=238312)|Descreve os tipos do .NET Framework e membros que você pode usar para criar [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)] aplicativos e [!INCLUDE[wrt](../../../includes/wrt-md.md)]componentes. (No Centro de desenvolvimento do Windows.)|  
|[Roteiro para aplicativos da Windows Store usando c# ou Visual Basic](http://go.microsoft.com/fwlink/p/?LinkId=242212)|Fornece os principais recursos para ajudá-lo a começar a desenvolver [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)] aplicativos usando o c# ou Visual Basic, incluindo muitos tópicos do guia de início rápido, diretrizes e práticas recomendadas. (No Centro de desenvolvimento do Windows.)|  
|[Desenvolvendo aplicativos da Windows Store (VB / c / C++ e XAML)](http://go.microsoft.com/fwlink/p/?LinkId=238311)|Fornece os principais recursos para ajudá-lo a começar a desenvolver [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)] aplicativos usando o c# ou Visual Basic, incluindo muitos tópicos do guia de início rápido, diretrizes e práticas recomendadas. (No Centro de desenvolvimento do Windows.)|  
|[Criando componentes de tempo de execução do Windows em c# e Visual Basic](http://go.microsoft.com/fwlink/p/?LinkId=238313)|Descreve como criar um [!INCLUDE[wrt](../../../includes/wrt-md.md)] componente usando o .NET Framework, explica como usá-lo como parte de um [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)] aplicativo compilado para Windows usando JavaScript e descreve como depurar a combinação com o Visual Studio. (No Centro de desenvolvimento do Windows.)|  
|[Referência de tempo de execução do Windows](http://go.microsoft.com/fwlink/?LinkId=238319)|A documentação de referência para o [!INCLUDE[wrt](../../../includes/wrt-md.md)]. (No Centro de desenvolvimento do Windows.)|  
|[Passando um URI para o tempo de execução do Windows](../../../docs/standard/cross-platform/passing-a-uri-to-the-windows-runtime.md)|Descreve um problema que pode ocorrer quando você passar um URI do código gerenciado para o [!INCLUDE[wrt](../../../includes/wrt-md.md)]e como evitá-la.|
