...
ms.locfileid: "58831386"
---
# <a name="visual-basic-sample-applications"></a>Aplicativos de exemplo do Visual Basic
É possível usar o Visual Studio para baixar e instalar exemplos de aplicativos Visual Basic completos e empacotados na [Galeria de Códigos do MSDN](https://code.msdn.microsoft.com)  
