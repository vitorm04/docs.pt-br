...
## <a name="arguments"></a>Argumentos  
 `+` &#124; `-`  
 Opcional. A opção está desativada por padrão ou, `-highentropyva-`se você especificar. A opção estará ativada se você `-highentropyva` especificar `-highentropyva+`ou.  
