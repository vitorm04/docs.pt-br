...
---
# <a name="data-types-of-the-type-parameters-in-extension-method-ltmethodnamegt-defined-in-lttypenamegt-cannot-be-inferred-from-these-arguments"></a>Tipos de dados dos parâmetros de tipo no método de extensão '&lt;methodname&gt;'definido em'&lt;typename&gt;' não podem ser inferidos destes argumentos
