...
---
# <a name="type-argument-lttypeargumentnamegt-must-have-a-public-parameterless-instance-constructor-to-satisfy-the-new-constraint-for-type-parameter-lttypeparameternamegt"></a>O argumento de tipo '&lt;typeargumentname&gt;'deve ter um construtor de instância pública sem-parâmetros para satisfazer a restrição 'New' para parâmetro de tipo'&lt;typeparametername&gt;'
