...
---
# <a name="member-ltmembernamegt-implicitly-defines-a-member-ltimplicitmembernamegt-which-has-the-same-name-as-a-type-parameter"></a>Membro '&lt;membername&gt;'define implicitamente um membro'&lt;implicitmembername&gt;' que tem o mesmo nome que um parâmetro de tipo
