...
---
# <a name="no-accessible-overloaded-methodname-can-be-called-with-these-arguments-without-a-narrowing-conversion-list"></a>Não acessível '\<methodname >' pode ser chamado com estes argumentos sem uma conversão redutora: \<lista >
