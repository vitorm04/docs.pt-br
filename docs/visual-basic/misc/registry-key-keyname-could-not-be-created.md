...
-   Certifique-se de que você tem permissões de segurança suficientes para acessar a chave.  
  
## <a name="see-also"></a>Consulte também  
 [Resumo do Registro](../../visual-basic/language-reference/keywords/registry-summary.md)  
 [Alterações de acesso do registro no Visual Basic .NET](http://msdn.microsoft.com/library/b58f7687-f4db-448a-a865-07f62fd16fb2)
