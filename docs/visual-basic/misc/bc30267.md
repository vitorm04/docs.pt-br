...
Uma declaração de procedimento ou propriedade tenta substituir um elemento herdado do mesmo nome, mas o elemento herdado é especificado `NotOverridable`como.  
