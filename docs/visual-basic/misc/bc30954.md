...
---
# <a name="type-arguments-inferred-for-method-ltprocedurenamegt-result-in-the-following-errors-lterrorlistgt"></a>Argumentos de tipo inferidos para método '&lt;procedurename&gt;' resultam nos seguintes erros:&lt;errorlist&gt;
