...
---
# <a name="extension-method-methodname-has-type-constraints-that-can-never-be-satisfied"></a>O método de extensão ' \<methodname > ' tem restrições de tipo que nunca podem ser satisfeitas
...
```  
 ...
 A aplicabilidade de um método de extensão é determinada do argumento fornecido para o primeiro parâmetro, que é `arg1` no código a seguir.  
