...
---
# <a name="data-types-of-the-type-parameters-in-method-39ltmethodnamegt39-cannot-be-inferred-from-these-arguments-because-more-than-one-type-is-possible"></a>Tipos de dados dos parâmetros de tipo no método &#39; &lt;methodname&gt; &#39; não podem ser inferidos destes argumentos porque mais de um tipo possível
