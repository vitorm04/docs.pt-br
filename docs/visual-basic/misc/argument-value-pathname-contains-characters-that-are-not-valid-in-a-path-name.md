...
ms.locfileid: "61977061"
---
# <a name="argument-value-pathname-contains-characters-that-are-not-valid-in-a-path-name"></a>O valor do argumento '\<pathname >' contém caracteres que não são válidos em um nome de caminho
