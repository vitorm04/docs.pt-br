...
A ferramenta ALink, utilizada pelo [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] compilador, relata um erro ao criar o assembly. As causa possíveis incluem as seguintes:  
