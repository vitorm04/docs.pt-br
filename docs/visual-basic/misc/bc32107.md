...
Uma lista de restrição inclui tanto o [classe (Visual Basic)](http://msdn.microsoft.com/library/0777c6e6-46bc-451b-ad70-57b49d4ef4f7) restrição e o nome de uma classe definida.  
