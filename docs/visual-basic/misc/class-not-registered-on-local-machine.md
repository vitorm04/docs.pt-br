---
title: "Classe não registrada no computador local | Documentos do Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
---
# <a name="class-not-registered-on-local-machine"></a>Classe não registrada na máquina local
