...
---
# <a name="variable-ltvariablenamegt-is-passed-by-reference-before-it-has-been-assigned-a-value-structure-variable"></a>Variável '&lt;variablename&gt;' é passada por referência antes de ele foi atribuído um valor (variável de estrutura)
