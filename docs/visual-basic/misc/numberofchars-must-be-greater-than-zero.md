...
-   Alterar `NumberOfChars` para um valor que é maior do que `0`.  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Método TextFieldParser.PeekChars](http://msdn.microsoft.com/library/4a180d26-d46d-4cc1-9af7-d23abe27c89b)  
