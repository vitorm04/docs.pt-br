...
---
# <a name="expected-closing-39gt39-for-xml-processor-instruction"></a>Fechamento esperado de &#39;? &gt; &#39; para instrução de processador XML
O fechamento necessário ausente do literal de instrução de processamento XML `?>` caracteres.  
