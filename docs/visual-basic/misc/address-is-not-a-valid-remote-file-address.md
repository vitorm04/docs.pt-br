...
\<endereço > não é um endereço de arquivo remoto válido. Um endereço válido deve incluir um protocolo, um caminho e um nome de arquivo.  
 ...
 Um endereço inválido foi especificado para uma operação de upload ou download. Endereços devem incluir um protocolo, como `ftp` ou `http`, um caminho válido e o nome do arquivo. Esse erro pode ser um resultado da análise de caminhos de arquivo incorretamente.  
