...
---
# <a name="ltmethodnamegt-is-not-accessible-in-this-context-because-the-return-type-is-not-accessible"></a>'&lt;methodname&gt;' não está acessível neste contexto porque o tipo de retorno não está acessível
