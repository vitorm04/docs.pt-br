---
title: '&#39;Antes de&#39; e &#39;após&#39; argumentos não podem ser combinados'
ms.date: 07/20/2015
f1_keywords:
...
## <a name="to-correct-this-error"></a><span data-ttu-id="45db6-104">Para corrigir este erro</span><span class="sxs-lookup"><span data-stu-id="45db6-104">To correct this error</span></span>  
  
1.  <span data-ttu-id="45db6-105">Remover o `Before` ou `After` argumento.</span><span class="sxs-lookup"><span data-stu-id="45db6-105">Remove either the `Before` or `After` argument.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="45db6-106">Consulte também</span><span class="sxs-lookup"><span data-stu-id="45db6-106">See Also</span></span>  
