...
---
# <a name="expression-of-type-lttypenamegt-cannot-be-converted-to-object-or-valuetype"></a>Expressão do tipo '&lt;typename&gt;' não pode ser convertido em 'Object' ou 'ValueType'
