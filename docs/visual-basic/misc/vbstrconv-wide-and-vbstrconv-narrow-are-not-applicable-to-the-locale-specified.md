---
title: "VbStrConv. Wide e VbStrConv não são aplicáveis para a localidade especificada | Documentos do Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
---
# <a name="vbstrconvwide-and-vbstrconvnarrow-are-not-applicable-to-the-locale-specified"></a>VbStrConv. Wide e VbStrConv não são aplicáveis para a localidade especificada
