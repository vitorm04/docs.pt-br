...
---
# <a name="type-lttypenamegt-has-no-type-parameters-and-so-cannot-have-type-arguments"></a>Tipo '&lt;typename&gt;' não tem nenhum tipo parâmetros e, portanto, não podem ter argumentos de tipo
