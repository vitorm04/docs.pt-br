...
Uma instrução `Implements` foi encontrada em um local inválido.  
  
 **ID do erro:** BC31053  
  
## <a name="to-correct-this-error"></a>Para corrigir este erro  
  
- Coloque instruções `Implements` imediatamente após qualquer instrução `Inherits`, mas antes de qualquer declaração. Por exemplo:  
