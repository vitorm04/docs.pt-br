---
title: "Objeto não dá suporte à configuração de localidade atual (Visual Basic) | Documentos do Microsoft"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
ms.openlocfilehash: 9d0fda9c45f77c5c8470e7cc396f425b5c587a66
ms.lasthandoff: 03/13/2017

---
# <a name="object-doesn39t-support-current-locale-setting-visual-basic"></a>Objeto não dá suporte à configuração de localidade atual (Visual Basic)
