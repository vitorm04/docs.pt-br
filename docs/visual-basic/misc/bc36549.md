...
---
# <a name="anonymous-type-property-ltpropertynamegt-cannot-be-used-in-the-definition-of-a-lambda-expression-within-the-same-initialization-list"></a>Propriedade de tipo anônimo '&lt;propertyname&gt;' não pode ser usado na definição de uma expressão lambda na mesma lista de inicialização
