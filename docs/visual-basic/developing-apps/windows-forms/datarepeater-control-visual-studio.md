---
title: Controle DataRepeater (Visual Studio) | Documentos do Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.suite: 
ms.technology:
...
ms.openlocfilehash: d28c96402d144dc1cf49293551c360403c8456bb
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Apresenta e discute o `DataRepeater` controle.  
 ...
 Demonstra como usar o `DataRepeater` controle para exibir dados de uma fonte de dados.  
 ...
 Demonstra como usar o `DataRepeater` controle para exibir dados adicionais.  
 ...
 Demonstra como alterar a orientação de um `DataRepeater` controle.  
 ...
 Demonstra como personalizar um `DataRepeater` controle em tempo de design e tempo de execução.  
 ...
 Demonstra como controlar os indicadores de seleção em um `DataRepeater` controle.  
 ...
 Demonstra como impedir que os usuários adicionem ou excluam itens em uma `DataRepeater` controle.  
 ...
 Demonstra como implementar recursos de pesquisa em um `DataRepeater` controle.  
 ...
 Demonstra como exibir registros relacionados usando dois `DataRepeater` controles.  
 ...
 Fornece uma demonstração do início ao fim de como usar um `DataRepeater` controle.  
 ...
 Descreve problemas potenciais e suas soluções.  
