...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Demonstra como personalizar um `DataRepeater` controle em tempo de design e em tempo de execução.  
 ...
 Demonstra como impedir que os usuários adicionem ou excluam itens em um `DataRepeater` controle.  
 ...
 Demonstra como exibir os registros relacionados usando dois `DataRepeater` controles.  
