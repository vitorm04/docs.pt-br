...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Apresenta e discute a `DataRepeater` controle.  
 ...
 Demonstra como evitar que usuários adicionem ou excluam itens em um `DataRepeater` controle.  
 ...
 Fornece uma demonstração do início ao término de como usar um `DataRepeater` controle.  
