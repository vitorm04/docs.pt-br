...
### <a name="to-create-a-data-bound-datarepeater"></a>Para criar um DataRepeater associado a dados  
...
2.  Arraste as alças de dimensionamento e a posição para o tamanho e posicionar o controle.  
     ...
     Observe que o controle tem duas regiões retangulares. A região superior é o *modelo de item*; controles adicionados ao modelo serão repetidos em cada item o <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater> controle em tempo de execução. A região inferior é o *visor*, onde os itens serão exibidos.  
...
5.  Alterar o tipo de tabela para descarte `Details` clicando em `Details` na lista suspensa no nó da tabela.  
