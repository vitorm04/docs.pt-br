...
|My Object|Windows Application|Biblioteca de Classes|Aplicativo do Console|Windows Control Library|Web Control Library|Serviço do Windows|Vazio|Web Site|  
|---|---|---|---|---|---|---|---|---|  
