...
## <a name="my"></a>Meu  
 O `My` recurso fornece acesso rápido e intuitivo a inúmeras classes do .NET Framework, permitindo que o usuário do Visual Basic interagir com o computador, aplicativo, configurações, recursos e assim por diante.  
