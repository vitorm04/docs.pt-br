...
Quando você nomeia um elemento em seu aplicativo do Visual Basic, o primeiro caractere do nome deve ser um caractere alfabético ou um sublinhado. No entanto, observe que os nomes que começam com um sublinhado não são compatíveis com o [independência da linguagem e componentes independentes da linguagem](https://msdn.microsoft.com/library/12a7a7h3) (CLS).  
