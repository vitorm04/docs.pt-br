...
## <a name="separators"></a>Separadores  
 ...
 Para obter mais informações, confira [Como: Instruções Break e combine no código](../../../visual-basic/programming-guide/program-structure/how-to-break-and-combine-statements-in-code.md).  
  
 O caractere de`:`dois-pontos () também é usado para identificar um rótulo de instrução. Para obter mais informações, confira [Como: Instruções](../../../visual-basic/programming-guide/program-structure/how-to-label-statements.md)de rótulo.  
...
### <a name="dot--operator"></a>Ponto (.) Operator  
...
### <a name="exclamation-point--operator"></a>Ponto de exclamação (!) Operator  
 ...
 As três linhas de saída `MsgBox` de todos exibem `32856`o valor. A primeira linha usa o acesso tradicional à propriedade `index`, o segundo utiliza o fato que `index` é a propriedade padrão da classe `hasDefault`e o terceiro usa o acesso de dicionário à classe.  
