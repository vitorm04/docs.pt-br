...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Aborda o procedimento que serve como a partir do ponto e controle geral para seu aplicativo.  
 ...
 Mostra como dividir instruções longas em várias linhas e combinar instruções curtas em uma única linha.  
 ...
 Mostra como recolher e ocultar seções de código no Visual Basic editor de códigos.  
 ...
 Descreve como usar colchetes (`[]`) para delimitar os nomes de variáveis que também são palavras-chave do Visual Basic.  
  
 [Me, My, MyBase e MyClass](../../../visual-basic/programming-guide/program-structure/me-my-mybase-and-myclass.md)  
 Descreve várias maneiras para se referir a elementos de um programa do Visual Basic.  
  
 [Limitações do Visual Basic](../../../visual-basic/programming-guide/program-structure/limitations.md)  
 Discute a remoção dos limites de codificação conhecidos no Visual Basic.  
