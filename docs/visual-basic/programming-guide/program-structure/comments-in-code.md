...
> [!NOTE]
> Você também pode adicionar comentários ao código precedendo o texto com a palavra-chave `REM`. No entanto `'` , o símbolo e os botões de desmarcação de **Comentário**/são mais fáceis de usar e exigem menos espaço e memória.  
