...
Um *estrutura* é uma generalização do que o tipo definido pelo usuário (UDT) compatível com versões anteriores do Visual Basic. Além dos campos, estruturas podem expor propriedades, métodos e eventos. Uma estrutura pode implementar uma ou mais interfaces, e você pode declarar os níveis de acesso individual para cada campo.  
 ...
 Você pode combinar itens de dados de diferentes tipos para criar uma estrutura. Uma estrutura associa um ou mais *elementos* entre si e com a estrutura em si. Quando você declara uma estrutura, ele se torna uma *tipo de dados composto*, e você pode declarar variáveis desse tipo.  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Bastidores atribuir uma estrutura para uma variável e acessar seus elementos.  
 ...
 Resume como estruturas interagem com matrizes, objetos, procedimentos e uns aos outros.  
