...
|Identifier type character|Tipo de dados|Exemplo|  
|-------------------------------|---------------|-------------|  
|`%`|`Integer`|`Dim L%`|  
|`&`|`Long`|`Dim M&`|  
...
|Textual form of literal|Default data type|Exemplo|  
|-----------------------------|-----------------------|-------------|  
...
|Literal type character|Tipo de dados|Exemplo|  
|----------------------------|---------------|-------------|  
|`S`|`Short`|`I = 347S`|
|`I`|`Integer`|`J = 347I`|
|`L`|`Long`|`K = 347L`|
...
|Number base|Prefixo|Valid digit values|Exemplo|
|-----------------|------------|------------------------|-------------|
