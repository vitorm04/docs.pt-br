...
|Tópico|Descrição|  
|-----------|-----------------|  
|[Visão geral do LINQ to XML no Visual Basic](../../../../visual-basic/programming-guide/language-features/xml/overview-of-linq-to-xml.md)|Descreve como o [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] dá suporte ao [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)].|  
