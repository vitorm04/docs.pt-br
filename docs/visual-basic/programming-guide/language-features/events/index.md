...
|[Criando manipuladores de eventos no Windows Forms](../../../../../docs/framework/winforms/creating-event-handlers-in-windows-forms.md)|Descreve como trabalhar com eventos associados aos objetos do Windows Forms.|  
