...
- Ele não deve ter mais de 1023 caracteres.  
 ...
 O limite de comprimento de 1023 caracteres também se aplica à cadeia de caracteres inteira de um nome totalmente qualificado `outerNamespace.middleNamespace.innerNamespace.thisClass.thisElement`, como.  
...
- Você está trabalhando com código escrito em outro idioma no qual a palavra-chave fornecida não está reservada.  
 ...
 Caso contrário, você deve considerar renomear o elemento se seu nome entrar em conflito com uma palavra-chave. O IDE (ambiente de desenvolvimento integrado) fornece uma maneira fácil de fazer isso. Para obter mais informações, consulte [refatoração](/visualstudio/vb-ide/refactoring-vb).  
