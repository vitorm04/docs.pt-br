...
- [Criando uma matriz](#creating-an-array)  
  
- [Armazenando valores em uma matriz](#storing-values-in-an-array)  
  
- [Preenchendo uma matriz com literais de matriz](#populating-an-array-with-array-literals)  
  
- [Iterando por uma matriz](#iterating-through-an-array)  
...
- [Divisão de uma matriz](#splitting-an-array)
...
Além disso, a [instrução ReDim](../../../../visual-basic/language-reference/statements/redim-statement.md) não pode operar em uma variável declarada como tipo `Array`. Por esses motivos e à segurança de tipo, é aconselhável declarar cada matriz como um tipo específico.  
...
Antes de copiar os elementos de cada matriz para a nova matriz, primeiro você deve assegurar que você inicializou a matriz para que ele seja grande o suficiente para accompodate a nova matriz. Você pode fazer isso de duas maneiras:
