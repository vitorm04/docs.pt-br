...
Operadores realizar muitas tarefas comuns que envolvem uma ou mais expressões chamadas *operandos*.  
  
## <a name="arithmetic-and-bit-shift-tasks"></a>Tarefas aritméticas e Bit shift  
 A tabela a seguir resume as operações disponíveis aritméticas e bit shift.  
  
|Para|Veja|  
|---|---|  
|Adicionar um valor numérico para outro|[Operador +](../../../../visual-basic/language-reference/operators/addition-operator.md)|  
|Subtrai um valor numérico de outro|[-Operador (Visual Basic)](../../../../visual-basic/language-reference/operators/subtraction-operator.md)|  
...
|Um valor numérico de multiplicação por outro|[Operador *](../../../../visual-basic/language-reference/operators/multiplication-operator.md)|  
...
|Localizar o quociente de um valor numérico é dividido por outro (sem o restante)|[\ Operador (Visual Basic)](../../../../visual-basic/language-reference/operators/integer-division-operator.md)|  
|Encontrar o resto de um valor numérico é dividido por outro (sem o quociente)|[Operador Mod](../../../../visual-basic/language-reference/operators/mod-operator.md)|  
...
|Mudar o padrão de bits de um valor numérico para a esquerda|[<\< Operador](../../../../visual-basic/language-reference/operators/left-shift-operator.md)|  
...
## <a name="logical-and-bitwise-tasks"></a>Tarefas lógicas e bit a bit  
 A tabela a seguir resume as operações disponíveis lógicas e bit a bit.  
...
|Executar uma conjunção lógica de curto-circuitada dois valores Boolean|[Operador AndAlso](../../../../visual-basic/language-reference/operators/andalso-operator.md)|  
|Executar o curto-circuitada uma disjunção lógica inclusiva em dois valores Boolean|[Operador OrElse](../../../../visual-basic/language-reference/operators/orelse-operator.md)|  
...
|Realizar a negação lógica bit a bit em um valor inteiro|[Operador Not](../../../../visual-basic/language-reference/operators/not-operator.md)|  
