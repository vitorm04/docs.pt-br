---
title: "Como consultar um banco de dados usando LINQ (Visual Basic) | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
dev_langs: 
  - "VB"
helpviewer_keywords: 
  - "consulta de banco de dados [LINQ]"
  - "consultas [LINQ no Visual Basic], consulta de banco de dados"
  - "consultas [LINQ no Visual Basic], tópicos explicativos"
  - "exemplos de consulta [LINQ]"
...
5.  A seguir estão algumas consultas adicionais que você pode experimentar:  
