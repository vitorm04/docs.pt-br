...
Um *recursiva* procedimento é aquele que chama a mesmo. Em geral, isso não é a maneira mais eficiente para gravar [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] código.  
