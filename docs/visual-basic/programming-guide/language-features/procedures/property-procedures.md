...
Um procedimento de propriedade é uma série de [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] instruções que manipulam uma propriedade personalizada em um módulo, classe ou estrutura. Procedimentos de propriedade são também conhecidos como *acessadores de propriedade*.  
  
 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]fornece para os procedimentos de propriedade a seguir:  
