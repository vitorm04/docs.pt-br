...
You can omit the `Get` and `Set` procedure when using an auto-implemented property. Para obter mais informações, consulte [Propriedades autoimplementadas](./auto-implemented-properties.md).
