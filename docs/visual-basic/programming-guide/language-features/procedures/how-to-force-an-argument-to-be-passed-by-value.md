...
-   Se o parâmetro correspondente é declarado `ByVal` no procedimento, você não precisa executar etapas adicionais. [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]já espera passar o argumento por valor.  
