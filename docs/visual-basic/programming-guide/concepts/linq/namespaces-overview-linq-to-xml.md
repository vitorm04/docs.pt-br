...
Ao usar [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] com Visual Basic e literais XML, você deve usar prefixos de namespace ao trabalhar com documentos em namespaces.  
