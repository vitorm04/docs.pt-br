...
## <a name="example"></a>Exemplo  
 ...
 Observe que a indexação em uma lista no .NET é 'zero' com base. A indexação em uma coleção de nós em um predicado XPath “é um” com base. Este exemplo reflete essa diferença.  
