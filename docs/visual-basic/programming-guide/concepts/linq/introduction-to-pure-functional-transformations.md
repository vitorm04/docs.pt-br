...
|[Aplicabilidade da transformação funcional (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/applicability-of-functional-transformation.md)|Descreve cenários típicos para transformações funcionais.|  
