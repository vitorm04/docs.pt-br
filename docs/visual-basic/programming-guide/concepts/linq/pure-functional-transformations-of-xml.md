...
|Tópico|Descrição|  
|-----------|-----------------|  
|[Introdução às transformações funcionais puras (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/introduction-to-pure-functional-transformations.md)|Descreve transformações funcionais e define a terminologia relevante.|  
|[Tutorial: Execução adiada (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/tutorial-deferred-execution.md)|Descreve a avaliação lazy e a execução adiada em detalhes.|  
