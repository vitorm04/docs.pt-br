---
title: Detalhes do Office Open XML WordprocessingML documentos (Visual Basic) | Documentos do Microsoft
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="details-of-office-open-xml-wordprocessingml-documents-visual-basic"></a>Detalhes do Office Open XML WordprocessingML documentos (Visual Basic)
...
|[Exemplo de saída partes do documento do Office Open XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/example-that-outputs-office-open-xml-document-parts.md)|Fornece um exemplo que abre um documento do Office Open XML WordprocessingML, e saída partes no console.|  
