...
ms.locfileid: "33641190"
---
# <a name="details-of-office-open-xml-wordprocessingml-documents-visual-basic"></a>Detalhes do Office abrir documentos de WordprocessingML XML (Visual Basic)
...
|[Exemplo de saídas de partes de documentos do Office Open XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/example-that-outputs-office-open-xml-document-parts.md)|Fornece um exemplo que abre um documento do Office Open XML WordprocessingML, e saída partes no console.|  
