---
title: "Arquivo XML de exemplo: clientes e pedidos (LINQ to XML) | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
manager: "wpickett"
---
# Arquivo XML de exemplo: clientes e pedidos (LINQ to XML)
[!INCLUDE[vs2017banner](../../../../csharp/includes/vs2017banner.md)]

O arquivo XML a seguir é usado em vários exemplos de [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] documentação. Esse arquivo contém clientes e pedidos.  
  
 O tópico [Arquivo XSD de exemplo: clientes e pedidos](../../../../visual-basic/programming-guide/concepts/linq/sample-xsd-file-customers-and-orders.md) contém um XSD que pode ser usado para validar esse documento. Ele usa o `xs:key` e `xs:keyref` recursos de XSD para estabelecer que o `CustomerID` atributo do `Customer` elemento é uma chave e estabelecer uma relação entre o `CustomerID` elemento em cada `Order` elemento e o `CustomerID` atributo em cada `Customer` elemento.  
