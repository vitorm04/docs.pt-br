...
## <a name="example"></a>Exemplo  
 Se você estiver trabalhando no passo a passo, você pode usar este código para o arquivo Module1. vb do projeto que será criado ali. Basta substituir as linhas marcadas com * * * no `Main` método com as consultas e as execuções de consulta são fornecidas no passo a passo.  
