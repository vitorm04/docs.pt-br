...
|[Eixos linguagem integrados em Visual Basic (LINQ para XML)](../../../../visual-basic/programming-guide/concepts/linq/language-integrated-axes.md)|Resume o [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] integrado eixos.|  
