...
## <a name="example"></a>Exemplo  
 ...
 Para obter mais informações sobre o operador de `Any`, consulte [operações do quantificador (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/quantifier-operations.md).  
