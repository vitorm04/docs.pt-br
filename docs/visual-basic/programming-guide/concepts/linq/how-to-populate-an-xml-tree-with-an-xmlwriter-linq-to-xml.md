...
---
# <a name="how-to-populate-an-xml-tree-with-an-xmlwriter-linq-to-xml-visual-basic"></a>Como: Preencher uma árvore XML com um XmlWriter (LINQ para XML) (Visual Basic)
