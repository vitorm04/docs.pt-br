...
|[Introdução aos literais XML no Visual Basic](../../../../visual-basic/programming-guide/concepts/linq/introduction-to-xml-literals.md)|Fornece uma breve introdução à criação de árvores usando literais XML no Visual Basic. Este tópico inclui links para documentação do Visual Basic dos literais XML.|  
