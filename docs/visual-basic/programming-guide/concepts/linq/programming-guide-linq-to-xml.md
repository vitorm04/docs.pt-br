...
## <a name="who-should-read-this-documentation"></a>Quem deve ler esta documentação  
 Esta documentação tem como alvo os desenvolvedores que já conhecem o Visual Basic e alguns aspectos básicos de [!INCLUDE[dnprdnshort](~/includes/dnprdnshort-md.md)].  
 ...
 O [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] depende fortemente de classes genéricas. Portanto, é muito importante entender o uso de classes e tipos genéricos. Para obter mais informações, consulte [tipos genéricos no Visual Basic](../../../../visual-basic/programming-guide/language-features/data-types/generic-types.md).  
