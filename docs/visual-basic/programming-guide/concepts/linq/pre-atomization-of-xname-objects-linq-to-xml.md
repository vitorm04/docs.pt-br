...
- [Objetos XName e XNamespace (LINQ to XML) atomáveis (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/atomized-xname-and-xnamespace-objects-linq-to-xml.md)
