...
## <a name="example"></a>Exemplo  
 O código a seguir preenche um grafo de objeto com o `Address`, `PurchaseOrder`, e `PurchaseOrderItem` as classes do [arquivo XML de exemplo: Ordem de compra típica (LINQ to XML)](../../../../visual-basic/programming-guide/concepts/linq/sample-xml-file-typical-purchase-order-linq-to-xml.md) documento XML.  
