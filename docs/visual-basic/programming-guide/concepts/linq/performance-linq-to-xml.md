...
## <a name="in-this-section"></a>Nesta seção  
 ...
 [Pré-Atomização de objetos XName (LINQ to XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/pre-atomization-of-xname-objects-linq-to-xml.md)  
 ...
 [Consultas estaticamente compiladas (LINQ to XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/statically-compiled-queries-linq-to-xml.md)  
