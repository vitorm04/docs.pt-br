...
Visual Basic oferece suporte completo para programação orientada a objeto, como encapsulamento, herança e polimorfismo.  
...
-   [Classes e objetos](#classes-and-objects)  
    ...
    -   [Membros de classe](#members)  
         ...
         [Campos e propriedades](#properties-and-fields)  
    ...
    -   [Modificador de acesso e níveis de acesso](#access-modifiers-and-access-levels)  
  
    -   [Criando classes](#instantiating-classes)  
  
    -   [Membros e classes compartilhadas](#shared-classes-and-members)  
...
O Visual Basic também fornece uma versão leve do classes chamadas *estruturas* que são úteis quando você precisa criar uma matriz grande de objetos e deseja consumir muita memória para que não.
...
#### <a name="properties-and-fields"></a>Campos e propriedades
...
Visual Basic permite que você criar um campo particular para armazenar o valor da propriedade ou usar os chamados Propriedades autoimplementadas que cria esse campo automaticamente em segundo plano e fornecem a lógica básica para os procedimentos de propriedade.
...
> [!NOTE]
>  No Visual Basic, há duas maneiras de criar um método: o `Sub` instrução será usada se o método não retorna um valor; o `Function` instrução é usada se um método retorna um valor.
...
Na maioria dos casos, você declara um método dentro de uma definição de classe. No entanto, o Visual Basic também suporta *métodos de extensão* que permitem que você adicione métodos para uma classe existente fora da definição atual da classe.
...
Para obter mais informações, consulte: [vida útil do objeto: como os objetos são criados e Destroyed](../../../visual-basic/programming-guide/language-features/objects-and-classes/object-lifetime-how-objects-are-created-and-destroyed.md).
...
- Para declarar eventos, use o [instrução Event](../../../visual-basic/language-reference/statements/event-statement.md).

- Para gerar eventos, use o [instrução RaiseEvent](../../../visual-basic/language-reference/statements/raiseevent-statement.md).

- Para especificar o uso de uma forma declarativa de manipuladores de eventos, use o [WithEvents](../../../visual-basic/language-reference/modifiers/withevents.md) instrução e o [manipula](../../../visual-basic/language-reference/statements/handles-clause.md) cláusula.
...
### <a name="access-modifiers-and-access-levels"></a>Modificador de acesso e níveis de acesso  
...
### <a name="instantiating-classes"></a>Criando classes  
...
```  
 ...
 Módulos compartilhados no Visual Basic compartilharam membros somente e não podem ser instanciados. Membros compartilhados também não é possível acessar propriedades não compartilhado, campos ou métodos  
...
Classes, estruturas, interfaces e métodos em .NET podem incluir *parâmetros de tipo* que definem tipos de objetos que podem armazenar ou usar. O exemplo mais comum dos genéricos é uma coleção, em que você pode especificar o tipo dos objeto a serem armazenados em uma coleção.  
