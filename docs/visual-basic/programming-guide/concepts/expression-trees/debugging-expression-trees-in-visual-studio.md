...
---
# <a name="debugging-expression-trees-in-visual-studio-visual-basic"></a>Depuração de árvores de expressão no visual studio (visual básico)
...
- [Expression Tree Visualizer](https://github.com/zspitz/ExpressionToString#visual-studio-debugger-visualizer-for-expression-trees) ([licença MIT),](https://github.com/zspitz/ExpressionToString/blob/master/LICENSE)fornece uma visão gráfica da árvore de expressão, suas propriedades e objetos relacionados; e pode renderizar a árvore de expressão usando o código Visual Basic:
