---
title: Consultas (Visual Basic) | Documentos do Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
ms.suite: 
...
[!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]permite que você crie [!INCLUDE[vbteclinqext](../../../csharp/getting-started/includes/vbteclinqext_md.md)] expressões no seu código.  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Descreve o `Distinct` cláusula, que restringe os valores da variável range atual para eliminar valores duplicados nos resultados da consulta.  
 ...
 Descreve o `Group By` cláusula, que agrupa os elementos de um resultado de consulta e pode ser usada para aplicar funções de agregação para cada grupo.  
 ...
 Descreve o `Select` cláusula, que declara um conjunto de variáveis range para uma consulta.  
  
 [Cláusula Skip](../../../visual-basic/language-reference/queries/skip-clause.md)  
 Descreve o `Skip` cláusula, que ignora um número especificado de elementos em uma coleção e, em seguida, retorna os elementos restantes.  
  
 [Cláusula Skip While](../../../visual-basic/language-reference/queries/skip-while-clause.md)  
 Descreve o `Skip While` cláusula, que ignora elementos em uma coleção desde que uma condição especificada for `true` e, em seguida, retorna os elementos restantes.  
 ...
 Descreve o `Take While` cláusula, que inclui elementos em uma coleção desde que uma condição especificada for `true` e ignora os elementos restantes.  
