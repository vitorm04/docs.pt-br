...
[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]permite que você crie [!INCLUDE[vbteclinqext](~/includes/vbteclinqext-md.md)] expressões no seu código.  
  
## <a name="in-this-section"></a>Nesta seção  
 [Cláusula Aggregate](../../../visual-basic/language-reference/queries/aggregate-clause.md)  
 Descreve o `Aggregate` cláusula, que aplica um ou mais funções de agregação a uma coleção.  
  
 [Cláusula Distinct](../../../visual-basic/language-reference/queries/distinct-clause.md)  
 Descreve o `Distinct` cláusula, que restringe os valores da variável de intervalo atual para eliminar valores duplicados nos resultados da consulta.  
 ...
 Descreve o `Skip While` cláusula, que ignora elementos em uma coleção desde que uma condição especificada seja `true` e, em seguida, retorna os elementos restantes.  
