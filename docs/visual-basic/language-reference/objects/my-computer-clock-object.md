---
title: Objeto My.Computer.Clock | Documentos do Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.suite: 
ms.technology:
...
ms.openlocfilehash: 5503d14c8e9e4c00d9657c73f8f122a37d04d516
...
## <a name="remarks"></a>Comentários  
 Para obter informações sobre os métodos e propriedades do `My.Computer.Clock` de objeto, consulte <xref:Microsoft.VisualBasic.Devices.Clock>.</xref:Microsoft.VisualBasic.Devices.Clock>  
  
## <a name="requirements"></a>Requisitos  
 **Namespace:**<xref:Microsoft.VisualBasic.Devices></xref:Microsoft.VisualBasic.Devices>  
  
 **Classe:**<xref:Microsoft.VisualBasic.Devices.Clock></xref:Microsoft.VisualBasic.Devices.Clock>  
