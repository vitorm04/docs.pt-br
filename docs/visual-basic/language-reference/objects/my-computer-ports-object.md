...
## <a name="remarks"></a>Comentários  
 Para obter informações sobre os métodos e propriedades do `My.Computer.Ports` do objeto, consulte <xref:Microsoft.VisualBasic.Devices.Ports>.  
...
> [!NOTE]
>  Você também pode usar propriedades e métodos do <xref:System.IO.Ports.SerialPort?displayProperty=nameWithType> classe para acessar portas seriais do computador.  
