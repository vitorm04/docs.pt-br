---
title: Objeto My.Computer.Keyboard | Documentos do Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.suite: 
ms.technology:
...
ms.openlocfilehash: 1c3007dad5ff10c9a929092494e047f28a936643
...
## <a name="remarks"></a>Comentários  
 Para obter informações sobre os métodos e propriedades do `My.Computer.Keyword` de objeto, consulte <xref:Microsoft.VisualBasic.Devices.Keyboard>.</xref:Microsoft.VisualBasic.Devices.Keyboard>  
 ...
 **Classe:**<xref:Microsoft.VisualBasic.Devices.Keyboard></xref:Microsoft.VisualBasic.Devices.Keyboard>  
