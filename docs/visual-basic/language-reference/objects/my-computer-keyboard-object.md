...
## <a name="remarks"></a>Comentários  
 Para obter informações sobre os métodos e propriedades do `My.Computer.Keyword` do objeto, consulte <xref:Microsoft.VisualBasic.Devices.Keyboard>.  
