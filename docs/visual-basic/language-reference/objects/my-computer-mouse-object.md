...
## <a name="remarks"></a>Comentários  
 Para obter informações sobre os métodos e propriedades do `My.Computer.Mouse` de objeto, consulte <xref:Microsoft.VisualBasic.Devices.Mouse>.  
