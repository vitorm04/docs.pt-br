---
title: Objeto My.Computer.Mouse (Visual Basic)
ms.date: 07/20/2015
helpviewer_keywords:
...
## <a name="remarks"></a>Comentários  
 Para obter informações sobre os métodos e propriedades do `My.Computer.Mouse` do objeto, consulte <xref:Microsoft.VisualBasic.Devices.Mouse>.  
