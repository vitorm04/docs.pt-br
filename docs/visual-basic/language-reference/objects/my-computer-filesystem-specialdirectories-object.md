...
## <a name="remarks"></a>Comentários  
 Para obter informações sobre os métodos e propriedades do `My.Computer.FileSystem.SpecialDirectories` de objeto, consulte <xref:Microsoft.VisualBasic.FileIO.SpecialDirectories>.  
