---
title: Objeto My.Computer.Network | Documentos do Microsoft
ms.date: 2015-07-20
ms.prod: .net
ms.suite: 
ms.technology:
...
ms.openlocfilehash: 4fbc854b78f57e5b804f1a8eb06d8f55424ab6f2
...
## <a name="remarks"></a>Comentários  
 Para obter informações sobre os métodos e propriedades do `My.Computer.Network` de objeto, consulte <xref:Microsoft.VisualBasic.Devices.Network>.</xref:Microsoft.VisualBasic.Devices.Network>  
 ...
 **Namespace:**<xref:Microsoft.VisualBasic.Devices?displayProperty=fullName></xref:Microsoft.VisualBasic.Devices?displayProperty=fullName>  
  
 **Classe:**<xref:Microsoft.VisualBasic.Devices.Network></xref:Microsoft.VisualBasic.Devices.Network>  
