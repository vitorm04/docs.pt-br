...
## <a name="remarks"></a>Comentários  
 Para obter informações sobre os métodos e propriedades do `My.Computer.Audio` do objeto, consulte <xref:Microsoft.VisualBasic.Devices.Audio>.  
  
 Para obter mais informações, consulte [baralho sons](../../../visual-basic/developing-apps/programming/computer-resources/playing-sounds.md).  
