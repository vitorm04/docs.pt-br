---
title: "Instru&#231;&#227;o Property | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
helpviewer_keywords: 
  - "instrução Property"
  - "modificador padrão"
  - "procedimentos de propriedade, instruções Property"
  - "palavra-chave Property"
...
-   `accessmodifier`  
     ...
     Opcional no `Property` instrução e no máximo uma de `Get` e `Set` instruções. Pode ser uma das seguintes opções:  
...
-   `name`  
     ...
     Obrigatório. Nome da propriedade. Consulte [nomes de elemento declarados](../../../visual-basic/programming-guide/language-features/declared-elements/declared-element-names.md).  
...
-   `implementslist`  
    ...
    |-|-|  
    |Parte|Descrição|  
    |`interface`|Obrigatório. Nome de uma interface implementada por esta propriedade contendo classe ou estrutura.|  
