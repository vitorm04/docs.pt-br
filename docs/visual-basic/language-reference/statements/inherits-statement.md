...
|Termo|Definição|  
|---|---|  
|`basetypenames`|Necessário. The name of the class from which this class derives.<br /><br /> \- ou -<br /><br /> The names of the interfaces from which this interface derives. Use commas to separate multiple names.|  
