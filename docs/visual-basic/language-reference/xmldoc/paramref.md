...
## <a name="remarks"></a>Comentários  
 O `<paramref>` marca oferece uma maneira para indicar que uma palavra é um parâmetro. O arquivo XML pode ser processado para formatar esse parâmetro de alguma forma distinta.  
