...
## <a name="remarks"></a>Comentários  
 ...
 O [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] compilador converte propriedades de eixo filho em chamadas para o <xref:System.Xml.Linq.XContainer.Elements%2A> método.  
