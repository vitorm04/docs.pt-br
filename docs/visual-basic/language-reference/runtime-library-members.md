---
title: "Membros da biblioteca em tempo de execução do Visual Basic"
ms.date: 07/20/2015
ms.prod: .net
...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="5a3d3-102">Membros da biblioteca em tempo de execução do Visual Basic</span><span class="sxs-lookup"><span data-stu-id="5a3d3-102">Visual Basic Runtime Library Members</span></span>
<span data-ttu-id="5a3d3-103">O `Microsoft.VisualBasic` namespace contém as classes, módulos, constantes e enumerações que constituem o [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] biblioteca de tempo de execução.</span><span class="sxs-lookup"><span data-stu-id="5a3d3-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] runtime library.</span></span> <span data-ttu-id="5a3d3-104">Esses membros de biblioteca fornecem procedimentos, propriedades e valores constantes que você pode usar em seu código.</span><span class="sxs-lookup"><span data-stu-id="5a3d3-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="5a3d3-105">Cada módulo e a classe representam uma categoria específica de funcionalidade.</span><span class="sxs-lookup"><span data-stu-id="5a3d3-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="5a3d3-106">Classe Microsoft.VisualBasic.Collection</span><span class="sxs-lookup"><span data-stu-id="5a3d3-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="5a3d3-107">Classe ComClassAttribute</span><span class="sxs-lookup"><span data-stu-id="5a3d3-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="5a3d3-108">Classe Microsoft.VisualBasic.ControlChars</span><span class="sxs-lookup"><span data-stu-id="5a3d3-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="5a3d3-109">Classe Microsoft.VisualBasic.Constants</span><span class="sxs-lookup"><span data-stu-id="5a3d3-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="5a3d3-110">Módulo Microsoft.VisualBasic.Conversion</span><span class="sxs-lookup"><span data-stu-id="5a3d3-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="5a3d3-111">Módulo Microsoft.VisualBasic.DateAndTime</span><span class="sxs-lookup"><span data-stu-id="5a3d3-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="5a3d3-112">Classe Microsoft.VisualBasic.ErrObject</span><span class="sxs-lookup"><span data-stu-id="5a3d3-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="5a3d3-113">Módulo Microsoft.VisualBasic.FileSystem</span><span class="sxs-lookup"><span data-stu-id="5a3d3-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="5a3d3-114">Módulo Microsoft.VisualBasic.Financial</span><span class="sxs-lookup"><span data-stu-id="5a3d3-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="5a3d3-115">Módulo Microsoft.VisualBasic.Globals</span><span class="sxs-lookup"><span data-stu-id="5a3d3-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="5a3d3-116">Classe Microsoft.VisualBasic.HideModuleNameAttribute</span><span class="sxs-lookup"><span data-stu-id="5a3d3-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="5a3d3-117">Módulo Microsoft.VisualBasic.Information</span><span class="sxs-lookup"><span data-stu-id="5a3d3-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="5a3d3-118">Módulo Microsoft.VisualBasic.Interaction</span><span class="sxs-lookup"><span data-stu-id="5a3d3-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="5a3d3-119">Classe Microsoft.VisualBasic.MyGroupCollectionAttribute</span><span class="sxs-lookup"><span data-stu-id="5a3d3-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="5a3d3-120">Módulo Microsoft.VisualBasic.Strings</span><span class="sxs-lookup"><span data-stu-id="5a3d3-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="5a3d3-121">Classe Microsoft.VisualBasic.VBFixedArrayAttribute</span><span class="sxs-lookup"><span data-stu-id="5a3d3-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="5a3d3-122">Classe Microsoft.VisualBasic.VBFixedStringAttribute</span><span class="sxs-lookup"><span data-stu-id="5a3d3-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="5a3d3-123">Módulo Microsoft.VisualBasic.VbMath</span><span class="sxs-lookup"><span data-stu-id="5a3d3-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="5a3d3-124">Microsoft. VisualBasic constantes e enumerações</span><span class="sxs-lookup"><span data-stu-id="5a3d3-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  
 <span data-ttu-id="5a3d3-125">O `Microsoft.VisualBasic` namespace fornece constantes e enumerações como parte do [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] biblioteca de tempo de execução.</span><span class="sxs-lookup"><span data-stu-id="5a3d3-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] run-time library.</span></span> <span data-ttu-id="5a3d3-126">Você pode usar esses valores constantes em seu código.</span><span class="sxs-lookup"><span data-stu-id="5a3d3-126">You can use these constant values in your code.</span></span> <span data-ttu-id="5a3d3-127">Cada enumeração representa uma categoria específica de funcionalidade.</span><span class="sxs-lookup"><span data-stu-id="5a3d3-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="5a3d3-128">Para obter mais informações, consulte [constantes e enumerações](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="5a3d3-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="5a3d3-129">Consulte também</span><span class="sxs-lookup"><span data-stu-id="5a3d3-129">See Also</span></span>  
 [<span data-ttu-id="5a3d3-130">Constantes e Enumerações</span><span class="sxs-lookup"><span data-stu-id="5a3d3-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)  
 [<span data-ttu-id="5a3d3-131">Palavras-chave</span><span class="sxs-lookup"><span data-stu-id="5a3d3-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
