...
---
# <a name="because-this-call-is-not-awaited-execution-of-the-current-method-continues-before-the-call-is-completed"></a>Como essa chamada não é esperada, a execução do método atual continua antes que a chamada seja concluída
