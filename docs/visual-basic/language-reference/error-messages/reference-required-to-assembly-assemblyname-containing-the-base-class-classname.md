...
Referência necessária para o assembly '\<assemblyname >' contendo a classe base\<classname >'. Adicione uma ao seu projeto.  
 ...
 A classe é definida em uma biblioteca de vínculo dinâmico (DLL) ou assembly que não é referenciado diretamente em seu projeto. O compilador do Visual Basic exige uma referência para evitar ambiguidade caso a classe é definida em mais de uma DLL ou assembly.  
