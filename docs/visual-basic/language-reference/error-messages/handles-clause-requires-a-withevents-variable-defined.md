...
<span data-ttu-id="9b62a-103">Você não forneceu um `WithEvents` variável no seu `Handles` cláusula.</span><span class="sxs-lookup"><span data-stu-id="9b62a-103">You did not supply a `WithEvents` variable in your `Handles` clause.</span></span> <span data-ttu-id="9b62a-104">O `Handles` palavra-chave no final de uma declaração de procedimento faz com que ele manipule eventos gerados por uma variável de objeto declarada usando o `WithEvents` palavra-chave.</span><span class="sxs-lookup"><span data-stu-id="9b62a-104">The `Handles` keyword at the end of a procedure declaration causes it to handle events raised by an object variable declared using the `WithEvents` keyword.</span></span>  
 ...
 <span data-ttu-id="9b62a-105">**ID do erro:** BC30506</span><span class="sxs-lookup"><span data-stu-id="9b62a-105">**Error ID:** BC30506</span></span>  
  
## <a name="to-correct-this-error"></a><span data-ttu-id="9b62a-106">Para corrigir este erro</span><span class="sxs-lookup"><span data-stu-id="9b62a-106">To correct this error</span></span>  
  
-   <span data-ttu-id="9b62a-107">Forneça o necessário `WithEvents` variável.</span><span class="sxs-lookup"><span data-stu-id="9b62a-107">Supply the necessary `WithEvents` variable.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="9b62a-108">Consulte também</span><span class="sxs-lookup"><span data-stu-id="9b62a-108">See Also</span></span>  
 [<span data-ttu-id="9b62a-109">Handles</span><span class="sxs-lookup"><span data-stu-id="9b62a-109">Handles</span></span>](../../../visual-basic/language-reference/statements/handles-clause.md)
