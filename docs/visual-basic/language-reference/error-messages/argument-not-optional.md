...
2. Verifique se os argumentos omitidos são opcionais. Se não forem, forneça o argumento na chamada ou declare o parâmetro `Optional` na definição.  
