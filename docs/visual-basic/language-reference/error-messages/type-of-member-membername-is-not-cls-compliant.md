...
---
# <a name="bc40025-type-of-member-membername-is-not-cls-compliant"></a>BC40025: tipo de membro " \<membername> " não tem conformidade com CLS

O tipo de dados especificado para esse membro não faz parte da [independência de linguagem e dos componentes de Language-Independent](../../../standard/language-independence-and-language-independent-components.md) (CLS). Isso não é um erro no seu componente, porque o .NET Framework e Visual Basic oferecem suporte a esse tipo de dados. No entanto, outro componente escrito em código estritamente compatível com CLS pode não dar suporte a esse tipo de dados. Esse componente pode não ser capaz de interagir com êxito com seu componente.
