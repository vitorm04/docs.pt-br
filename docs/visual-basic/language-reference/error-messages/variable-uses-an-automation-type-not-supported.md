...
Você tentou usar uma variável definida em uma biblioteca de tipos ou a biblioteca de objeto que tem um tipo de dados não tem suporte pelo Visual Basic.
