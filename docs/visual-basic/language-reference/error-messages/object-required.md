...
Referências a propriedades e métodos geralmente exigem um qualificador de objeto explícito. Isso é o caso.  
...
3. Se um caminho é fornecido para um aplicativo de host **abrir arquivo** de comando, verifique se os argumentos nele estão corretos.  
