...
-   Foi feita uma tentativa para chamar um procedimento em uma biblioteca de vínculo dinâmico (DLL), mas a biblioteca especificada no `Lib` cláusula do `Declare` instrução não pode ser encontrada.  
