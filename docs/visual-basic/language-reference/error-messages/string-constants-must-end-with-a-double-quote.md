...
-   Verifique se que o literal de cadeia de caracteres termina com um sinal de aspas ("). Se você colar os valores dos outros editores de texto, verifique se o caractere colado é um sinal de aspas válido e não um dos caracteres semelhantes, como aspas "inteligentes" ou "chaves" ("ou") ou duas aspas simples (').  
