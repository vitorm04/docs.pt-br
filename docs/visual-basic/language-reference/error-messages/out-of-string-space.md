...
1. Certifique-se de que uma expressão que exige a criação de cadeia de caracteres temporária durante a avaliação não está causando o erro.  
  
2. Remove todos os aplicativos desnecessários da memória para criar mais espaço.  
